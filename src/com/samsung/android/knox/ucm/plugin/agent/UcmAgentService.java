...
public abstract class UcmAgentService extends Service {
    ...
    public static final String PLUGIN_BYTEARRAY_RESPONSE_2 = "bytearrayresponse2";
    ...
    public final class UcmAgentServiceWrapper extends IUcmAgentService.Stub {
        ...
        public Bundle generateKey(String str, String str2, int i, Bundle bundle)
            ...
            return UcmAgentService.this.generateKey(
                    new KeyGenParameterSpec.Builder(str, i, i2, false, 1, i2)
                            .setAlgorithm(str2)
                            .setPurpose(bundle.getInt(UcmAgentProviderImpl.KEY_EXTRA_PURPOSE))
                            ...
                            .setEcCurveName(
                                    bundle.getString(
                                            UcmAgentProviderImpl.KEY_EXTRA_EC_CURVE_NAME,
                                            ApnSettings.MVNO_NONE))
                            .setBlockModes(
                                    bundle.getStringArray(
                                            UcmAgentProviderImpl.KEY_EXTRA_BLOCK_MODES))
                            .setDigests(
                                    bundle.getStringArray(UcmAgentProviderImpl.KEY_EXTRA_DIGESTS))
        ...
        public Bundle keyguardPasswordUpdated(boolean z) throws RemoteException {
            return UcmAgentService.this.keyguardPasswordUpdated(z);
        }
        ...
        public Bundle sign(String str, byte[] bArr, String str2, boolean z, Bundle bundle)
                throws RemoteException {
            return z
                    ? UcmAgentService.this.encrypt(str, bArr, bundle)
                    : UcmAgentService.this.sign(str, bArr, str2, bundle);
        }
    ...
    public final Bundle decrypt(String str, byte[] bArr, String str2, Bundle bundle) {
        ...
        StringBuilder m =
                ActivityResultRegistry$$ExternalSyntheticOutline0.m("decrypt ", str, ",uid: ");
        ...
        try {
            com.samsung.android.knox.ucm.plugin.service.KeyStore keyStore =
                    com.samsung.android.knox.ucm.plugin.service.KeyStore.getInstance(
                            "KNOX", this.mProvider);
            keyStore.setProperty(bundle);
            try {
                keyStore.load(
                        new UcmAgentLoadParameter(
                                bundle.getInt(
                                        UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_OWNER_ID),
                                bundle.getInt(
                                        UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_RESOURCE_ID),
                                bundle.getBundle(
                                        UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_EXTRA_ARGS)));
                KeyStore.Entry entry = keyStore.getEntry(str, null);
                try {
                    if (entry == null) {
                        Log.e(TAG, "decrypt. getEntry null ");
                        return responseErrorWithNullBytes(
                                keyStore.getErrorStatus() == 0 ? 8 : keyStore.getErrorStatus());
                    }
                    String str4 = str2.split("/")[0];
                    Cipher cipher = Cipher.getInstance(str2, this.mProvider);
                    cipher.setProperty(bundle);
                    Log.d(TAG, "decrypt. base algorithm = " + str4);
                    int i2 = 10;
                    if (!TextUtils.isEmpty(str2) && "AES".equalsIgnoreCase(str4)) {
                        ...
                        try {
                            if (equals
                                    && bundle.containsKey(KEY_EXTRA_TAG_LEN)
                                    && bundle.containsKey(KEY_EXTRA_IV)) {
                                algorithmParameterSpec =
                                        new GCMParameterSpec(
                                                bundle.getInt(KEY_EXTRA_TAG_LEN),
                                                bundle.getByteArray(KEY_EXTRA_IV));
                            } else {
                                if (!bundle.containsKey(KEY_EXTRA_IV)) {
                                    ...
                                    int errorStatus = cipher.getErrorStatus();
                                    str3 = PLUGIN_ERROR_CODE;
                                    bundle2.putInt(str3, errorStatus);
                                    return bundle2;
                                }
                                algorithmParameterSpec =
                                        new IvParameterSpec(bundle.getByteArray(KEY_EXTRA_IV));
                            }
                            bundle2.putInt(str3, errorStatus);
                            return bundle2;
                        } catch (IOException e) {
                            ...
                            bundle2.putInt(str3, ERROR_TRANSMIT_ILLEGAL_STATE_EXCEPTION);
                            bundle2.putByteArray(PLUGIN_BYTEARRAY_RESPONSE, null);
                            return bundle2;
                        ...
                        doFinal = cipher.doFinal(bArr);
                        bundle2.putByteArray(PLUGIN_BYTEARRAY_RESPONSE, doFinal);
                        int errorStatus2 = cipher.getErrorStatus();
                        str3 = PLUGIN_ERROR_CODE;
                    }
                    ...
                    doFinal = cipher.doFinal(bArr);
                    bundle2.putByteArray(PLUGIN_BYTEARRAY_RESPONSE, doFinal);
                    int errorStatus22 = cipher.getErrorStatus();
                    str3 = PLUGIN_ERROR_CODE;
                    bundle2.putInt(str3, errorStatus22);
                    return bundle2;
                    ...
                    unsupportedOperationException = e18;
                    str3 = PLUGIN_ERROR_CODE;
                    unsupportedOperationException.printStackTrace();
                    bundle2.putInt(str3, 3);
                    bundle2.putByteArray(PLUGIN_BYTEARRAY_RESPONSE, null);
                    ...
                    invalidAlgorithmParameterException = e19;
                    str3 = PLUGIN_ERROR_CODE;
                    invalidAlgorithmParameterException.printStackTrace();
                    bundle2.putInt(str3, 259);
                    bundle2.putByteArray(PLUGIN_BYTEARRAY_RESPONSE, null);
                    ...
                    unrecoverableEntryException = e23;
                    str3 = PLUGIN_ERROR_CODE;
                    unrecoverableEntryException.printStackTrace();
                    bundle2.putInt(str3, 265);
                    bundle2.putByteArray(PLUGIN_BYTEARRAY_RESPONSE, null);
                ...
                e = e31;
                str3 = PLUGIN_ERROR_CODE;
            } catch (InvalidAlgorithmParameterException e32) {
                e = e32;
                str3 = PLUGIN_ERROR_CODE;
            } catch (InvalidKeyException e33) {
                e = e33;
                str3 = PLUGIN_ERROR_CODE;
            } catch (KeyStoreException e34) {
                e = e34;
                str3 = PLUGIN_ERROR_CODE;
            } catch (NoSuchAlgorithmException e35) {
                e = e35;
                str3 = PLUGIN_ERROR_CODE;
            } catch (UnrecoverableEntryException e36) {
                e = e36;
                str3 = PLUGIN_ERROR_CODE;
            ...
            e = e48;
            str3 = PLUGIN_ERROR_CODE;
        } catch (UnrecoverableEntryException e49) {
            e = e49;
            str3 = PLUGIN_ERROR_CODE;
        } catch (CertificateException e50) {
            e = e50;
            str3 = PLUGIN_ERROR_CODE;
        } catch (BadPaddingException e51) {
            e = e51;
            str3 = PLUGIN_ERROR_CODE;
    ...
    public final Bundle deleteKey(String str, Bundle bundle) {
        ...
        StringBuilder m =
                ActivityResultRegistry$$ExternalSyntheticOutline0.m("deleteKey ", str, ", uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
        ...
        try {
            ...
            keyStore.load(
                    new UcmAgentLoadParameter(
                            bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_OWNER_ID),
                            bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_RESOURCE_ID),
                            bundle.getBundle(
                                    UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_EXTRA_ARGS)));
            ...
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to deleteKey with error code"
                        + " ks.getErrorStatus() = "
                            + keyStore.getErrorStatus());
            return bundle2;
        } catch (IOException e) {
            e.printStackTrace();
            ...
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to deleteKey with EXCEPTION error"
                        + " code  = "
                            + bundle2.getInt(PLUGIN_ERROR_CODE));
            return bundle2;
        } catch (IllegalArgumentException e2) {
            e2.printStackTrace();
    ...
    public final Bundle generateKey(KeyGenParameterSpec keyGenParameterSpec, Bundle bundle) {
        ...
        Log.i(
                ...
                "generateKey "
                        ...
                        + ", uid: "
                        + bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID)
                        + ", caller: "
                        + Binder.getCallingUid());
        Bundle bundle2 = new Bundle();
        try {
            KeyGenerator keyGenerator =
                    KeyGenerator.getInstance(keyGenParameterSpec.getAlgorithm(), this.mProvider);
            keyGenerator.setProperty(bundle);
            keyGenerator.init(keyGenParameterSpec, null);
            boolean z = keyGenerator.generateKey() != null;
            ...
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to generateKey with EXCEPTION"
                        + " error code  = "
                            + bundle2.getInt(PLUGIN_ERROR_CODE));
            return bundle2;
    ...
    public final Bundle generateKeyPair(String str, String str2, int i, Bundle bundle) {
        ...
        KeyGenParameterSpec build =
                new KeyGenParameterSpec.Builder(str, i, i2, false, 1, i2)
                        .setAlgorithm(str2)
                        .setPurpose(bundle2.getInt(UcmAgentProviderImpl.KEY_EXTRA_PURPOSE))
                        .setRandomizedEncryptionRequired(
                                bundle2.getBoolean(
                                        UcmAgentProviderImpl.KEY_EXTRA_RANDOMIZED_ENCRYPTION, true))
                        .setEcCurveName(
                                bundle2.getString(
                                        UcmAgentProviderImpl.KEY_EXTRA_EC_CURVE_NAME,
                                        ApnSettings.MVNO_NONE))
                        .setBlockModes(
                                bundle2.getStringArray(UcmAgentProviderImpl.KEY_EXTRA_BLOCK_MODES))
                        .setDigests(bundle2.getStringArray(UcmAgentProviderImpl.KEY_EXTRA_DIGESTS))
                        .setSignaturePaddings(
                                bundle2.getStringArray(
                                        UcmAgentProviderImpl.KEY_EXTRA_SIGNATURE_PADDINGS))
                        .setOptions(bundle2)
                        .build();
        Log.i(
        ...
        try {
            KeyPairGenerator keyPairGenerator =
                    KeyPairGenerator.getInstance(build.getAlgorithm(), this.mProvider);
    ...
    public final Bundle generateSecureRandom(int i, Bundle bundle) {
        ...
        StringBuilder m =
                ListPopupWindow$$ExternalSyntheticOutline0.m(i, "generateSecureRandom ", ",uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
        ...
        try {
            SecureRandom secureRandom =
                    SecureRandom.getInstance(
                            UcmAgentProviderImpl.SECURERANDOM_SHA1PRNG, this.mProvider);
    ...
    public final Bundle getCertificateChain(String str, Bundle bundle) {
        ...
        try {
            ...
            if (certificateChain != null && certificateChain.length != 0) {
                ...
                bundle2.putByteArray(
                        PLUGIN_BYTEARRAY_RESPONSE, byteArrayOutputStream.toByteArray());
                bundle2.putInt(PLUGIN_ERROR_CODE, keyStore.getErrorStatus());
                return bundle2;
            }
    ...
    public final Bundle getKeyType(String str, Bundle bundle) {
        ...
        StringBuilder m =
                ActivityResultRegistry$$ExternalSyntheticOutline0.m("getKeyType: ", str, ", uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
        ...
        UcmAgentLoadParameter ucmAgentLoadParameter =
                new UcmAgentLoadParameter(
                        bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_OWNER_ID),
                        bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_RESOURCE_ID),
                        bundle.getBundle(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_EXTRA_ARGS));
        for (String str2 : stringArray) {
            if (str2 != null && str2.equals(str)) {
                try {
                    ...
                    Log.d(
                            TAG,
                            "UCMERRORTESTING: @UcmAgentService responding to getKeyType with error"
                                + " code ks.getErrorStatus() = "
                                    + keyStore.getErrorStatus());
                    return saw;
                } catch (IOException e) {
                    e.printStackTrace();
        ...
        Log.d(
                TAG,
                "UCMERRORTESTING: @UcmAgentService responding to getKeyType with EXCEPTION error"
                    + " code  = "
                        + saw.getInt(PLUGIN_ERROR_CODE));
        return saw;
    }
    ...
    public final Bundle importKey(String str, Bundle bundle) {
        ...
        KeyProtection.Builder builder =
                new KeyProtection.Builder(bundle.getInt(UcmAgentProviderImpl.KEY_EXTRA_PURPOSE));
        ...
        if (bundle.containsKey(UcmAgentProviderImpl.KEY_EXTRA_SIGNATURE_PADDINGS)) {
            builder.setEncryptionPaddings(
                    bundle.getString(UcmAgentProviderImpl.KEY_EXTRA_SIGNATURE_PADDINGS));
        }
        builder.setRandomizedEncryptionRequired(
                bundle.getBoolean(UcmAgentProviderImpl.KEY_EXTRA_RANDOMIZED_ENCRYPTION, true));
        KeyProtection build = builder.build();
        StringBuilder m =
                ActivityResultRegistry$$ExternalSyntheticOutline0.m("importKey: ", str, ", uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
        ...
        try {
            ...
            Log.i(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to importKey with error code"
                        + " ks.getErrorStatus() = "
                            + keyStore.getErrorStatus());
            return bundle2;
        } catch (IOException e) {
            ...
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to importKey with EXCEPTION error"
                        + " code  = "
                            + bundle2.getInt(PLUGIN_ERROR_CODE));
            return bundle2;
        } catch (KeyStoreException e2) {
    ...
    public final Bundle importKeyPair(String str, byte[] bArr, byte[] bArr2, Bundle bundle) {
        ...
        try {
            List list =
                    (List)
                            CertificateFactory.getInstance("X.509")
                                    .generateCertificates(new ByteArrayInputStream(bArr2));
            Certificate[] certificateArr =
                    (Certificate[]) list.toArray(new Certificate[list.size()]);
            com.samsung.android.knox.ucm.plugin.service.KeyStore keyStore =
                    com.samsung.android.knox.ucm.plugin.service.KeyStore.getInstance(
                            "KNOX", this.mProvider);
            keyStore.setProperty(bundle);
                                    ...
                                    ? KeyFactory.getInstance(
                                                    bundle.getString(
                                                            UcmAgentProviderImpl.UcmAgentSpiProperty
                                                                    .KEY_ALGORITHM,
                                                            "RSA"))
                                            .generatePrivate(new PKCS8EncodedKeySpec(bArr))
                                    : (PrivateKey) keyStore.getKey(str, null),
                            certificateArr),
                    build);
            bundle2.putBoolean(PLUGIN_BOOLEAN_RESPONSE, true);
            bundle2.putInt(PLUGIN_ERROR_CODE, keyStore.getErrorStatus());
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to importKeyPair with error code"
                        + " ks.getErrorStatus() = "
                            + keyStore.getErrorStatus());
            return bundle2;
        } catch (IOException e) {
            ...
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to importKeyPair with EXCEPTION"
                        + " error code  = "
                            + bundle2.getInt(PLUGIN_ERROR_CODE));
            return bundle2;
        } catch (IllegalArgumentException e2) {
    ...
    public final Bundle installCertificateIfSupported(
        ...
        StringBuilder m =
                ActivityResultRegistry$$ExternalSyntheticOutline0.m(
                        "installCertificateIfSupported: ", str, ", uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
        ...
        try {
            ...
            while (true) {
                ...
                if (key instanceof PrivateKey) {
                    ...
                    keyStore.setEntry(
                            str,
                            new KeyStore.PrivateKeyEntry((PrivateKey) key, certificateChain),
                            new KeyProtection.Builder(
                                            bundle.getInt(UcmAgentProviderImpl.KEY_EXTRA_PURPOSE))
                                    .build());
                }
            }
            bundle2.putBoolean(PLUGIN_BOOLEAN_RESPONSE, true);
            ...
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to installCertificateIfSupported"
                        + " with EXCEPTION error code  = "
                            + bundle2.getInt(PLUGIN_ERROR_CODE));
            return bundle2;
        } catch (KeyStoreException e2) {
            e2.printStackTrace();
    ...
    public final Bundle mac(String str, byte[] bArr, String str2, Bundle bundle) {
        ...
        StringBuilder m =
                ActivityResultRegistry$$ExternalSyntheticOutline0.m("mac ", str, ", uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
        ...
        try {
            ...
            if (secretKey == null) {
                ...
                return responseErrorWithNullBytes(
                        keyStore.getErrorStatus() == 0 ? 10 : keyStore.getErrorStatus());
            }
    ...
    public final Bundle saw(Bundle bundle) {
        ...
        if (aliases == null) {
            ...
            Log.d(
                    TAG,
                    "UCMERRORTESTING: @UcmAgentService responding to saw with EXCEPTION error code "
                        + " = "
                            + bundle2.getInt(PLUGIN_ERROR_CODE));
            return bundle2;
        }
        ...
        bundle2.putStringArray(
                PLUGIN_STRINGARRAY_RESPONSE,
                (String[]) arrayList.toArray(new String[arrayList.size()]));
        bundle2.putInt(PLUGIN_ERROR_CODE, keyStore.getErrorStatus());
        Log.d(
                TAG,
                "UCMERRORTESTING: @UcmAgentService responding to saw with error code"
                    + " ks.getErrorStatus() = "
                        + keyStore.getErrorStatus());
        return bundle2;
    }
    ...
    public final Bundle sign(String str, byte[] bArr, String str2, Bundle bundle) {
        ...
        StringBuilder m =
                ActivityResultRegistry$$ExternalSyntheticOutline0.m("sign ", str, ",uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
    ...
    public abstract Bundle keyguardPasswordUpdated(boolean z);
    ...
    public final Bundle encrypt(String str, byte[] bArr, String str2, Bundle bundle) {
        ...
        StringBuilder m =
                SeslRoundedCorner$$ExternalSyntheticOutline0.m(
                        "encrypt: ", str, ", algorithm: ", str2, ", uid: ");
        m.append(bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID));
        m.append(", caller: ");
        m.append(Binder.getCallingUid());
        Log.i(TAG, m.toString());
        ...
        try {
            ...
            if (TextUtils.isEmpty(str2) || !str2.toUpperCase().startsWith("AES/")) {
                ...
                cipher =
                        Cipher.getInstance(
                                UcmAgentProviderImpl.CIPHER_RSA_ECB_PKCS1PADDING, this.mProvider);
                cipher.setProperty(bundle);
