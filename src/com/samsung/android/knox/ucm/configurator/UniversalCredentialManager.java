...
public class UniversalCredentialManager {
    public static final String ACTION_UCM_CONFIG_STATUS =
            "com.samsung.android.knox.intent.action.UCM_CONFIG_STATUS";
    public static final String ACTION_UCM_KEYGUARD_SET =
            "com.samsung.android.knox.intent.action.UCM_KEYGUARD_SET";
    public static final String ACTION_UCM_KEYGUARD_UNSET =
            "com.samsung.android.knox.intent.action.UCM_KEYGUARD_UNSET";
    ...
    public static final String BUNDLE_EXTRA_CREDENTIAL_STORAGE = "credential_storage";
    public static final String BUNDLE_EXTRA_ENFORCE_LOCK_TYPE_DIRECT_SET =
            "enforce_lock_type_direct_set";
    ...
    public UniversalCredentialManager(ContextInfo contextInfo, Context context) {
        this.mContextInfo = contextInfo;
        Log.w(
                TAG,
                "UniversalCredentialStorageManager API ["
                        + this.mContextInfo.mContainerId
                        + ","
                        + this.mContextInfo.mCallerUid
                        + "] ");
    }
    ...
    public static synchronized UniversalCredentialManager getUCMManager(Context context) {
        synchronized (UniversalCredentialManager.class) {
            if (EdmConstants.getEnterpriseKnoxSdkVersion()
                            .compareTo(
                                    EdmConstants.EnterpriseKnoxSdkVersion
    ...
    */
    public static boolean isValidUser(android.content.Context r3, int r4) {
        /*
            ...
            com.android.settings.MainClearConfirm$$ExternalSyntheticOutline0.m(r4, r1, r0)
            r0 = 1
            if (r4 != 0) goto Lb
            goto L21
        Lb:
            ...
            java.lang.Object r3 = r3.getSystemService(r2)     // Catch: java.lang.Exception -> L1e
            com.samsung.android.knox.SemPersonaManager r3 = (com.samsung.android.knox.SemPersonaManager) r3     // Catch: java.lang.Exception -> L1e
            if (r3 == 0) goto L20
            boolean r3 = r3.exists(r4)     // Catch: java.lang.Exception -> L1e
            if (r3 == 0) goto L20
            goto L21
        L1e:
            r3 = move-exception
        ...
        L3a:
            ...
            androidx.apppickerview.widget.AbsAdapter$$ExternalSyntheticOutline0.m(r4, r3, r1)
            return r1
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.samsung.android.knox.ucm.configurator.UniversalCredentialManager.isValidUser(android.content.Context,"
                    + " int):boolean");
    }

    public int addPackagesToExemptList(
            CredentialStorage credentialStorage, int i, List<AppIdentity> list) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.addPackagesToExemptList");
        ...
        if (getUCMService() != null) {
            return mUCMService.addPackagesToExemptList(
                    this.mContextInfo, credentialStorage, i, list);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.addPackagesToExemptList getUCMService is"
                    + " null....");
        return -1;
    }

    public int addPackagesToWhiteList(
            CredentialStorage credentialStorage, List<AppIdentity> list, Bundle bundle) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.addPackagesToWhiteList");
        ...
        if (getUCMService() != null) {
            return mUCMService.addPackagesToWhiteList(
                    this.mContextInfo, credentialStorage, list, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.addPackagesToWhiteList getUCMService is"
                    + " null....");
        return -1;
    }
    ...
    public int addPackagesToWhiteListInternal(
            ...
            Bundle bundle) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.addPackagesToWhiteListInternal");
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "addPackagesToWhiteListInternal : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return -1;
        }
        try {
        ...
        if (getUCMService() != null) {
            return mUCMService.addPackagesToWhiteListInternal(
                    i, i2, credentialStorage, list, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.addPackagesToWhiteListInternal getUCMService is"
                    + " null....");
        return -1;
    }

    public int changeKeyguardPin(CredentialStorage credentialStorage, String str, String str2) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.changeKeyguardPin");
        Log.i(TAG, "UniversalCredentialManager.changeKeyguardPin is called....");
        if (isNotSupportKnoxSdk(
                EdmConstants.EnterpriseKnoxSdkVersion.KNOX_ENTERPRISE_SDK_VERSION_3_9)) {
            return -1;
        }
        try {
        } catch (RemoteException e) {
    ...
    public int configureCredentialStorageForODESettings(
            CredentialStorage credentialStorage, Bundle bundle) {
        Log.i(
                TAG,
                "UniversalCredentialManager.configureCredentialStorageForODESettings is"
                    + " called....");
        try {
            if (getUCMService() != null) {
                return mUCMService.configureCredentialStorageForODESettings(
                        this.mContextInfo, credentialStorage, bundle);
            }
            Log.i(
                    TAG,
                    "UniversalCredentialStorageManager.configureCredentialStorageForODESettings"
                        + " getUCMService is null....");
            return -1;
        } catch (RemoteException e) {
            RingerModeAffectedVolumePreferenceController$$ExternalSyntheticOutline0.m(
                    e, new StringBuilder("The exception occurs "), TAG);
    ...
    public int configureCredentialStoragePlugin(
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "configureCredentialStoragePlugin : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return -1;
        }
        try {
        ...
        if (getUCMService() != null) {
            return mUCMService.configureCredentialStoragePlugin(
                    this.mContextInfo, credentialStorage, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.configureCredentialStoragePlugin getUCMService"
                    + " is null....");
        return -1;
    }
    ...
    public int deleteCACertificate(String str) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.deleteCACertificate");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.deleteCACertificate getUCMService is null....");
        return -1;
    }
    ...
    public int deleteCertificateInternal(
        ...
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.deleteCertificateInternal");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.deleteCertificateInternal getUCMService is"
                    + " null....");
        return -1;
    }

    public int enableCredentialStorageForLockType(CredentialStorage credentialStorage, boolean z) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.enableCredentialStorageForLockType");
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "enableCredentialStorageForLockType : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_7");
            return -1;
        }
        try {
        ...
        if (getUCMService() != null) {
            return mUCMService.enableCredentialStorageForLockType(
                    this.mContextInfo, credentialStorage, z);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.enableCredentialStorageForLockType getUCMService"
                    + " is null....");
        return -1;
    }
    ...
    public int enforceCredentialStorageAsLockType(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo,
                "UniversalCredentialManager.enforceCredentialStorageAsLockType(CredentialStorage)");
    ...
    public CredentialStorage[] getAvailableCredentialStorages() {
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "getAvailableCredentialStorages : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return null;
        }
        try {
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getAvailableCredentialStorages getUCMService is"
                    + " null....");
        return null;
    }
    ...
    public String[] getCACertificateAliases(Bundle bundle) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getCACertificateAliases");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getCACertificateAliases getUCMService is"
                    + " null....");
        return null;
    }
    ...
    public Bundle getCredentialStoragePluginConfiguration(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo,
                "UniversalCredentialManager.getCredentialStoragePluginConfiguration",
                true);
        Log.i(
                TAG,
                "UniversalCredentialManager.getCredentialStoragePluginConfiguration is called....");
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
                        .compareTo(
                                EdmConstants.EnterpriseKnoxSdkVersion
                                        .KNOX_ENTERPRISE_SDK_VERSION_2_6)
            ...
            Log.i(
                    TAG,
                    "getCredentialStoragePluginConfiguration : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return null;
        }
        try {
        ...
        if (getUCMService() != null) {
            return mUCMService.getCredentialStoragePluginConfiguration(
                    this.mContextInfo, credentialStorage);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getCredentialStoragePluginConfiguration"
                    + " getUCMService is null....");
        return null;
    }
    ...
    public Bundle getCredentialStorageProperty(CredentialStorage credentialStorage, Bundle bundle) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getCredentialStorageProperty", true);
        ...
        if (getUCMService() != null) {
            return mUCMService.getCredentialStorageProperty(
                    this.mContextInfo, credentialStorage, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getStorageOption getCredentialStorageProperty is"
                    + " null....");
        return null;
    }
    ...
    public CredentialStorage[] getCredentialStorages(String str) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getCredentialStorages");
    ...
    public CredentialStorage getDefaultInstallStorage() {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getDefaultInstallStorage");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getDefaultInstallStorage getUCMService is"
                    + " null....");
        return null;
    }
    ...
    public CredentialStorage getEnforcedCredentialStorageForLockType() {
        Log.i(
                TAG,
                "UniversalCredentialManager.getEnforcedCredentialStorageForLockType is called....");
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
                        .compareTo(
                                EdmConstants.EnterpriseKnoxSdkVersion
                                        .KNOX_ENTERPRISE_SDK_VERSION_2_7)
            ...
            Log.i(
                    TAG,
                    "getEnforcedCredentialStorageForLockType : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_7");
            return null;
        }
        try {
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getEnforcedCredentialStorageForLockType"
                    + " getUCMService is null....");
        return null;
    }

    public int getKeyguardPinCurrentRetryCount(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getKeyguardPinCurrentRetryCount");
        ...
        if (getUCMService() != null) {
            return mUCMService.getKeyguardPinCurrentRetryCount(
                    this.mContextInfo, credentialStorage);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getKeyguardPinCurrentRetryCount getUCMService is"
                    + " null....");
        return -1;
    }

    public int getKeyguardPinMaximumLength(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getKeyguardPinMaximumLength");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getKeyguardPinMaximumLength getUCMService is"
                    + " null....");
        return -1;
    }

    public int getKeyguardPinMaximumRetryCount(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getKeyguardPinMaximumRetryCount");
        ...
        if (getUCMService() != null) {
            return mUCMService.getKeyguardPinMaximumRetryCount(
                    this.mContextInfo, credentialStorage);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getKeyguardPinMaximumRetryCount getUCMService is"
                    + " null....");
        return -1;
    }

    public int getKeyguardPinMinimumLength(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getKeyguardPinMinimumLength");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getKeyguardPinMinimumLength getUCMService is"
                    + " null....");
        return -1;
    }
    ...
    public Bundle getODESettingsConfiguration() {
        ...
        try {
            ...
            Log.i(
                    TAG,
                    "UniversalCredentialManager.getODESettingsConfiguration getUCMService is"
                        + " null....");
            return null;
        } catch (RemoteException e) {
            RingerModeAffectedVolumePreferenceController$$ExternalSyntheticOutline0.m(
    ...
    public List<AppIdentity> getPackagesFromExemptList(CredentialStorage credentialStorage, int i) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.getPackagesFromExemptList", true);
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getPackagesFromExemptList getUCMService is"
                    + " null....");
        return null;
    }
    ...
    public List<AppIdentity> getPackagesFromWhiteList(
        ...
        if (getUCMService() != null) {
            return mUCMService.getPackagesFromWhiteList(
                    this.mContextInfo, credentialStorage, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getPackagesFromWhiteList getUCMService is"
                    + " null....");
        return null;
    }
    ...
    public String[] getSupportedAlgorithms(CredentialStorage credentialStorage) {
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getSupportedAlgorithms getUCMService is"
                    + " null....");
        return null;
    }

    public int initKeyguardPin(CredentialStorage credentialStorage, String str, Bundle bundle) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.initKeyguardPin");
    ...
    public int installCACertificate(byte[] bArr, String str, Bundle bundle) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.installCACertificate");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.installCACertificate getUCMService is null....");
        return -1;
    }
    ...
    public int installCertificate(
        ...
        if (getUCMService() != null) {
            return mUCMService.installCertificate(
                    this.mContextInfo, credentialStorage, bArr, str, str2, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.installCertificate getUCMService is null....");
        return -1;
    }
    ...
    public int installCertificateInternal(
            ...
            boolean z) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.installCertificateInternal");
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "installCertificateInternal : support above KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return -1;
        }
        try {
        } catch (RemoteException e) {
        ...
        if (getUCMService() != null) {
            return mUCMService.installCertificateInternal(
                    i, i2, credentialStorage, bArr, str, bundle, z);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.installCertificateInternal getUCMService is"
                    + " null....");
        return -1;
    }

    public boolean isCredentialStorageEnabledForLockType(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo,
                "UniversalCredentialManager.isCredentialStorageEnabledForLockType",
                true);
        Log.i(
                TAG,
                "UniversalCredentialManager.isCredentialStorageEnabledForLockType is called....");
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
                        .compareTo(
                                EdmConstants.EnterpriseKnoxSdkVersion
                                        .KNOX_ENTERPRISE_SDK_VERSION_2_7)
            ...
            Log.i(
                    TAG,
                    "isCredentialStorageEnabledForLockType : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_7");
            return false;
        }
        try {
        ...
        if (getUCMService() != null) {
            return mUCMService.isCredentialStorageEnabledForLockType(
                    this.mContextInfo, credentialStorage);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.isCredentialStorageEnabledForLockType"
                    + " getUCMService is null....");
        return false;
    }

    public boolean isCredentialStorageLocked(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.isCredentialStorageLocked");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.getStorageOption isCredentialStorageLocked is"
                    + " null....");
        return false;
    }
    ...
    public boolean isCredentialStorageManaged(CredentialStorage credentialStorage) {
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "isCredentialStorageManaged : support above KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return false;
        }
        try {
        } catch (RemoteException e) {
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.isCredentialStorageManaged getUCMService is"
                    + " null....");
        return false;
    }

    public final boolean isNotSupportKnoxSdk(
    ...
    public int lockCredentialStorage(CredentialStorage credentialStorage, boolean z) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.lockCredentialStorage");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.lockCredentialStorage getUCMService is"
                    + " null....");
        return -1;
    }
    ...
    public int manageCredentialStorage(CredentialStorage credentialStorage, boolean z) {
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.manageCredentialStorage getUCMService is"
                    + " null....");
        return -1;
    }
    ...
    public int removePackagesFromExemptList(
            CredentialStorage credentialStorage, int i, List<AppIdentity> list) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.removePackagesFromExemptList");
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "removePackagesFromExemptList : support above KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return -1;
        }
        try {
        } catch (RemoteException e) {
        ...
        if (getUCMService() != null) {
            return mUCMService.removePackagesFromExemptList(
                    this.mContextInfo, credentialStorage, i, list);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.removePackagesFromExemptList getUCMService is"
                    + " null....");
        return -1;
    }
    ...
    public int removePackagesFromWhiteList(
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "removePackagesFromWhiteList : support above KNOX_ENTERPRISE_SDK_VERSION_2_6");
            return -1;
        }
        try {
        } catch (RemoteException e) {
        ...
        if (getUCMService() != null) {
            return mUCMService.removePackagesFromWhiteList(
                    this.mContextInfo, credentialStorage, list, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.removePackagesFromWhiteList getUCMService is"
                    + " null....");
        return -1;
    }
    ...
    public Bundle setCredentialStorageProperty(CredentialStorage credentialStorage, Bundle bundle) {
        ...
        if (getUCMService() != null) {
            return mUCMService.setCredentialStorageProperty(
                    this.mContextInfo, credentialStorage, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.setCredentialStorageProperty getUCMService is"
                    + " null....");
        return null;
    }

    public int setDefaultInstallStorage(CredentialStorage credentialStorage) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.setDefaultInstallStorage");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.setDefaultInstallStorage getUCMService is"
                    + " null....");
        return -1;
    }

    public int setKeyguardPinMaximumLength(CredentialStorage credentialStorage, int i) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.setKeyguardPinMaximumLength");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.setKeyguardPinMaximumLength getUCMService is"
                    + " null....");
        return -1;
    }

    public int setKeyguardPinMaximumRetryCount(CredentialStorage credentialStorage, int i) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.setKeyguardPinMaximumRetryCount");
        ...
        if (getUCMService() != null) {
            return mUCMService.setKeyguardPinMaximumRetryCount(
                    this.mContextInfo, credentialStorage, i);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.setKeyguardPinMaximumRetryCount getUCMService is"
                    + " null....");
        return -1;
    }

    public int setKeyguardPinMinimumLength(CredentialStorage credentialStorage, int i) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "UniversalCredentialManager.setKeyguardPinMinimumLength");
        ...
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.setKeyguardPinMinimumLength getUCMService is"
                    + " null....");
        return -1;
    }
    ...
    public int enforceCredentialStorageAsLockType(
        ...
        if (EdmConstants.getEnterpriseKnoxSdkVersion()
            ...
            Log.i(
                    TAG,
                    "enforceCredentialStorageAsLockType : support above"
                        + " KNOX_ENTERPRISE_SDK_VERSION_2_7");
            return -1;
        }
        try {
        ...
        if (getUCMService() != null) {
            return mUCMService.enforceCredentialStorageAsLockType(
                    this.mContextInfo, credentialStorage, bundle);
        }
        Log.i(
                TAG,
                "UniversalCredentialStorageManager.enforceCredentialStorageAsLockType getUCMService"
                    + " is null....");
        return -1;
    }
