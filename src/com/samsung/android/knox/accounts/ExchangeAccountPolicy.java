...
public class ExchangeAccountPolicy {
    public static final String ACTION_CBA_INSTALL_STATUS =
            "com.samsung.android.knox.intent.action.CBA_INSTALL_STATUS";
    ...
    public static final String ACTION_CBA_INSTALL_STATUS_OLD =
            "android.intent.action.sec.CBA_INSTALL_STATUS";
    public static final String ACTION_CREATE_EMAILACCOUNT_INTERNAL =
            "com.samsung.android.knox.intent.action.CREATE_EMAILACCOUNT_INTERNAL";
    public static final String ACTION_DELETE_EMAILACCOUNT_INTERNAL =
            "com.samsung.android.knox.intent.action.DELETE_EMAILACCOUNT_INTERNAL";
    public static final String ACTION_DELETE_NOT_VALIDATED_EMAILACCOUNT_INTERNAL =
            "com.samsung.android.knox.intent.action.DELETE_NOT_VALIDATED_EMAILACCOUNT_INTERNAL";
    public static final String ACTION_EAS_INTENT_INTERNAL =
            "com.samsung.android.knox.intent.action.EAS_INTENT_INTERNAL";
    public static final String ACTION_EMAIL_DEVICEID_RESULT_NEWEMAIL =
            "edm.intent.action.internal.GET_DEVICEID_RESULT";
    public static final String ACTION_EMAIL_ENABLE_MSG_COMPOSE_INTERNAL =
            "com.samsung.android.knox.intent.action.EMAIL_ENABLE_MSG_COMPOSE_INTERNAL";
    public static final String ACTION_EMAIL_INSTALL_CERT_INTERNAL =
            "com.samsung.android.knox.intent.action.EMAIL_INSTALL_CERT_INTERNAL";
    public static final String ACTION_EMAIL_RENAME_CERTIFICATE_INTERNAL =
            "com.samsung.android.knox.intent.action.EMAIL_RENAME_CERTIFICATE_INTERNAL";
    public static final String ACTION_ENFORCE_SMIME_ALIAS_EMAIL_INTERNAL =
            "com.samsung.android.knox.intent.action.ENFORCE_SMIME_ALIAS_EMAIL_INTERNAL";
    public static final String ACTION_ENFORCE_SMIME_ALIAS_INTERNAL =
            "com.samsung.android.knox.intent.action.ENFORCE_SMIME_ALIAS_INTERNAL";
    public static final String ACTION_ENFORCE_SMIME_ALIAS_RESULT =
            "com.samsung.android.knox.intent.action.ENFORCE_SMIME_ALIAS_RESULT";
    public static final String ACTION_EXCHANGE_ACCOUNT_ADD_RESULT =
            "com.samsung.android.knox.intent.action.EXCHANGE_ACCOUNT_ADD_RESULT";
    public static final String ACTION_EXCHANGE_ACCOUNT_DELETE_RESULT =
            "com.samsung.android.knox.intent.action.EXCHANGE_ACCOUNT_DELETE_RESULT";
    public static final String ACTION_FORCE_SMIME_CERTIFICATE_FOR_ENCRYPTION_INTERNAL =
            "com.samsung.android.knox.intent.action.FORCE_SMIME_CERTIFICATE_FOR_ENCRYPTION_INTERNAL";
    public static final String ACTION_FORCE_SMIME_CERTIFICATE_FOR_SIGNING_INTERNAL =
            "com.samsung.android.knox.intent.action.FORCE_SMIME_CERTIFICATE_FOR_SIGNING_INTERNAL";
    public static final String ACTION_FORCE_SMIME_CERTIFICATE_INTERNAL =
            "com.samsung.android.knox.intent.action.FORCE_SMIME_CERTIFICATE_INTERNAL";
    public static final String ACTION_GET_EMAIL_DEVICEID_REQUEST_INTERNAL =
            "com.samsung.android.knox.intent.action.GET_EMAIL_DEVICEID_REQUEST_INTERNAL";
    public static final String ACTION_GET_EMAIL_DEVICEID_RESULT_INTERNAL =
            "com.samsung.android.knox.intent.action.GET_EMAIL_DEVICEID_RESULT_INTERNAL";
    public static final String ACTION_RELEASE_SMIME_CERTIFICATE_FOR_ENCRYPTION_INTERNAL =
            "com.samsung.android.knox.intent.action.RELEASE_SMIME_CERTIFICATE_FOR_ENCRYPTION_INTERNAL";
    public static final String ACTION_RELEASE_SMIME_CERTIFICATE_FOR_SIGNING_INTERNAL =
            "com.samsung.android.knox.intent.action.RELEASE_SMIME_CERTIFICATE_FOR_SIGNING_INTERNAL";
    public static final String ACTION_RELEASE_SMIME_CERTIFICATE_INTERNAL =
            "com.samsung.android.knox.intent.action.RELEASE_SMIME_CERTIFICATE_INTERNAL";
    public static final String ACTION_REQUEST_EMAILACCOUNT_PASSWORD_INTERNAL =
            "com.samsung.android.knox.intent.action.REQUEST_EMAILACCOUNT_PASSWORD_INTERNAL";
    public static final String ACTION_RESULT_EMAILACCOUNT_PASSWORD_INTERNAL =
            "com.samsung.android.knox.intent.action.RESULT_EMAILACCOUNT_PASSWORD_INTERNAL";
    public static final String ACTION_SET_EMAILACCOUNT_PASSWORD_INTERNAL =
            "com.samsung.android.knox.intent.action.SET_EMAILACCOUNT_PASSWORD_INTERNAL";
    ...
    public static final String EXTRA_CERT_PASSWORD_ID_INTERNAL =
            "com.samsung.android.knox.intent.extra.CERT_PASSWORD_ID_INTERNAL";
    public static final String EXTRA_CERT_PASSWORD_INTERNAL =
            "com.samsung.android.knox.intent.extra.CERT_PASSWORD_INTERNAL";
    public static final String EXTRA_CERT_PATH = "cert_path";
    public static final String EXTRA_CERT_PATH_INTERNAL =
            "com.samsung.android.knox.intent.extra.CERT_PATH_INTERNAL";
    public static final String EXTRA_CERT_RESULT_ID = "certificate_result_id";
    public static final String EXTRA_CERT_RESULT_ID_INTERNAL =
            "com.samsung.android.knox.intent.extra.CERT_RESULT_ID_INTERNAL";
    public static final String EXTRA_EMAIL_ADDRESS =
            "com.samsung.android.knox.intent.extra.EMAIL_ADDRESS";
    public static final String EXTRA_ENFORCE_SMIME_ALIAS_NAME =
            "com.samsung.edm.intent.extra.ENFORCE_SMIME_ALIAS_NAME";
    public static final String EXTRA_ENFORCE_SMIME_ALIAS_NAME_INTERNAL =
            "com.samsung.android.knox.intent.extra.ENFORCE_SMIME_ALIAS_NAME_INTERNAL";
    public static final String EXTRA_ENFORCE_SMIME_ALIAS_STORAGE =
            "com.samsung.edm.intent.extra.ENFORCE_SMIME_ALIAS_STORAGE";
    public static final String EXTRA_ENFORCE_SMIME_ALIAS_STORAGE_INTERNAL =
            "com.samsung.android.knox.intent.extra.ENFORCE_SMIME_ALIAS_STORAGE_INTERNAL";
    public static final String EXTRA_ENFORCE_SMIME_ALIAS_TYPE =
            "com.samsung.android.knox.intent.extra.ENFORCE_SMIME_ALIAS_TYPE";
    ...
    public static final String EXTRA_SERVER_ADDRESS =
            "com.samsung.android.knox.intent.extra.SERVER_ADDRESS";
    public static final String EXTRA_SMIME_INSTALL_TYPE = "smime_type";
    public static final String EXTRA_SMIME_INSTALL_TYPE_INTERNAL =
            "com.samsung.android.knox.intent.extra.SMIME_INSTALL_TYPE";
    public static final String EXTRA_SMIME_RESULT =
            "com.samsung.android.knox.intent.extra.SMIME_RESULT";
    ...
    public long addNewAccount(ExchangeAccount exchangeAccount) {
        ...
        if ((KnoxInternalFeature.KNOX_CONFIG_MDM_VERSION >= 17
                        ...
                        || (TextUtils.isEmpty(exchangeAccount.certificateAlias)
                                && TextUtils.isEmpty(exchangeAccount.certificateStorageName)))
                && getService() != null) {
            try {
    ...
    public boolean allowInComingAttachments(boolean z, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.allowInComingAttachments");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public String getAccountCertificatePassword(long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.getAccountCertificatePassword", true);
        if (getService() == null) {
            return null;
        }
        try {
    ...
    public String getAccountEmailPassword(long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.getAccountEmailPassword", true);
        if (getService() == null) {
            return null;
        }
        try {
    ...
    public void removePendingAccount(String str, String str2, String str3, String str4) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.removePendingAccount");
        if (getService() != null) {
            try {
    ...
    public void sendAccountsChangedBroadcast() {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.sendAccountsChangedBroadcast");
        if (getService() != null) {
            try {
                if (this.mAccId != 0) {
                    ...
                    setAccountBaseParameters(
                            this.mUser, this.mDomain, this.mEmailAddress, this.mHost, this.mAccId);
                    this.mHost = null;
    ...
    public boolean setAcceptAllCertificates(boolean z, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setAcceptAllCertificates");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public long setAccountBaseParameters(
            String str, String str2, String str3, String str4, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setAccountBaseParameters");
        if (getService() == null) {
            return -1L;
        }
        try {
            return this.mService.setAccountBaseParameters(
                    this.mContextInfo, str, str2, str3, str4, j);
        } catch (RemoteException e) {
            Log.w(TAG, "Failed talking with exchange account policy", e);
            return -1L;
        }
    ...
    public long setAccountCertificatePassword(String str) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setAccountCertificatePassword");
        if (getService() == null) {
            return -1L;
        }
        try {
    ...
    public long setAccountEmailPassword(String str) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setAccountEmailPassword");
        if (getService() == null) {
            return -1L;
        }
        try {
    ...
    public boolean setAlwaysVibrateOnEmailNotification(boolean z, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setAlwaysVibrateOnEmailNotification");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setAsDefaultAccount(long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setAsDefaultAccount");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setForceSMIMECertificateAlias(long j, String str, int i) {
        EnterpriseLicenseManager.log(
                this.mContextInfo,
                "ExchangeAccountPolicy.setForceSMIMECertificateAlias(long, String, int)");
        try {
            if (getService() != null) {
                return this.mService.setForceSMIMECertificateAlias(
                        this.mContextInfo, j, null, str, i);
            }
            return false;
        } catch (RemoteException e) {
    ...
    public boolean setIncomingAttachmentsSize(int i, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setIncomingAttachmentsSize");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setMaxCalendarAgeFilter(int i, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setMaxCalendarAgeFilter");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setMaxEmailAgeFilter(int i, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setMaxEmailAgeFilter");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setMaxEmailBodyTruncationSize(int i, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setMaxEmailBodyTruncationSize");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setMaxEmailHTMLBodyTruncationSize(int i, long j) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setMaxEmailHTMLBodyTruncationSize");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setRequireEncryptedSMIMEMessages(long j, boolean z) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setRequireEncryptedSMIMEMessages");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setRequireSignedSMIMEMessages(long j, boolean z) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "ExchangeAccountPolicy.setRequireSignedSMIMEMessages");
        if (getService() == null) {
            return false;
        }
        try {
    ...
    public boolean setForceSMIMECertificateAlias(long j, String str, String str2, int i) {
        EnterpriseLicenseManager.log(
                this.mContextInfo,
                "ExchangeAccountPolicy.setForceSMIMECertificateAlias(long, String, String, int)");
        ...
        try {
            if (getService() != null) {
                return this.mService.setForceSMIMECertificateAlias(
                        this.mContextInfo, j, str, str2, i);
            }
            return false;
        } catch (RemoteException e) {
            Log.w(TAG, "Failed setForceSMIMECertificateAlias() ", e);
