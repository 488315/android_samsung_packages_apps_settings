...
public interface IDeviceAccountPolicy extends IInterface {
    public static final String DESCRIPTOR =
            "com.samsung.android.knox.accounts.IDeviceAccountPolicy";
    ...
    public static class Default implements IDeviceAccountPolicy {
        ...
        public boolean addAccountsToAdditionBlackList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public boolean addAccountsToAdditionWhiteList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public boolean addAccountsToRemovalBlackList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public boolean addAccountsToRemovalWhiteList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }
        ...
        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public List<AccountControlInfo> getAccountsFromAdditionBlackLists(
                ContextInfo contextInfo, String str) throws RemoteException {
            return null;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public List<AccountControlInfo> getAccountsFromAdditionWhiteLists(
                ContextInfo contextInfo, String str) throws RemoteException {
            return null;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public List<AccountControlInfo> getAccountsFromRemovalBlackLists(
                ContextInfo contextInfo, String str) throws RemoteException {
            return null;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public List<AccountControlInfo> getAccountsFromRemovalWhiteLists(
                ContextInfo contextInfo, String str) throws RemoteException {
            return null;
        }
        ...
        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public boolean removeAccountsFromAdditionBlackList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public boolean removeAccountsFromAdditionWhiteList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public boolean removeAccountsFromRemovalBlackList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }

        @Override // com.samsung.android.knox.accounts.IDeviceAccountPolicy
        public boolean removeAccountsFromRemovalWhiteList(
                ContextInfo contextInfo, String str, List<String> list) throws RemoteException {
            return false;
        }
    }
    ...
    boolean removeAccountsFromAdditionBlackList(
            ContextInfo contextInfo, String str, List<String> list) throws RemoteException;

    boolean removeAccountsFromAdditionWhiteList(
            ContextInfo contextInfo, String str, List<String> list) throws RemoteException;

    boolean removeAccountsFromRemovalBlackList(
            ContextInfo contextInfo, String str, List<String> list) throws RemoteException;

    boolean removeAccountsFromRemovalWhiteList(
            ContextInfo contextInfo, String str, List<String> list) throws RemoteException;

    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements IDeviceAccountPolicy {
        ...
        public static IDeviceAccountPolicy asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface =
                    iBinder.queryLocalInterface(IDeviceAccountPolicy.DESCRIPTOR);
            return (queryLocalInterface == null
                            || !(queryLocalInterface instanceof IDeviceAccountPolicy))
                    ? new Proxy(iBinder)
                    : (IDeviceAccountPolicy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2)
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    boolean addAccountsToRemovalBlackList =
                            addAccountsToRemovalBlackList(
                                    contextInfo, readString, createStringArrayList);
                    parcel2.writeNoException();
                ...
                case 3:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean removeAccountsFromRemovalBlackList =
                            removeAccountsFromRemovalBlackList(
                                    contextInfo2, readString2, createStringArrayList2);
                    parcel2.writeNoException();
                ...
                case 4:
                    ...
                    parcel.enforceNoDataAvail();
                    List<AccountControlInfo> accountsFromRemovalBlackLists =
                            getAccountsFromRemovalBlackLists(contextInfo3, readString3);
                    parcel2.writeNoException();
                ...
                case 5:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean clearAccountsFromRemovalBlackList =
                            clearAccountsFromRemovalBlackList(contextInfo4, readString4);
                    parcel2.writeNoException();
                ...
                case 6:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean addAccountsToRemovalWhiteList =
                            addAccountsToRemovalWhiteList(
                                    contextInfo5, readString5, createStringArrayList3);
                    parcel2.writeNoException();
                ...
                case 7:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean removeAccountsFromRemovalWhiteList =
                            removeAccountsFromRemovalWhiteList(
                                    contextInfo6, readString6, createStringArrayList4);
                    parcel2.writeNoException();
                ...
                case 8:
                    ...
                    parcel.enforceNoDataAvail();
                    List<AccountControlInfo> accountsFromRemovalWhiteLists =
                            getAccountsFromRemovalWhiteLists(contextInfo7, readString7);
                    parcel2.writeNoException();
                ...
                case 9:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean clearAccountsFromRemovalWhiteList =
                            clearAccountsFromRemovalWhiteList(contextInfo8, readString8);
                    parcel2.writeNoException();
                ...
                case 10:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean isAccountRemovalAllowed =
                            isAccountRemovalAllowed(readString9, readString10, readBoolean);
                    parcel2.writeNoException();
                ...
                case 11:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean isAccountRemovalAllowedAsUser =
                            isAccountRemovalAllowedAsUser(
                                    readString11, readString12, readBoolean2, readInt);
                    parcel2.writeNoException();
                ...
                case 12:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean addAccountsToAdditionBlackList =
                            addAccountsToAdditionBlackList(
                                    contextInfo9, readString13, createStringArrayList5);
                    parcel2.writeNoException();
                ...
                case 13:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean removeAccountsFromAdditionBlackList =
                            removeAccountsFromAdditionBlackList(
                                    contextInfo10, readString14, createStringArrayList6);
                    parcel2.writeNoException();
                ...
                case 14:
                    ...
                    List<AccountControlInfo> accountsFromAdditionBlackLists =
                            getAccountsFromAdditionBlackLists(contextInfo11, readString15);
                    parcel2.writeNoException();
                ...
                case 15:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean clearAccountsFromAdditionBlackList =
                            clearAccountsFromAdditionBlackList(contextInfo12, readString16);
                    parcel2.writeNoException();
                ...
                case 16:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean addAccountsToAdditionWhiteList =
                            addAccountsToAdditionWhiteList(
                                    contextInfo13, readString17, createStringArrayList7);
                    parcel2.writeNoException();
                ...
                case 17:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean removeAccountsFromAdditionWhiteList =
                            removeAccountsFromAdditionWhiteList(
                                    contextInfo14, readString18, createStringArrayList8);
                    parcel2.writeNoException();
                ...
                case 18:
                    ...
                    parcel.enforceNoDataAvail();
                    List<AccountControlInfo> accountsFromAdditionWhiteLists =
                            getAccountsFromAdditionWhiteLists(contextInfo15, readString19);
                    parcel2.writeNoException();
                ...
                case 19:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean clearAccountsFromAdditionWhiteList =
                            clearAccountsFromAdditionWhiteList(contextInfo16, readString20);
                    parcel2.writeNoException();
                ...
                case 20:
                    ...
                    boolean isAccountAdditionAllowed =
                            isAccountAdditionAllowed(readString21, readString22, readBoolean3);
                    parcel2.writeNoException();
