        ...
        public Bundle onMessage(int i, String str, Bundle bundle) {
            ...
            try {
                ...
                switch (c) {
                    case 0:
                        bundle2.putBoolean(
                                "dual_dar_response", this.mDualDARClient.onClientBringup());
                        break;
                    case 1:
                    case 2:
                        int i2 =
                        ...
                        bundle2.putBoolean(
                                "dual_dar_response", this.mDualDARClient.onDualDARSetupForUser(i2));
                    ...
                    case 3:
                        ...
                        bundle2.putBoolean(
                                "dual_dar_response",
                                this.mDualDARClient.onDualDARDestroyForUser(i3));
                    ...
                    case 4:
                        ...
                        byte[] decryptMessageFrom =
                                ((IProxyAgentService) this)
                                        .mSecureClientForInAPI.decryptMessageFrom(
                                                string, bundle.getByteArray("EXISTING_PASSWORD"));
                        boolean onPasswordAuth =
                                this.mDualDARClient.onPasswordAuth(i4, decryptMessageFrom);
                    ...
                    case 5:
                        int i5 =
                                bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_USER_ID);
                        byte[] decryptMessageFrom2 =
                                ((IProxyAgentService) this)
                                        .mSecureClientForInAPI.decryptMessageFrom(
                                                string, bundle.getByteArray("EXISTING_PASSWORD"));
                        byte[] decryptMessageFrom3 =
                                ((IProxyAgentService) this)
                                        .mSecureClientForInAPI.decryptMessageFrom(
                                                string, bundle.getByteArray("NEW_PASSWORD"));
                        boolean onPasswordChange =
                                this.mDualDARClient.onPasswordChange(
                                        i5, decryptMessageFrom2, decryptMessageFrom3);
                    ...
                    case 6:
                        int i6 =
                                bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_USER_ID);
                        byte[] decryptMessageFrom4 =
                                ((IProxyAgentService) this)
                                        .mSecureClientForInAPI.decryptMessageFrom(
                                                string, bundle.getByteArray("EXISTING_PASSWORD"));
                        long j = bundle.getLong("RESET_PASSWORD_TOKEN_HANDLE");
                        byte[] decryptMessageFrom5 =
                                ((IProxyAgentService) this)
                                        .mSecureClientForInAPI.decryptMessageFrom(
                                                string,
                                                bundle.getByteArray("RESET_PASSWORD_TOKEN"));
                        boolean onSetResetPasswordToken =
                                this.mDualDARClient.onSetResetPasswordToken(
                                        i6, decryptMessageFrom4, j, decryptMessageFrom5);
                    ...
                    case 7:
                        int i7 =
                                bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_USER_ID);
                        this.mDualDARClient.onClearResetPasswordToken(
                                i7, bundle.getLong("RESET_PASSWORD_TOKEN_HANDLE"));
                    ...
                    case '\b':
                        int i8 =
                                bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_USER_ID);
                        byte[] decryptMessageFrom6 =
                                ((IProxyAgentService) this)
                                        .mSecureClientForInAPI.decryptMessageFrom(
                                                string, bundle.getByteArray("NEW_PASSWORD"));
                        long j2 = bundle.getLong("RESET_PASSWORD_TOKEN_HANDLE");
                        byte[] decryptMessageFrom7 =
                                ((IProxyAgentService) this)
                                        .mSecureClientForInAPI.decryptMessageFrom(
                                                string,
                                                bundle.getByteArray("RESET_PASSWORD_TOKEN"));
                        boolean onResetPasswordWithToken =
                                this.mDualDARClient.onResetPasswordWithToken(
                                        i8, decryptMessageFrom6, j2, decryptMessageFrom7);
                    ...
                    case '\t':
                        bundle2.putBoolean(
                                "dual_dar_response",
                                this.mDualDARClient.isSupported(bundle.getInt("FEATURE")));
                        bundle2.putInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_USER_ID, -1);
                        break;
                    case '\n':
                        int i9 =
                                bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_USER_ID);
                        this.mDualDARClient.onDataLockStateChange(
                                i9, bundle.getBoolean("is_data_locked"));
                        bundle2.putInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_USER_ID, i9);
                        break;
                }
            } catch (Exception e) {
                Log.e(
                        DualDarClientManager.TAG,
                        "Failed to decrypt function params or complete the function invocation");
                e.printStackTrace();
