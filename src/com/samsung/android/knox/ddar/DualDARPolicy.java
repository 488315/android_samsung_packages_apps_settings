...
public class DualDARPolicy {
    ...
    private static final String DUAL_DAR_VERSION_1_7_0 = "1.7.0";
    ...
    public static final String KEY_CONFIG_WHITELISTED_DATA_LOCK_STATE_PACKAGES =
    ...
    public static String getDualDARVersion() {
        return DUAL_DAR_VERSION_1_7_0;
    }

    private IDualDARPolicy getService() {
        if (this.mService == null) {
            this.mService =
                    IDualDARPolicy.Stub.asInterface(
                            ServiceManager.getService(DUAL_DAR_POLICY_SERVICE));
        }
    ...
    public boolean clearResetPasswordTokenForInner() {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "DualDARPolicy.clearResetPasswordTokenForInner");
        IDualDARPolicy iDualDARPolicy = this.mService;
        if (iDualDARPolicy == null) {
            return false;
        }
    ...
    public boolean isActivePasswordSufficientForInner() {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "DualDARPolicy.isActivePasswordSufficientForInner");
        IDualDARPolicy iDualDARPolicy = this.mService;
        if (iDualDARPolicy == null) {
            return false;
        }
    ...
    public boolean isResetPasswordTokenActiveForInner() {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "DualDARPolicy.isResetPasswordTokenActiveForInner");
        IDualDARPolicy iDualDARPolicy = this.mService;
        if (iDualDARPolicy == null) {
            return false;
        }
    ...
    public boolean resetPasswordWithTokenForInner(String str, byte[] bArr) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "DualDARPolicy.resetPasswordWithTokenForInner");
        IDualDARPolicy iDualDARPolicy = this.mService;
        if (iDualDARPolicy == null) {
            return false;
        }
    ...
    public boolean setPasswordMinimumLengthForInner(int i) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "DualDARPolicy.setPasswordMinimumLengthForInner");
        IDualDARPolicy iDualDARPolicy = this.mService;
        if (iDualDARPolicy == null) {
            return false;
        }
    ...
    public boolean setResetPasswordTokenForInner(byte[] bArr) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "DualDARPolicy.setResetPasswordTokenForInner");
        IDualDARPolicy iDualDARPolicy = this.mService;
        if (iDualDARPolicy == null) {
            return false;
        }
