...
public class FirewallRuleTranslator {
    ...
    public static String convertNetworkInterface(Firewall.NetworkInterface networkInterface) {
        ...
        return networkInterface.equals(Firewall.NetworkInterface.WIFI_DATA_ONLY)
                ? networkInterfaceOptions[0]
                : networkInterface.equals(Firewall.NetworkInterface.MOBILE_DATA_ONLY)
                        ? networkInterfaceOptions[1]
                        : networkInterfaceOptions[2];
    }
    ...
    public static String convertPortLocation(Firewall.PortLocation portLocation) {
        ...
        return portLocation.equals(Firewall.PortLocation.REMOTE)
                ? portLocationOptions[0]
                : portLocation.equals(Firewall.PortLocation.LOCAL)
                        ? portLocationOptions[1]
                        : portLocationOptions[2];
    }
    ...
    */
    public static com.samsung.android.knox.net.firewall.FirewallRule translateAllowRule(
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.samsung.android.knox.net.firewall.FirewallRuleTranslator.translateAllowRule(java.lang.String):com.samsung.android.knox.net.firewall.FirewallRule");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.samsung.android.knox.net.firewall.FirewallRule translateDenyRule(
            java.lang.String r11) {
        /*
            r0 = 0
            if (r11 != 0) goto L4
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.samsung.android.knox.net.firewall.FirewallRuleTranslator.translateDenyRule(java.lang.String):com.samsung.android.knox.net.firewall.FirewallRule");
    }
    ...
    public static String translateFirewallRuleToOldFormat(FirewallRule firewallRule) {
        ...
        if (i == 1) {
            ...
            sb.append(";");
            sb.append(convertPortLocation(firewallRule.getPortLocation()));
            if (!"*".equals(firewallRule.getApplication().getPackageName())
                    || !firewallRule
                            .getNetworkInterface()
                            .equals(Firewall.NetworkInterface.ALL_NETWORKS)) {
                sb.append(";");
    ...
    public static FirewallRule translateRedirectExceptionRule(String str) {
        ...
        if (split.length < 1
                || split.length > 2
                || (lastIndexOf = split[0].lastIndexOf(":")) == -1) {
            return null;
        }
        ...
        FirewallRule firewallRule =
                new FirewallRule(
                        FirewallRule.RuleType.REDIRECT_EXCEPTION, Firewall.AddressType.IPV4);
        AppIdentity appIdentity = new AppIdentity(str2, null);
    ...
    public static FirewallRule translateRedirectRule(String str) {
        ...
        FirewallRule firewallRule =
                new FirewallRule(FirewallRule.RuleType.REDIRECT, Firewall.AddressType.IPV4);
        AppIdentity appIdentity = new AppIdentity(str2, null);
        firewallRule.setIpAddress(substring);
        firewallRule.setPortNumber(substring2);
