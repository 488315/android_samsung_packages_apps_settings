...
public class KnoxVpnPolicyConstants {
    public static final String ACTION_BIND_RESULT =
            "com.samsung.android.knox.intent.action.VPN_BIND_RESULT";
    public static final String[] ALLOWED_METHODS_VENDOR_SETTINGS = {
        "getAllVpnProfiles", "removeVpnProfile"
    };
    public static final String ANDROID_SETTINGS_PKG = "com.android.settings";
    public static final String CONTAINER_VPN_PERMISSION =
            "com.samsung.android.knox.permission.KNOX_VPN_CONTAINER";
    public static final String ENTERPRISE_PREMIUM_VPN_POLICY_SERVICE =
            "enterprise_premium_vpn_policy";
    ...
    public static final String EXTRA_BIND_STATUS =
            "com.samsung.android.knox.intent.extra.VPN_BIND_STATUS";
    public static final String EXTRA_BIND_VENDOR =
            "com.samsung.android.knox.intent.extra.VPN_BIND_VENDOR";
    public static final String INTENT_CONTAINER_ADMIN_CHANGED_ACTION =
            "enterprise.container.admin.changed";
    ...
    public static final String NETWORK_TRAFFIC_AGENT_PERMISSION =
    ...
    public static final String VPN_PERMISSION =
