...
public interface IKnoxVpnService extends IInterface {
    public static final String DESCRIPTOR =
            "com.samsung.android.knox.net.vpn.serviceprovider.IKnoxVpnService";
    ...
    public static class Default implements IKnoxVpnService {
        ...
        public boolean setServerCertValidationUserAcceptanceCriteria(
                String str, boolean z, List list, int i) throws RemoteException {
            return false;
        }
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements IKnoxVpnService {
        ...
        public static IKnoxVpnService asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface =
                    iBinder.queryLocalInterface(IKnoxVpnService.DESCRIPTOR);
            return (queryLocalInterface == null
                            || !(queryLocalInterface instanceof IKnoxVpnService))
                    ? new Proxy(iBinder)
                    : (IKnoxVpnService) queryLocalInterface;
        }
            ...
            switch (i) {
                ...
                case 5:
                    ...
                    boolean userCertificate =
                            setUserCertificate(readString4, createByteArray, readString5);
                    parcel2.writeNoException();
                ...
                case 15:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean serverCertValidationUserAcceptanceCriteria =
                            setServerCertValidationUserAcceptanceCriteria(
                                    readString15, readBoolean, readArrayList, readInt2);
                    parcel2.writeNoException();
                ...
                case 16:
                    ...
                    boolean autoRetryOnConnectionError =
                            setAutoRetryOnConnectionError(readString16, readBoolean2);
                    parcel2.writeNoException();
