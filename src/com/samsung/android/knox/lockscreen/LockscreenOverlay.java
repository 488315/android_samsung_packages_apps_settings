...
public class LockscreenOverlay {
    ...
    public static LSOItemData createLSOItem_EmergencyPhone(Context context, String str) {
        ...
        lSOItemWidget.setDimension(
                LSOUtils.convertDipToPixel(context, 100), LSOUtils.convertDipToPixel(context, 200));
    ...
    public static LSOItemData createLSOItem_StyleEnterprise(
            Context context, String str, String str2, String str3, String str4) {
        int rgb = Color.rgb(192, 199, 209);
        String resourceString = LSOUtils.getResourceString(context, R.string.week);
        String resourceString2 = LSOUtils.getResourceString(context, R.string.weeks);
        String resourceString3 = LSOUtils.getResourceString(context, R.string.websearch);
        LSOItemContainer lSOItemContainer = new LSOItemContainer();
        ...
        if (str2 != null) {
            ...
            lSOItemImage.setAttribute(
                    LSOAttrConst.ATTR_MAX_HEIGHT,
                    Integer.valueOf(LSOUtils.convertDipToPixel(context, 75)));
    ...
    public static LSOEmergencyPhoneInfo parseLSOItem_EmergencyPhoneInfo(
            Context context, LSOItemData lSOItemData) {
        ...
        LSOEmergencyPhoneInfo lSOEmergencyPhoneInfo =
                new LSOEmergencyPhoneInfo(ApnSettings.MVNO_NONE);
        lSOEmergencyPhoneInfo.gravity = lSOItemWidget.getGravity();
        if (attrs.containsKey(LSOAttrConst.EPW_ATTR_PHONE_NUMBER)) {
            lSOEmergencyPhoneInfo.phoneNumber =
                    attrs.getAsString(LSOAttrConst.EPW_ATTR_PHONE_NUMBER);
        }
        ...
        if (attrs.containsKey(LSOAttrConst.ATTR_TOP_POSITION)) {
            lSOEmergencyPhoneInfo.topPosition =
                    attrs.getAsInteger(LSOAttrConst.ATTR_TOP_POSITION).intValue();
        }
        if (attrs.containsKey(LSOAttrConst.ATTR_BOTTOM_POSITION)) {
            lSOEmergencyPhoneInfo.bottomPosition =
                    attrs.getAsInteger(LSOAttrConst.ATTR_BOTTOM_POSITION).intValue();
        }
        if (attrs.containsKey(LSOAttrConst.EPW_ATTR_SHOW_BG)) {
            lSOEmergencyPhoneInfo.showBackground =
                    attrs.getAsBoolean(LSOAttrConst.EPW_ATTR_SHOW_BG).booleanValue();
        }
        if (attrs.containsKey(LSOAttrConst.EPW_ATTR_SHOW_DEFAULT_TEXT)) {
            lSOEmergencyPhoneInfo.showDefaultText =
                    attrs.getAsBoolean(LSOAttrConst.EPW_ATTR_SHOW_DEFAULT_TEXT).booleanValue();
        }
    ...
    public int configure(String str, String str2, String str3, String str4) {
        EnterpriseLicenseManager.log(
                this.mContextInfo, "LockscreenOverlay.configure(String, String, String, String)");
        if (str == null || str3 == null || str.length() == 0 || str3.length() == 0) {
            throw new InvalidParameterException("Name and Address cannot be null");
        }
        if (str2 != null
                && str2.length() > 0
                && (str2 = LSOUtils.copyFileToDataLocalDirectory(this.mContext, str2, "logo"))
                        == null) {
            Log.e(TAG, "Failed to copy enterprise logo");
            return -4;
        }
        LSOItemData createLSOItem_StyleEnterprise =
                createLSOItem_StyleEnterprise(this.mContext, str, str2, str3, str4);
    ...
    public int setEmergencyPhoneInfo(LSOEmergencyPhoneInfo lSOEmergencyPhoneInfo) {
        ...
        if (lSOEmergencyPhoneInfo == null
                || (str = lSOEmergencyPhoneInfo.phoneNumber) == null
                || str.length() == 0) {
            throw new InvalidParameterException("Emergency/Support phone cannot be null");
        }
        ...
        if (str2 != null) {
            String copyFileToDataLocalDirectory =
                    LSOUtils.copyFileToDataLocalDirectory(this.mContext, str2, "epw");
        ...
        LSOItemData createLSOItem_EmergencyPhone =
                createLSOItem_EmergencyPhone(this.mContext, lSOEmergencyPhoneInfo);
    ...
    public int setWallpaper(String str) {
        ...
        String copyFileToDataLocalDirectory =
                LSOUtils.copyFileToDataLocalDirectory(this.mContext, str, "wp");
        if (copyFileToDataLocalDirectory == null) {
        ...
        try {
            ParcelFileDescriptor open =
                    ParcelFileDescriptor.open(new File(copyFileToDataLocalDirectory), 268435456);
    ...
    public int configure(LSOImage[] lSOImageArr) {
        ...
        if (lSOImageArr != null && lSOImageArr.length != 0) {
            ...
            if (lSOImage2 != null
                    && lSOImage2.topPosition >= 0
                    && (i = (lSOImage = lSOImageArr[length]).bottomPosition) <= 100
                    && i > lSOImage.topPosition) {
                int i3 = 0;
                while (i3 < length) {
                    LSOImage lSOImage3 = lSOImageArr[i3];
                    if (lSOImage3 != null
                            && (i2 = lSOImage3.bottomPosition) > lSOImage3.topPosition) {
                        i3++;
                        if (i2 <= lSOImageArr[i3].topPosition) {}
                    }
                    throw new InvalidParameterException(
                            "Invalid argument list - Item[i] top > bottom or Item[i+1] top <"
                                + " Item[i] bottom");
                }
                LSOItemContainer lSOItemContainer = new LSOItemContainer();
                ...
                for (int i5 = 0; i5 < lSOImageArr.length; i5++) {
                    if (i4 < lSOImageArr[i5].topPosition) {
                        lSOItemContainer.addItem(
                                new LSOItemSpace(-1, 0, lSOImageArr[i5].topPosition - i4));
                    }
                    String copyFileToDataLocalDirectory =
                            LSOUtils.copyFileToDataLocalDirectory(
                                    this.mContext, lSOImageArr[i5].filePath, "lso" + i5);
                    if (copyFileToDataLocalDirectory == null) {
                    ...
                    lSOItemImage.setDimension(
                            -1, 0, lSOImage4.bottomPosition - lSOImage4.topPosition);
            ...
            throw new InvalidParameterException(
                    "Invalid argument list - Item[0] top position is less than 0, Item[last_index]"
                        + " is greater than 100, or position of Item[0] > Item[last_index]");
        }
        throw new InvalidParameterException("Invalid argument list - List is empty");
    }

    public static LSOItemData createLSOItem_EmergencyPhone(
            Context context, LSOEmergencyPhoneInfo lSOEmergencyPhoneInfo) {
        LSOItemContainer lSOItemContainer = new LSOItemContainer();
        ...
        LSOItemWidget lSOItemWidget = new LSOItemWidget();
        lSOItemWidget.setWidget("com.samsung.android.knox.lockscreen.EmergencyPhoneWidget");
        lSOItemWidget.setAttribute(
                LSOAttrConst.EPW_ATTR_PHONE_NUMBER, lSOEmergencyPhoneInfo.phoneNumber);
        ...
        if (str != null && str.length() > 0) {
            ...
            lSOItemWidget.setAttribute(
                    LSOAttrConst.EPW_ATTR_SHOW_DEFAULT_TEXT,
                    Boolean.valueOf(lSOEmergencyPhoneInfo.showDefaultText));
        }
        String str2 = lSOEmergencyPhoneInfo.icon;
        ...
        lSOItemWidget.setAttribute(LSOAttrConst.ATTR_ORIENTATION, Boolean.TRUE);
        lSOItemWidget.setAttribute(
                LSOAttrConst.EPW_ATTR_SHOW_BG,
                Boolean.valueOf(lSOEmergencyPhoneInfo.showBackground));
        lSOItemWidget.setAttribute(
                LSOAttrConst.ATTR_TOP_POSITION, Integer.valueOf(lSOEmergencyPhoneInfo.topPosition));
        lSOItemWidget.setAttribute(
                LSOAttrConst.ATTR_BOTTOM_POSITION,
                Integer.valueOf(lSOEmergencyPhoneInfo.bottomPosition));
        lSOItemWidget.setGravity(lSOEmergencyPhoneInfo.gravity);
        lSOItemWidget.setDimension(-1, 0);
        lSOItemWidget.setWeight(
                lSOEmergencyPhoneInfo.bottomPosition - lSOEmergencyPhoneInfo.topPosition);
        lSOItemContainer.addItem(lSOItemWidget);
        if (lSOEmergencyPhoneInfo.bottomPosition < 100) {
            lSOItemContainer.addItem(
                    new LSOItemSpace(-1, 0, 100 - lSOEmergencyPhoneInfo.bottomPosition));
        }
        lSOItemContainer.setAttribute(LSOAttrConst.ATTR_ALPHA, Float.valueOf(1.0f));
        lSOItemContainer.setGravity(51);
        return lSOItemContainer;
