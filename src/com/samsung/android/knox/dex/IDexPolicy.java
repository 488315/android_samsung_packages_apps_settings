...
public interface IDexPolicy extends IInterface {
    ...
    public static class Default implements IDexPolicy {
        ...
        @Override // com.samsung.android.knox.dex.IDexPolicy
        public List<String> getPackagesFromDisableList(ContextInfo contextInfo)
                throws RemoteException {
            return null;
        }
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements IDexPolicy {
        ...
        public static IDexPolicy asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IDexPolicy))
                    ? new Proxy(iBinder)
                    : (IDexPolicy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2)
            ...
            switch (i) {
                ...
                case 7:
                    ...
                    parcel.enforceNoDataAvail();
                    int removePackageFromDisableList =
                            removePackageFromDisableList(contextInfo4, readString2);
                    parcel2.writeNoException();
                ...
                case 9:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean allowScreenTimeoutChange =
                            allowScreenTimeoutChange(contextInfo6, readBoolean3);
                    parcel2.writeNoException();
                ...
                case 11:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean enforceVirtualMacAddress =
                            enforceVirtualMacAddress(contextInfo7, readBoolean4);
                    parcel2.writeNoException();
