...
public class KioskMode {
    public static final String ACTION_DISABLE_KIOSK_MODE_RESULT =
            "com.samsung.android.knox.intent.action.DISABLE_KIOSK_MODE_RESULT";
    public static final String ACTION_ENABLE_KIOSK_MODE_RESULT =
            "com.samsung.android.knox.intent.action.ENABLE_KIOSK_MODE_RESULT";
    public static final String ACTION_INFORMATION_STREAM_INTERNAL =
            "com.samsung.android.knox.intent.action.INFORMATION_STREAM_INTERNAL";
    public static String ACTION_REFRESH_HWKEY_INTERNAL =
            "com.samsung.android.knox.intent.action.REFRESH_HWKEY_CACHE_INTERNAL";
    public static final String ACTION_UNEXPECTED_KIOSK_BEHAVIOR =
            "com.samsung.android.knox.intent.action.UNEXPECTED_KIOSK_BEHAVIOR";
    ...
    public static final String EXTRA_BLOCKED_STATUS =
            "com.samsung.android.knox.intent.extra.BLOCKED_STATUS";
    public static final String EXTRA_KIOSK_RESULT =
            "com.samsung.android.knox.intent.extra.KIOSK_RESULT";
            ...
            try {
                if (!list.isEmpty() && !list.contains(null)) {
                    ...
                    int[] allowHardwareKeys =
                            this.mKioskService.allowHardwareKeys(this.mContextInfo, iArr, z);
    ...
    public void disableKioskMode() {
        ...
        this.mContext.sendBroadcast(
                intent, EnterpriseDeviceAdminInfo.USES_POLICY_MDM_KIOSK_MODE_TAG);
    }
    ...
    public void disableKioskMode(final KioskSetting kioskSetting) {
        ...
        if (service != null) {
            Thread thread =
                    new Thread(
                            new Runnable() { // from class:
                                             // com.samsung.android.knox.kiosk.KioskMode.3
                                ...
                                public void run() {
                                    try {
                                        ...
                                        Log.w(
                                                KioskMode.TAG,
                                                "Failed talking with kiosk mode service",
                                                e);
                                    }
                                    ...
                                    IRestrictionPolicy restrictionService =
                                            KioskMode.this.getRestrictionService();
                                    if (restrictionService == null) {
                                        Log.w(
                                                KioskMode.TAG,
                                                "Failed talking with restriction service");
                                    } else {
                                        try {
                                            if (!restrictionService.allowSettingsChanges(
                                                    KioskMode.this.mContextInfo,
                                                    kioskSetting2.settingsChanges)) {
                                                Log.w(
                                                        KioskMode.TAG,
                                                        "allow settings changes failed");
                                            }
                                        } catch (RemoteException e2) {
                                            Log.w(
                                                    KioskMode.TAG,
                                                    "Failed to allow settings changes",
                                                    e2);
                                        }
                                        try {
                                            if (!restrictionService.allowStatusBarExpansion(
                                                    KioskMode.this.mContextInfo,
                                                    kioskSetting2.statusBarExpansion)) {
                                                Log.w(
                                                        KioskMode.TAG,
                                                        "allow status bar expansion failed");
                                            }
                                        } catch (RemoteException e3) {
                                            Log.w(
                                                    KioskMode.TAG,
                                                    "Failed to allow status bar expansion",
                                                    e3);
                                        }
                                        try {
                                            if (!restrictionService.setHomeKeyState(
                                                    KioskMode.this.mContextInfo,
                                                    kioskSetting2.homeKey)) {
                                                Log.w(KioskMode.TAG, "set home key state failed");
                                            }
                                        } catch (RemoteException e4) {
                                            Log.w(
                                                    KioskMode.TAG,
                                                    "Failed to set home key state",
                                                    e4);
                                        }
                                        try {
                                            if (!restrictionService.allowSmartClipMode(
                                                    KioskMode.this.mContextInfo,
                                                    kioskSetting2.smartClip)) {
                                                Log.w(
                                                        KioskMode.TAG,
                                                        "allow smart clip mode failed");
                                            }
                                        } catch (RemoteException e5) {
                                            Log.w(
                                                    KioskMode.TAG,
                                                    "Failed to allow smart clip mode",
                                                    e5);
                                        }
                                    }
                                    try {
                                        if (!service.allowAirCommandMode(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.airCommand)) {
                                            Log.w(KioskMode.TAG, "allow air command failed");
                                        }
                                    } catch (RemoteException e6) {
                                        Log.w(
                                                KioskMode.TAG,
                                                "Failed to allow air command mode",
                                                e6);
                                    }
                                    try {
                                        if (!service.allowAirViewMode(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.airView)) {
                                    ...
                                    if (list != null) {
                                        ...
                                        try {
                                            if (service.allowHardwareKeys(
                                                            KioskMode.this.mContextInfo, iArr, true)
                                                    == null) {
                                            ...
                                            Log.w(
                                                    KioskMode.TAG,
                                                    "Failed to allow hardware keys",
                                                    e8);
                                        }
                                    }
                                    try {
                                        if (!service.allowMultiWindowMode(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.multiWindow)) {
                                            Log.w(KioskMode.TAG, "set multiwindow mode failed");
                                        }
                                    } catch (RemoteException e9) {
                                        Log.w(
                                                KioskMode.TAG,
                                                "Failed to allow multiwindow mode",
                                                e9);
                                    }
                                    try {
                                        if (!service.allowTaskManager(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.taskManager)) {
                                    ...
                                    if (kioskSetting2.clearAllNotifications) {
                                        try {
                                            if (!service.clearAllNotifications(
                                                    KioskMode.this.mContextInfo)) {
                                                Log.w(
                                                        KioskMode.TAG,
                                                        "clear all notifications failed");
                                            }
                                    ...
                                    try {
                                        if (!service.hideNavigationBar(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.navigationBar)) {
                                    ...
                                    try {
                                        if (!service.hideStatusBar(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.statusBar)) {
                                    ...
                                    try {
                                        if (!service.hideSystemBar(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.systemBar)) {
                                    ...
                                    try {
                                        if (service.allowEdgeScreen(
                                                KioskMode.this.mContextInfo,
                                                kioskSetting2.blockedEdgeFunctions,
                                                true)) {
                                            return;
                                        }
            ...
            thread.setUncaughtExceptionHandler(
                    new Thread
                            .UncaughtExceptionHandler() { // from class:
                                                          // com.samsung.android.knox.kiosk.KioskMode.4
    ...
    public void enableKioskMode(final KioskSetting kioskSetting) {
        ...
        if (service != null) {
            Thread thread =
                    new Thread(
                            new Runnable() { // from class:
                                             // com.samsung.android.knox.kiosk.KioskMode.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    KioskSetting kioskSetting2 = kioskSetting;
                                    if (kioskSetting2 == null) {
            ...
            thread.setUncaughtExceptionHandler(
                    new Thread
                            .UncaughtExceptionHandler() { // from class:
                                                          // com.samsung.android.knox.kiosk.KioskMode.2
                        @Override // java.lang.Thread.UncaughtExceptionHandler
                        public void uncaughtException(Thread thread2, Throwable th) {
                            atomicReference.set(th);
                        }
