...
public class CustomDeviceManager {
    ...
    public enum SdkVersion {
        ...
        public String getInternalSdkVersion() {
            String str = toString();
            String replace =
                    str.startsWith("SDK_VERSION")
                            ? str.substring(12).replace('_', '.')
                            : PeripheralConstants.Result.NOT_AVAILABLE;
            int i = 0;
    ...
    public SdkVersion getSdkVersion() {
        int parseInt = Integer.parseInt(DATA.DM_FIELD_INDEX.GZIP_FLAG);
        return parseInt == 24
                ? SdkVersion.SDK_VERSION_3_0
                : parseInt == 25
                        ? SdkVersion.SDK_VERSION_3_1
                        : parseInt == 26
                                ? SdkVersion.SDK_VERSION_3_2
                                : parseInt == 27
                                        ? SdkVersion.SDK_VERSION_3_2_1
                                        : parseInt == 28
                                                ? SdkVersion.SDK_VERSION_3_3
                                                : parseInt == 29
                                                        ? SdkVersion.SDK_VERSION_3_4
                                                        : parseInt == 30
                                                                ? SdkVersion.SDK_VERSION_3_4_1
                                                                : parseInt == 31
                                                                        ? SdkVersion.SDK_VERSION_3_5
                                                                        : parseInt == 32
                                                                                ? SdkVersion
                                                                                        .SDK_VERSION_3_6
                                                                                : parseInt == 33
    ...
    public SystemManager getSystemManager() {
        ...
        return i > 0 ? SystemManager.getInstance(i) : SystemManager.getInstance();
    }

    public boolean laterSdk(SdkVersion sdkVersion) {
        return getSdkVersion().ordinal() > sdkVersion.ordinal();
    }
