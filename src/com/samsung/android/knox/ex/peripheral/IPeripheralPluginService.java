...
public interface IPeripheralPluginService extends IInterface {
    public static final String DESCRIPTOR =
            "com.samsung.android.knox.ex.peripheral.IPeripheralPluginService";
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements IPeripheralPluginService {
        ...
        public static IPeripheralPluginService asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface =
                    iBinder.queryLocalInterface(IPeripheralPluginService.DESCRIPTOR);
            return (queryLocalInterface == null
                            || !(queryLocalInterface instanceof IPeripheralPluginService))
                    ? new Proxy(iBinder)
                    : (IPeripheralPluginService) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2)
            ...
            switch (i) {
                ...
                case 9:
                    ...
                    IResultListener asInterface9 =
                            IResultListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                    int configuration =
                            getConfiguration(readString5, createStringArrayList, asInterface9);
                    parcel2.writeNoException();
                ...
                case 17:
                    ...
                    parcel.enforceNoDataAvail();
                    int resetPeripheral =
                            resetPeripheral(readString14, readString15, asInterface17);
                    parcel2.writeNoException();
                ...
                case 18:
                    ...
                    int triggerVendorCommand =
                            triggerVendorCommand(readString16, readInt, bundle3, asInterface18);
                    parcel2.writeNoException();
                ...
                case 21:
                    ...
                    int connectionProfile2 =
                            setConnectionProfile(readString19, readString20, asInterface21);
                    parcel2.writeNoException();
                ...
                case 24:
                    ...
                    int displayText =
                            displayText(
                                    readString24, readString25, readInt4, bundle6, asInterface24);
                    parcel2.writeNoException();
