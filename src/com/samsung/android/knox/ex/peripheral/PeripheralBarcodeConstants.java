...
public final class PeripheralBarcodeConstants {
    ...
    public static class Option {
        public static final String CODABAR_CHECK_DIGIT_VERIFY_NO_TRANSMIT =
                "CODABAR_CHECK_DIGIT_VERIFY_NO_TRANSMIT";
        public static final String CODABAR_CHECK_DIGIT_VERIFY_TRANSMIT =
        ...
        public static final String CODE39_CHECK_DIGIT_VERIFY_NO_TRANSMIT =
                "CODE39_CHECK_DIGIT_VERIFY_NO_TRANSMIT";
        public static final String CODE39_CHECK_DIGIT_VERIFY_TRANSMIT =
        ...
        public static final String I2OF5_CHECK_DIGIT_VERIFY_NO_TRANSMIT =
                "I2OF5_CHECK_DIGIT_VERIFY_NO_TRANSMIT";
        public static final String I2OF5_CHECK_DIGIT_VERIFY_TRANSMIT =
        ...
        public static final String MSI_VERIFY_CHECK_CHARACTER_TRANSMIT =
                "MSI_VERIFY_CHECK_CHARACTER_TRANSMIT";
        public static final String MSI_VERSION_ON = "MSI_VERSION_ON";
        public static final String PLANETCODE_CHECK_DIGIT_TRANSMIT =
    ...
    public static class Symbology {
        ...
        public static boolean contains(String str) {
            return mType1Ds.contains(str) || mType2Ds.contains(str);
        }

        public static String getType(String str) {
            return mType1Ds.contains(str)
                    ? Type.TYPE_1D
                    : mType2Ds.contains(str) ? Type.TYPE_2D : "NONE";
        }
