...
public interface IStateListener extends IInterface {
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements IStateListener {
        ...
        public static IStateListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStateListener))
                    ? new Proxy(iBinder)
                    : (IStateListener) queryLocalInterface;
        }
