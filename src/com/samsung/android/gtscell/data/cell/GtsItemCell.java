...
public final /* data */ class GtsItemCell implements Parcelable {
    ...
    public static class Creator implements Parcelable.Creator {
        ...
        public final Object createFromParcel(Parcel in) {
            ...
            GtsConfiguration gtsConfiguration =
                    (GtsConfiguration) in.readParcelable(GtsItemCell.class.getClassLoader());
            GtsCellProviderInfo gtsCellProviderInfo =
                    (GtsCellProviderInfo) in.readParcelable(GtsItemCell.class.getClassLoader());
    ...
    public static /* synthetic */ GtsItemCell copy$default(
            GtsItemCell gtsItemCell,
            String str,
            GtsConfiguration gtsConfiguration,
            GtsCellProviderInfo gtsCellProviderInfo,
            List list,
    ...
    public final GtsItemCell copy(
        ...
        Intrinsics.checkParameterIsNotNull(items, "items");
        return new GtsItemCell(
                category, configuration, providerInfo, items, privateCategory, version);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GtsItemCell)) {
            return false;
        }
        GtsItemCell gtsItemCell = (GtsItemCell) other;
        return Intrinsics.areEqual(this.category, gtsItemCell.category)
                && Intrinsics.areEqual(this.configuration, gtsItemCell.configuration)
                && Intrinsics.areEqual(this.providerInfo, gtsItemCell.providerInfo)
                && Intrinsics.areEqual(this.items, gtsItemCell.items)
                && Intrinsics.areEqual(this.privateCategory, gtsItemCell.privateCategory)
                && this.version == gtsItemCell.version;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GtsItemCell(category=");
