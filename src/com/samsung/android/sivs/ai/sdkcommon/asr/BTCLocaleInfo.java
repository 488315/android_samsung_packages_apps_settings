...
public class BTCLocaleInfo extends LocaleInfo {
    public static final Parcelable.Creator<LocaleInfo> CREATOR =
            new Parcelable.Creator<
                    LocaleInfo>() { // from class:
                                    // com.samsung.android.sivs.ai.sdkcommon.asr.BTCLocaleInfo.1
    ...
    public List<TtsPackageInfo> getDefaultPackages() {
        return (List)
                this.ttsPackage.stream()
                        .filter(
                                new Predicate() { // from class:
                                                  // com.samsung.android.sivs.ai.sdkcommon.asr.BTCLocaleInfo$$ExternalSyntheticLambda0
                                    @Override // java.util.function.Predicate
                                    public final boolean test(Object obj) {
                                        boolean lambda$getDefaultPackages$0;
                                        lambda$getDefaultPackages$0 =
                                                BTCLocaleInfo.this.lambda$getDefaultPackages$0(
                                                        (TtsPackageInfo) obj);
    ...
    public String toString() {
        return "BTCLocaleInfo{localeInfo="
                + super.toString()
                + ", defaultSpeaker="
                + this.defaultSpeaker
                + ", speaker="
    ...
    public BTCLocaleInfo(Parcel parcel) {
        ...
        this.defaultSpeaker =
                (TtsSpeakerInfo) parcel.readParcelable(TtsSpeakerInfo.class.getClassLoader());
