...
public class SpeechRecognitionConst {
    public static final String SERVICE_BIND_ACTION =
            "android.intellivoiceservice.speech.RecognitionService";
    public static final String SERVICE_SYSTEM_BIND_ACTION =
            "android.intellivoiceservice.speech.RecognitionSystemService";
    public static final String SYSTEM_PERMISSION_BIND_SERVICE =
            "com.samsung.android.intellivoiceservice.ai.asr.permission.SYSTEM_BIND_SPEECH_RECOGNITION_SERVICE";
    public static final String SYSTEM_PERMISSION_QUERY_CP =
            "com.samsung.android.intellivoiceservice.ai.asr.permission.SYSTEM_SPEECH_RECOGNITION_SERVICE_CONFIG_PROVIDER";
    public static final String SYSTEM_URI_STRING =
            "com.samsung.android.intellivoiceservice.ai.speech2";
    ...
    public static class Method {
        ...
        public static final String CHECK_SPEAKER_DIARIZATION_LANGUAGE_SUPPORT =
                "check_speaker_diarization_language_support";
        ...
        public static final String GET_TARGET_LOCAL_RESOURCE_PACKAGE_NAME =
                "get_target_local_package_name";
    }
