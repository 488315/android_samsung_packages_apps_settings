...
public class AboutLedViewCoverController extends BasePreferenceController
        implements PreferenceControllerMixin {
    private static final String KEY_ABOUT_LED_VIEW_COVER = "about_led_view_cover";
    private SecPreferenceScreen mPreference;

    public AboutLedViewCoverController(Context context) {
        this(context, KEY_ABOUT_LED_VIEW_COVER);
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mPreference =
                (SecPreferenceScreen) preferenceScreen.findPreference(KEY_ABOUT_LED_VIEW_COVER);
        ...
        if (UsefulfeatureUtils.isCoverVerified(this.mContext)
            ...
            return (!Utils.isIntentAvailable(
                                    ...
                                    DisplaySettings$$ExternalSyntheticOutline0.m(
                                            ...
                                            "com.samsung.android.app.ledcover.app.LCoverAboutActivity"))
                            || Utils.isTablet()
    ...
    public AboutLedViewCoverController(Context context, String str) {
        super(context, str);
    }
