...
public class SecSoundVibrationNavigationGesturesController
        extends SecSoundTogglePreferenceController {
    private static final String KEY_NAVIGATION_GESTURES_VIBRATION = "navigation_gestures_vibration";
    private SecSwitchPreference mPreference;

    public SecSoundVibrationNavigationGesturesController(Context context, String str) {
        super(context, str);
    }
    ...
    public int getAvailabilityStatus() {
        return (Rune.isNavigationBarEnabled(this.mContext)
    ...
    public Uri getDatabaseUri() {
        return Settings.System.getUriFor("navigation_gestures_vibrate");
    }
    ...
    public String getPreferenceKey() {
        return KEY_NAVIGATION_GESTURES_VIBRATION;
    }
    ...
    public boolean getThreadEnabled() {
        return Settings.System.getInt(
                        this.mContext.getContentResolver(), "navigation_gestures_vibrate", 1)
                == 1;
    }
    ...
    public boolean setChecked(boolean z) {
        LoggingHelper.insertEventLogging(FileType.SDOCX, 37001, z);
        return Settings.System.putInt(
                this.mContext.getContentResolver(), "navigation_gestures_vibrate", z ? 1 : 0);
    }
