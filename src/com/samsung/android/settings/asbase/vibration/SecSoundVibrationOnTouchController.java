...
public class SecSoundVibrationOnTouchController extends SecSoundTogglePreferenceController {
    private SecSwitchPreference mPreference;

    public SecSoundVibrationOnTouchController(Context context, String str) {
        super(context, str);
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        secSwitchPreference.setTitle(this.mContext.getString(R.string.sec_touch_sounds_title));
    }
    ...
    public Uri getDatabaseUri() {
        return Settings.System.getUriFor("haptic_feedback_enabled");
    }
    ...
    public boolean getThreadEnabled() {
        return Settings.System.getInt(
                        this.mContext.getContentResolver(), "haptic_feedback_enabled", 1)
                == 1;
    }
    ...
    public boolean setChecked(boolean z) {
        LoggingHelper.insertEventLogging(FileType.SDOCX, 4018, z);
        return Settings.System.putInt(
                this.mContext.getContentResolver(), "haptic_feedback_enabled", z ? 1 : 0);
    }
