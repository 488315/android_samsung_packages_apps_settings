...
public class SecVibrationIntensityIncomingCallController
        extends SecVibrationSeekBarPreferenceController {
    private static final AudioAttributes RING_VIBRATION_ATTRIBUTES =
    ...
    private static final VibrationAttributes SEP_VIBRATION_ATTRIBUTES =
            new VibrationAttributes.Builder().setUsage(33).semAddTag("VIRTUAL_VIB_SOUND").build();

    public SecVibrationIntensityIncomingCallController(Context context, String str) {
        super(context, str);
    }

    @Override // com.android.settings.core.BasePreferenceController
    public int getAvailabilityStatus() {
        return (!VibUtils.isSupportDcHaptic(this.mContext) && Utils.isVoiceCapable(this.mContext))
                ? 0
                : 3;
    }
    ...
    public VibrationEffect getEffect(int i) {
        return VibrationEffect.semCreateHaptic(
                Settings.System.getInt(
                        ...
                        i == 0 ? "ringtone_vibration_sep_index" : "ringtone_vibration_sep_index_2",
                        50035),
                0);
    }
    ...
    public Ringtone getRingtone(int i) {
        ...
        if (!VibRune.SUPPORT_SYNC_WITH_HAPTIC
                || (actualDefaultRingtoneUri =
                                RingtoneManager.getActualDefaultRingtoneUri(this.mContext, i2))
                        == null
    ...
    public String getSyncDbName(int i) {
        return i == 0 ? "sync_vibration_with_ringtone" : "sync_vibration_with_ringtone_2";
    }
    ...
    @Override // com.samsung.android.settings.asbase.vibration.SecVibrationSeekBarPreferenceController
    public int getTitle() {
        return R.string.sec_vibration_call;
    }
