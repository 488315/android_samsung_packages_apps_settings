...
public class SecSoundMultiSoundController extends BasePreferenceController {
    private static final String KEY_MULTI_SOUND = "multi_sound";
    private SettingsPreferenceFragment mFragment;

    public SecSoundMultiSoundController(
            Context context,
            SettingsPreferenceFragment settingsPreferenceFragment,
            Lifecycle lifecycle) {
        super(context, KEY_MULTI_SOUND);
        this.mFragment = settingsPreferenceFragment;
    }

    @Override // com.android.settings.core.BasePreferenceController
    public int getAvailabilityStatus() {
        return ActivityManager.getCurrentUser() != 0 ? 3 : 0;
    }
