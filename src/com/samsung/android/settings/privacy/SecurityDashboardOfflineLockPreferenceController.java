...
public class SecurityDashboardOfflineLockPreferenceController extends BasePreferenceController {
    private static final String OFFLINE_LOCK_ONBOARDING_FRAGMENT =
            "com.samsung.android.settings.privacy.SecurityDashboardOfflineLockDisclaimerFragment";
    private final boolean mIsOfflineLockSupported;
    protected boolean mIsScreenLockSet;
    protected boolean mOfflineLockOnBoardingStatus;
    private Fragment mParentFragment;
    private SecPreference mPreference;

    public SecurityDashboardOfflineLockPreferenceController(Context context, String str) {
        super(context, str);
        this.mIsOfflineLockSupported = SecurityDashboardUtils.isOfflineLockSupported(context);
    }

    private void updateMenuStatus() {
        if (this.mIsScreenLockSet || !this.mOfflineLockOnBoardingStatus) {
            return;
        }
    ...
    private void updateParameters() {
        ...
        this.mOfflineLockOnBoardingStatus =
    ...
    public int getAvailabilityStatus() {
        ...
        updateParameters();
        if (this.mOfflineLockOnBoardingStatus) {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (!"key_offline_lock".equals(preference.getKey())) {
            return super.handlePreferenceTreeClick(preference);
        }
        if (!this.mOfflineLockOnBoardingStatus) {
            SecurityDashboardUtils.startFragment(
                    R.string.theft_protection_offline_lock_menu_title,
                    this.mParentFragment,
                    OFFLINE_LOCK_ONBOARDING_FRAGMENT);
            return true;
        }
