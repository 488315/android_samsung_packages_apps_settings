...
public class CustomizationServicePreferenceController extends BasePreferenceController {
    public CustomizationServicePreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public int getAvailabilityStatus() {
        return (Build.VERSION.SEM_PLATFORM_INT >= 110100
                        && PrivacyUtils.isSupportRuneStonePackage(this.mContext)
                        && Rune.isChinaModel())
                ? 0
                : 3;
    }
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        LoggingHelper.insertEventLogging(getMetricsCategory(), 56020);
