...
public class SecurityDashboardTheftDetectionSwitchController extends TogglePreferenceController {
    ...
    protected boolean mIsTheftProtectionOnBoarded;
    private SecSwitchPreference mPreference;

    public SecurityDashboardTheftDetectionSwitchController(Context context, String str) {
        super(context, str);
                                ...
                                .setNegativeButton(
                                        ...
                                        new DialogInterface
                                                .OnClickListener() { // from class:
                                                                     // com.samsung.android.settings.privacy.SecurityDashboardTheftDetectionSwitchController$$ExternalSyntheticLambda0
                                            @Override // android.content.DialogInterface.OnClickListener
                                            public final void onClick(
                                                    DialogInterface dialogInterface, int i) {
                                                SecurityDashboardTheftDetectionSwitchController.this
                ...
                .authenticate(
                        ...
                        new BiometricPrompt
                                .AuthenticationCallback() { // from class:
                                                            // com.samsung.android.settings.privacy.SecurityDashboardTheftDetectionSwitchController.1
                            @Override // android.hardware.biometrics.BiometricPrompt.AuthenticationCallback
                            public final void onAuthenticationError(
                                    int i, CharSequence charSequence) {
                                SecurityDashboardTheftDetectionSwitchController.this.mPreference
                                        .setChecked(true);
                            }
    ...
    public /* synthetic */ boolean lambda$displayPreference$0(Preference preference, Object obj) {
        LoggingHelper.insertEventLogging(54101, 54201, this.mPreference.isChecked() ? 0L : 1L);
        if (this.mPreference.isChecked()) {
            authenticate();
        } else {
            Settings.Secure.putInt(
                    this.mContext.getContentResolver(), "theft_detection_lock_setting", 1);
    ...
    private void updateParameters() {
        ...
        this.mIsTheftProtectionOnBoarded =
        ...
        secSwitchPreference.setOnPreferenceChangeListener(
                new Preference
                        .OnPreferenceChangeListener() { // from class:
                                                        // com.samsung.android.settings.privacy.SecurityDashboardTheftDetectionSwitchController$$ExternalSyntheticLambda1
    ...
    public int getAvailabilityStatus() {
        ...
        boolean z =
                Settings.Secure.getInt(
                                ...
                                0)
                        != 0;
        boolean z2 = this.mIsTheftProtectionOnBoarded;
    ...
    public boolean getThreadEnabled() {
        return Settings.Secure.getInt(
                        this.mContext.getContentResolver(), "theft_detection_lock_setting", 0)
                != 0;
    }
