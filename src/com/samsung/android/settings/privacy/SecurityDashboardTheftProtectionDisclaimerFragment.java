...
public class SecurityDashboardTheftProtectionDisclaimerFragment extends Fragment {
    ...
    public final View onCreateView(
        ...
        View inflate =
                layoutInflater.inflate(
                        R.layout.sec_security_and_privacy_theft_protection_onboard_settings,
                        viewGroup,
                        false);
                ...
                .setOnClickListener(
                        new View
                                .OnClickListener() { // from class:
                                                     // com.samsung.android.settings.privacy.SecurityDashboardTheftProtectionDisclaimerFragment$$ExternalSyntheticLambda0
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                SecurityDashboardTheftProtectionDisclaimerFragment
                                        securityDashboardTheftProtectionDisclaimerFragment =
                                                SecurityDashboardTheftProtectionDisclaimerFragment
                                                        .this;
                                ...
                                SharedPreferences.Editor edit =
                                        activity.getSharedPreferences(
                                                ...
                                                .edit();
                                edit.putBoolean(
                                        "key_theft_detection_lock_on_boarding_status", true);
                                edit.commit();
