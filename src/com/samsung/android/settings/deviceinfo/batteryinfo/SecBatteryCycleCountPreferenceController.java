...
public class SecBatteryCycleCountPreferenceController
        extends BatteryRegulatoryPreferenceController {
    private static final String FILE_2ND_BATTERY_CYCLE_INFO =
            "/efs/FactoryApp/batt_discharge_level_2nd";
    private static final String FILE_BATTERY_CYCLE_INFO = "/efs/FactoryApp/batt_discharge_level";

    public SecBatteryCycleCountPreferenceController(Context context, String str) {
        super(context, str);
    }

    private String getCycleCountInfo(String str) {
        ...
        try {
            ...
            CloneBackend$$ExternalSyntheticOutline0.m(
                    e,
                    new StringBuilder("batt_discharge_level - format Error : "),
    ...
    public String getSummaryForBattery_Main() {
        return getCycleCountInfo(FILE_BATTERY_CYCLE_INFO);
    }

    @Override // com.samsung.android.settings.deviceinfo.batteryinfo.BatteryRegulatoryPreferenceController
    public String getSummaryForBattery_Sub() {
        return getCycleCountInfo(FILE_2ND_BATTERY_CYCLE_INFO);
    }
