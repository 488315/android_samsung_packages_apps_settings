...
public class StatusInfoPreferenceController extends BasePreferenceController {
    public StatusInfoPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (Rune.SUPPORT_SMARTMANAGER_CN) {
            if (SecDeviceInfoUtils.checkRootingCondition()) {
