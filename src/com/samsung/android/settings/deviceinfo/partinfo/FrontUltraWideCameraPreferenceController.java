...
public class FrontUltraWideCameraPreferenceController extends PartReplacementPreferenceController {
    private static final String MODULE_NAME_FRONT_ULTRA_WIDE_CAMERA = "front_ultra_wide";

    public FrontUltraWideCameraPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public String getPartReplacementFileName() {
        return getMapForCameraModuleId().get(MODULE_NAME_FRONT_ULTRA_WIDE_CAMERA);
    }
