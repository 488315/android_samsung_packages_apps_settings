...
public class ScreenPreferenceController extends PartReplacementPreferenceController {
    private static final String FILE_NAME_SCREEN_INFO = "SVC_OCTA";

    public ScreenPreferenceController(Context context, String str) {
        super(context, str);
    }
