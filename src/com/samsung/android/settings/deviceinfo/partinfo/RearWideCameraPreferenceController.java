...
public class RearWideCameraPreferenceController extends PartReplacementPreferenceController {
    private static final String MODULE_NAME_REAR_WIDE_CAMERA = "rear_wide";

    public RearWideCameraPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public String getPartReplacementFileName() {
        return getMapForCameraModuleId().get(MODULE_NAME_REAR_WIDE_CAMERA);
    }
