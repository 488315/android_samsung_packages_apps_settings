...
public class CoverScreenPreferenceController extends PartReplacementPreferenceController {
    private static final String FILE_NAME_COVER_SCREEN_INFO = "SVC_OCTA2";

    public CoverScreenPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public int getAvailabilityStatus() {
        char c = Utils.isTablet() ? (char) 2 : (char) 0;
        if (c == 3 || c == 1) {
    ...
    public String getPartReplacementFileName() {
        return FILE_NAME_COVER_SCREEN_INFO;
    }
