...
public class InnerCameraPreferenceController extends PartReplacementPreferenceController {
    private static final String MODULE_NAME_INNER_CAMERA = "inner";

    public InnerCameraPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public String getPartReplacementFileName() {
        return getMapForCameraModuleId().get(MODULE_NAME_INNER_CAMERA);
    }
