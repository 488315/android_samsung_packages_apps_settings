...
public class RearUltraWideCameraPreferenceController extends PartReplacementPreferenceController {
    private static final String MODULE_NAME_REAR_ULTRA_WIDE_CAMERA = "rear_ultra_wide";

    public RearUltraWideCameraPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public String getPartReplacementFileName() {
        return getMapForCameraModuleId().get(MODULE_NAME_REAR_ULTRA_WIDE_CAMERA);
    }
