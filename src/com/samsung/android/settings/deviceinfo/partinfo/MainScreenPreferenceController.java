...
public class MainScreenPreferenceController extends PartReplacementPreferenceController {
    private static final String FILE_NAME_MAIN_SCREEN_INFO = "SVC_OCTA";

    public MainScreenPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public String getPartReplacementFileName() {
        return FILE_NAME_MAIN_SCREEN_INFO;
    }
