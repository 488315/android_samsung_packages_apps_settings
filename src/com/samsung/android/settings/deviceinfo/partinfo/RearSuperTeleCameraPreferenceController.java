...
public class RearSuperTeleCameraPreferenceController extends PartReplacementPreferenceController {
    private static final String MODULE_NAME_REAR_SUPER_TELE_CAMERA = "rear_super_tele";

    public RearSuperTeleCameraPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public String getPartReplacementFileName() {
        return getMapForCameraModuleId().get(MODULE_NAME_REAR_SUPER_TELE_CAMERA);
    }
