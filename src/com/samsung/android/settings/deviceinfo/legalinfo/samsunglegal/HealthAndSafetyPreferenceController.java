...
public class HealthAndSafetyPreferenceController extends BasePreferenceController {
    public HealthAndSafetyPreferenceController(Context context, String str) {
        super(context, str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$displayPreference$0(Preference preference) {
        LoggingHelper.insertEventLogging(9508, 9509);
        return false;
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        findPreference.setOnPreferenceClickListener(
                new HealthAndSafetyPreferenceController$$ExternalSyntheticLambda0());
    }
