...
public class ServiceInformationPreferenceController extends BasePreferenceController {
    public ServiceInformationPreferenceController(Context context, String str) {
        super(context, str);
    }
