...
public class AutofillPickerWorkFragment extends DashboardFragment {
    ...
    public final String getTAG() {
        return "AutofillPickerWorkFragment";
    }
    ...
    public final int getPreferenceScreenResId() {
        return (getContext() == null || !CredentialManager.isServiceEnabled(getContext()))
                ? R.xml.sec_default_autofill_picker_work_settings
                : R.xml.sec_default_autofill_picker_work_settings_credman;
    }
        ...
        ((CredentialManagerPreferenceController) use(CredentialManagerPreferenceController.class))
                .init(
                        ...
                        new CredentialManagerPreferenceController
                                .Delegate() { // from class:
                                              // com.samsung.android.settings.general.AutofillPickerWorkFragment.1
                            ...
                            public final void forceDelegateRefresh() {
                                AutofillPickerWorkFragment.this.forceUpdatePreferences();
                            }

                            @Override // com.android.settings.applications.credentials.CredentialManagerPreferenceController.Delegate
                            public final void setActivityResult(int i) {
                                AutofillPickerWorkFragment.this.getActivity().setResult(i);
                            }
                        },
                        true);
    }
