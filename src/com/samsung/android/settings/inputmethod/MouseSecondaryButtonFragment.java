...
public class MouseSecondaryButtonFragment extends CustomMousePreference {
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    /* renamed from: com.samsung.android.settings.inputmethod.MouseSecondaryButtonFragment$1, reason: invalid class name */
    public final class AnonymousClass1 extends BaseResetSettingsData {
        ...
        public final void resetSettings(Context context) {
            Settings.System.putInt(
                    context.getContentResolver(), "mouse_secondary_button_option", 1);
            Settings.System.putString(
                    context.getContentResolver(),
                    MouseFunctionKeyInfo.getMouseFunctionDBKey(10),
                    null);
        }
    }
    ...
    public final void onAttach(Context context) {
        ...
        this.mMouseButtonValue =
                context.getResources().getStringArray(R.array.key_mouse_secondary_button_values);
