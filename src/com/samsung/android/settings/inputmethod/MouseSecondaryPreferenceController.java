...
public class MouseSecondaryPreferenceController extends SecCustomPreferenceController {
    private static final String TAG = "MouseSecondaryPreferenceController";

    public MouseSecondaryPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public CharSequence getSummary() {
        return InputMethodUtils.getMouseButtonFeatureTitle(
                this.mContext,
                Settings.System.getInt(
                        this.mContext.getContentResolver(), "mouse_secondary_button_option", 1));
    }
