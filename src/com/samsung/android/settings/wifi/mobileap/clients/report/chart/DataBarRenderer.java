...
public final class DataBarRenderer extends AbsRoundBarRenderer {
    public final void drawBufferDataSet(
            ...
            if (viewPortHandler.isInBoundsLeft(f)) {
                ...
                if (i6 != this.mMissingIndex) {
                    if ((i6 + 1) % 4 == 0) {
                        ...
                        canvas.drawRoundRect(f2, f3, f4, f5, 0.0f, 0.0f, this.mRenderPaint);
                    }
                }
            }
            i += this.mEntrySize;
    ...
    public final void drawDataSet(Canvas canvas, BarDataSet barDataSet, int i) {
        ...
        if (i3 != 0) {
            ...
            if (fArr.length % i3 == 0 && this.mMissingIndex != -1 && fArr.length >= i2) {
                ...
                drawBufferDataSet(canvas, this.mAdjustedBuffer, barDataSet, z);
                return;
            }
        }
        drawBufferDataSet(canvas, this.mBuffer.buffer, barDataSet, z);
    }
