...
public class WifiApConfigureMacAddressTypeDropDownController extends BasePreferenceController
        implements LifecycleEventObserver, Preference.OnPreferenceChangeListener {
    private static final String BUNDLE_KEY_MAC_ADDRESS_TYPE_DROPDOWN_VALUE =
            "bundle_key_mac_address_type_dropdown_value";
    public static final String KEY_PREFERENCE = "mac_address_type_dropdown_preference";
    private static final String TAG = "WifiApConfigureMacAddressTypeDropDownController";
    private Context mContext;
    private DropDownPreference mThisDropDownPreference;
    private WifiApEditSettings mWifiApConfigureSettings;

    public WifiApConfigureMacAddressTypeDropDownController(Context context, String str) {
        super(context, str);
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mThisDropDownPreference.setEntries(
                this.mContext
                        ...
                        .getStringArray(
                                Utils.isTablet()
                                        ? R.array.wifi_ap_mac_address_type_tablet_entries
                                        : R.array.wifi_ap_mac_address_type_phone_entries));
        this.mThisDropDownPreference.mEntryValues =
                this.mContext
                        .getResources()
                        .getStringArray(R.array.wifi_ap_mac_address_type_entry_values);
        setValueIndex(
    ...
    public boolean isValueModified() {
        ...
        if (isAvailable()) {
            ...
            DynamicDenylistManager$$ExternalSyntheticOutline0.m(
                    "Values, Old: ", ", New: ", i, dropDownValue, TAG);
            if (i != dropDownValue) {
                z = true;
            }
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        SALogging.insertSALog(parseInt == 1 ? 0L : 1L, "TETH_012", "8016");
        return true;
    }

    public void onRestoreInstanceState(Bundle bundle) {
        if (isAvailable() && bundle.containsKey(BUNDLE_KEY_MAC_ADDRESS_TYPE_DROPDOWN_VALUE)) {
            String string = bundle.getString(BUNDLE_KEY_MAC_ADDRESS_TYPE_DROPDOWN_VALUE);
