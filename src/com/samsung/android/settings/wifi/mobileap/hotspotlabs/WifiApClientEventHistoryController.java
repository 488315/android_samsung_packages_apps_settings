...
public class WifiApClientEventHistoryController extends BasePreferenceController {
    private static String TAG = "WifiApClientEventHistoryController";
    private Context mContext;
    private WifiApPreference mThisPreference;
    WifiApHotspotLabs mWifiApHotspotLabs;

    public WifiApClientEventHistoryController(Context context, String str) {
        super(context, str);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (TextUtils.equals(preference.getKey(), getPreferenceKey())) {
            Log.d(TAG, "Client Event history preference clicked ");
            SubSettingLauncher subSettingLauncher = new SubSettingLauncher(this.mContext);
            int metricsCategory = getMetricsCategory();
            SubSettingLauncher.LaunchRequest launchRequest = subSettingLauncher.mLaunchRequest;
            launchRequest.mSourceMetricsCategory = metricsCategory;
            launchRequest.mTitle = "Client Event History";
            launchRequest.mDestinationName = WifiApClientEventHistory.class.getCanonicalName();
