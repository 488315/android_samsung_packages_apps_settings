...
public class WifiApHotspotChannelSwitchHistory extends DashboardFragment
    ...
    public final int getPreferenceScreenResId() {
        return R.xml.sec_wifi_ap_hotspot_lab_channel_switch_history_screen;
    }
    ...
    public final void onActivityCreated(Bundle bundle) {
        ...
        while (it.hasNext()) {
            ...
            wifiApPreference.mSummaryMaxLines = 20;
