...
public class WifiApHotspotConnectionHistoryController extends BasePreferenceController {
    private static String TAG = "WifiApHotspotConnectionHistoryController";
    private Context mContext;
    private WifiApPreference mThisPreference;
    WifiApHotspotLabs mWifiApHotspotLabs;

    public WifiApHotspotConnectionHistoryController(Context context, String str) {
        super(context, str);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (TextUtils.equals(preference.getKey(), getPreferenceKey())) {
            Log.d(TAG, "Hotspot Connection History preference clicked ");
        }
