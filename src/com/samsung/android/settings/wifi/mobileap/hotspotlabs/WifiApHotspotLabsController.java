...
public class WifiApHotspotLabsController extends BasePreferenceController {
    private static final String TAG = "WifiApConfigureBroadcastChannelDropDownController";
    private Context mContext;
    private PreferenceScreen mThisPreferenceScreen;
    private WifiApEditSettings mWifiApConfigureSettings;

    public WifiApHotspotLabsController(Context context, String str) {
        super(context, str);
    ...
    public void updateState(Preference preference) {
        Log.i(TAG, "updateState() -" + preference.getKey());
        super.updateState(preference);
        this.mThisPreferenceScreen.setVisible(
