...
public class WifiApHotspotChannelSwitchHistoryController extends BasePreferenceController {
    private static String TAG = "WifiApHotspotChannelSwitchHistoryController";
    private Context mContext;
    private WifiApPreference mThisPreference;
    WifiApHotspotLabs mWifiApHotspotLabs;

    public WifiApHotspotChannelSwitchHistoryController(Context context, String str) {
        super(context, str);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (TextUtils.equals(preference.getKey(), getPreferenceKey())) {
            Log.d(TAG, "Hotspot Channel switch History preference clicked.");
        }
