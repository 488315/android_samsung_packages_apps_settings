...
public class SliderTickMarkItem extends GtsItemWrapper {
    ...
    public final GtsExpressionRaw buildExpression(GtsExpressionBuilder gtsExpressionBuilder) {
        return gtsExpressionBuilder
                ...
                .addSubExpression(
                        new GtsExpressionBuilder.LevelExpressionBuilder()
                                .setLevel(Integer.parseInt(this.mControlValue.getValue()))
