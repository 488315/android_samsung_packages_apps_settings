...
public class BiometricsAboutUnlockPreferenceController extends BasePreferenceController {
    public static final String KEY_SCREEN_TRANSITION_EFFECT = "key_about_unlock_biometrics";
    ...
    public BiometricsAboutUnlockPreferenceController(Context context) {
    ...
    public BiometricsAboutUnlockPreferenceController(Context context, String str) {
        super(context, str);
