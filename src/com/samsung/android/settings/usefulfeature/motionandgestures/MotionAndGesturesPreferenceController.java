...
public final class MotionAndGesturesPreferenceController extends BasePreferenceController {
    public static final int $stable = 0;

    public MotionAndGesturesPreferenceController(Context context, String str) {
        super(context, str);
    }
