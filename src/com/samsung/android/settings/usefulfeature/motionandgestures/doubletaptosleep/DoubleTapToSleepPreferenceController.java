package com.samsung.android.settings.usefulfeature.motionandgestures.doubletaptosleep;
...
public class DoubleTapToSleepPreferenceController extends SecMotionAndGestureBaseController {
    private SecSwitchPreference mPreference;

    public DoubleTapToSleepPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public ArrayList<Uri> getUriListRequiringObservation() {
        ...
        arrayList.add(Settings.Secure.getUriFor("enabled_accessibility_services"));
        arrayList.add(Settings.System.getUriFor("double_tap_to_sleep"));
        return arrayList;
    }
    ...
    public boolean getThreadEnabled() {
        return Settings.System.getInt(this.mContext.getContentResolver(), "double_tap_to_sleep", 0)
                != 0;
    }
    ...
    public boolean setChecked(boolean z) {
        Settings.System.putInt(
                this.mContext.getContentResolver(), "double_tap_to_sleep", z ? 1 : 0);
        LoggingHelper.insertEventLogging(7604, 7468, z);
        return true;
    }
    ...
    public void updatePreference() {
        ...
        if (secSwitchPreference != null) {
            Context context = this.mContext;
            boolean z = UsefulfeatureUtils.mAccessibilityEnabled;
            secSwitchPreference.setVisible(
