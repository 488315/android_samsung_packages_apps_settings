package com.samsung.android.settings.usefulfeature.motionandgestures.doubletaptowakeup;
...
public class DoubleTapToWakeUpPreferenceController extends SecMotionAndGestureBaseController {
    private SecSwitchPreference mPreference;

    public DoubleTapToWakeUpPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public int getAvailabilityStatus() {
        return !Rune.supportDoubleTapMenu() ? 3 : 0;
    }
    ...
    public ArrayList<Uri> getUriListRequiringObservation() {
        ...
        arrayList.add(Settings.System.getUriFor("double_tab_to_wake_up"));
        return arrayList;
    }
    ...
    public boolean setChecked(boolean z) {
        Settings.System.putInt(
                this.mContext.getContentResolver(), "double_tab_to_wake_up", z ? 1 : 0);
        LoggingHelper.insertEventLogging(7604, 7467, z);
        return true;
    }
