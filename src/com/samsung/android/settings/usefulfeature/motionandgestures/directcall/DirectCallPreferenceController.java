package com.samsung.android.settings.usefulfeature.motionandgestures.directcall;
...
public class DirectCallPreferenceController extends SecMotionAndGestureBaseController {
    private SecSwitchPreference mPreference;

    public DirectCallPreferenceController(Context context, String str) {
        super(context, str);
    }

    private int getSummaryForDirectCallSwitch() {
        ...
        return (applicationInfo == null || !applicationInfo.enabled)
                ? R.string.pick_up_to_call_out_guide_content_except_message
                : R.string.pick_up_to_call_out_guide_content;
    }
    ...
    public ArrayList<Uri> getUriListRequiringObservation() {
        ...
        arrayList.add(Settings.System.getUriFor("motion_pick_up_to_call_out"));
        return arrayList;
    }
    ...
    public boolean getThreadEnabled() {
        return (isDirectCallEnabled()
                        || Settings.System.getInt(
                                        this.mContext.getContentResolver(),
                                        "motion_pick_up_to_call_out",
                                        0)
                                == 0)
                ? false
                : true;
    ...
    public boolean setChecked(boolean z) {
        LoggingHelper.insertEventLogging(7604, 4371, z);
        Settings.System.putInt(
                this.mContext.getContentResolver(), "motion_pick_up_to_call_out", z ? 1 : 0);
        return true;
    }
