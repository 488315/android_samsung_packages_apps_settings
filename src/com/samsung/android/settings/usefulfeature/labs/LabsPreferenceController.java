...
@Metadata(
        ...
        d2 = {
            "Lcom/samsung/android/settings/usefulfeature/labs/LabsPreferenceController;",
...
public final class LabsPreferenceController extends BasePreferenceController {
    public static final int $stable = 0;

    public LabsPreferenceController(Context context, String str) {
        super(context, str);
    }
