...
public class FullScreenInSplitScreenViewPreferenceController extends TogglePreferenceController {
    public static final StatusLogger$StatusLoggingProvider STATUS_LOGGING_PROVIDER =
            new AnonymousClass1();
    private static final String TAG = "FullScreenInSplitScreenViewPreferenceController";
    private SecSwitchPreferenceScreen mPreference;

    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    /* renamed from: com.samsung.android.settings.usefulfeature.multiwindow.fullscreeninsplitscreenview.FullScreenInSplitScreenViewPreferenceController$1, reason: invalid class name */
    public final class AnonymousClass1 extends BaseStatusLoggingProvider {
        ...
        public final List getStatusLoggingData(Context context) {
            ...
            String valueOf = String.valueOf(68101);
            String str =
    ...
    public FullScreenInSplitScreenViewPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public Intent getLaunchIntent() {
        ...
        String name = FullScreenInSplitScreenViewSettings.class.getName();
        SubSettingLauncher.LaunchRequest launchRequest = subSettingLauncher.mLaunchRequest;
        launchRequest.mDestinationName = name;
        launchRequest.mSourceMetricsCategory = Integer.parseInt("68111");
        return SecAccountPreferenceController$$ExternalSyntheticOutline0.m(
                subSettingLauncher,
                null,
                com.android.settings.R.string.sec_full_screen_in_split_screen_view_title,
                268468224);
    }
    ...
    public boolean getThreadEnabled() {
        return MultiWindowManager.getInstance().isSplitImmersiveModeEnabled();
    }
    ...
    public boolean setChecked(boolean z) {
        ...
        LoggingHelper.insertEventLogging(78000, 68101, z);
        return true;
    }
