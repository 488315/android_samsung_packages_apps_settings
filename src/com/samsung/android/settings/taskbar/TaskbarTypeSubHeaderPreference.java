...
public class TaskbarTypeSubHeaderPreference extends SecSubHeaderPreference {
    public final String headerDesc;

    public TaskbarTypeSubHeaderPreference(Context context, AttributeSet attributeSet) {
