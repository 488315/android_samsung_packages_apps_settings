...
public class TopLevelSoftwareUpdatePreferenceController extends TopLevelPreferenceController {
    public TopLevelSoftwareUpdatePreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public int getAvailabilityStatus() {
        if (!Utils.isPackageEnabled(this.mContext, "com.wssyncmldm")) {
            return 3;
        }
    ...
    public CharSequence getSummary() {
        ...
        arrayList.add(this.mContext.getString(R.string.sec_download_and_install));
    ...
    public void updateState(Preference preference) {
        ...
        preference.setDotVisibility(SoftwareUpdateUtils.getFotaBadgeCount(this.mContext) > 0);
    }
