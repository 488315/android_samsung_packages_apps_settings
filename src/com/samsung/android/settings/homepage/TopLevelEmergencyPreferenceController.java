...
public class TopLevelEmergencyPreferenceController extends TopLevelPreferenceController {
    public TopLevelEmergencyPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public CharSequence getSummary() {
        ...
        arrayList.add(this.mContext.getString(R.string.sec_emergency_medical_info));
        Context context = this.mContext;
        StringBuilder sb = Utils.sBuilder;
        TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
        if (telephonyManager != null && telephonyManager.isSmsCapable()) {
            arrayList.add(this.mContext.getString(R.string.wireless_emergency_alerts));
        }
