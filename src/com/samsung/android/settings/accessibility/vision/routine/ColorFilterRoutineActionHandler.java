...
public class ColorFilterRoutineActionHandler extends AccessibilityRoutineSimpleOnOffActionHandler {
    ...
    public String getActionTag() {
        return "accessibility_color_filter";
    }
    ...
    public String getTitle(Context context) {
        return context.getString(R.string.colour_lens_title);
    }
