...
public class HighLightButtonPreferenceController extends TogglePreferenceController
        implements AccessibilityObservableController,
                AccessibilityUsingFunction,
                A11yStatusLoggingProvider {
    public HighLightButtonPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public Map<String, String> getStatusLoggingData(Context context) {
        return Map.of("A11YS3041", A11yStatusLoggingUtil.getSwitchStatus(getThreadEnabled()));
    }
    ...
    public List<Uri> getUriList() {
        return List.of(Settings.Global.getUriFor("show_button_background"));
    }
    ...
    public CharSequence getUsingFunctionTitle(Context context) {
        return context.getText(R.string.high_light_buttons_title);
    }
    ...
    public boolean setChecked(boolean z) {
        Settings.Global.putInt(
                this.mContext.getContentResolver(), "show_button_background", z ? 1 : 0);
        SecAccessibilityUtils.setButtonShape(this.mContext, z);
