...
public class MagnifierCameraPreferenceController extends BasePreferenceController
        implements A11yStatusLoggingProvider {
    private static final String TAG = "MagnifierCameraPreferenceController";

    public MagnifierCameraPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public int getAvailabilityStatus() {
        if (WizardManagerHelper.isUserSetupComplete(this.mContext)) {
            return !Utils.hasPackage(this.mContext, "com.sec.android.app.magnifier") ? 3 : 0;
        }
        return 4;
    }
