...
public class MagnificationTypePreferenceController extends BasePreferenceController {
    public MagnificationTypePreferenceController(Context context, String str) {
        super(context, str);
    }
