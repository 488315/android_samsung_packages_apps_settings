...
public class SoundNotificationPreferenceController extends AccessibilityShortcutPreferenceController
        implements GoogleAppPreferenceController {
    public SoundNotificationPreferenceController(Context context, String str) {
        super(context, str);
    }

    @Override // com.android.settings.core.BasePreferenceController
    public int getAvailabilityStatus() {
        if (SystemProperties.getInt(TouchPadGestureSettingsController.FIRST_API_LEVEL, 20) < 30) {
            return 3;
        }
        Rune.isChinaModel();
    ...
    public ComponentName getComponentName() {
        return AccessibilityConstant.COMPONENT_NAME_GOOGLE_SOUND_NOTIFICATION_SHORTCUT;
    }
    ...
    public void updateDynamicRawDataToIndex(List<SearchIndexableRaw> list) {
        ...
        searchIndexableRaw.keywords = this.mContext.getString(R.string.keywords_sound_notification);
