...
public class HearingAidsPreferenceController extends BasePreferenceController {
    private HearingAidHelper mHelper;

    public HearingAidsPreferenceController(Context context, String str) {
        super(context, str);
    ...
    public int getAvailabilityStatus() {
        ...
        return (hearingAidHelper == null || hearingAidHelper.isHearingAidSupported()) ? 0 : 3;
    }
