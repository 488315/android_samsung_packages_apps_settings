...
import com.android.settings.accessibility.HearingAidCompatibilityPreferenceController;
...
public class SecHearingAidCompatibilityPreferenceController
        extends HearingAidCompatibilityPreferenceController
        implements AccessibilityObservableController,
                AccessibilityUsingFunction,
                A11yStatusLoggingProvider {
    protected HearingAidHelper mHelper;

    public SecHearingAidCompatibilityPreferenceController(Context context, String str) {
        super(context, str);
    ...
    @Override // com.android.settings.accessibility.HearingAidCompatibilityPreferenceController,
    ...
    public int getAvailabilityStatus() {
        ...
        HearingAidHelper hearingAidHelper = this.mHelper;
        return ((hearingAidHelper == null || hearingAidHelper.isHearingAidSupported())
    ...
    public Map<String, String> getStatusLoggingData(Context context) {
        ...
        return Map.of("A11YS4004", getThreadEnabled() ? "On" : "Off");
    }
    ...
    public List<Uri> getUriList() {
        return List.of(Settings.System.getUriFor("hearing_aid"));
    }
    ...
    public CharSequence getUsingFunctionTitle(Context context) {
        return context.getText(R.string.accessibility_hac_mode_title);
    }
