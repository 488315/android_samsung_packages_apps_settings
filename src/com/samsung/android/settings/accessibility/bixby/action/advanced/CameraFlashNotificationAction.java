...
public final class CameraFlashNotificationAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.advanced.flashnotification.SecCameraFlashNotificationPreferenceController";
    }
    ...
    public final String getDestinationFragment() {
        return "com.samsung.android.settings.accessibility.advanced.flashnotification.CameraFlashNotificationAppPickerFragment";
    }
    ...
    public final int getTitleRes() {
        return R.string.flash_notification_camera_flash;
    }
}
