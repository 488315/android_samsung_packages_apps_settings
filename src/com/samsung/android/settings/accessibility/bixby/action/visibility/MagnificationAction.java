...
public final class MagnificationAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.vision.controllers.MagnificationPreferenceController";
    }
    ...
    public final int getTitleRes() {
        return R.string.accessibility_screen_magnification_title;
    }
}
