...
public final class HearingAidCompatibilityAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.hearing.controllers.SecHearingAidCompatibilityPreferenceController";
    }
    ...
    public final int getTitleRes() {
        return R.string.accessibility_hac_mode_title;
    }
}
