package com.samsung.android.settings.accessibility.bixby.action.spoken;
...
public final class AudioDescriptionAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.vision.controllers.SecAudioDescriptionPreferenceController";
    }
    ...
    public final int getTitleRes() {
        return R.string.vision_enhancements_title;
    }
}
