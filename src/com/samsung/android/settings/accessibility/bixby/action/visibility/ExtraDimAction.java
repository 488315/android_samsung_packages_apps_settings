...
public final class ExtraDimAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.vision.controllers.ReduceBrightColorsPreferenceController";
    }
    ...
    public final String getDestinationFragment() {
        return "com.android.settings.accessibility.ToggleReduceBrightColorsPreferenceFragment";
    }
