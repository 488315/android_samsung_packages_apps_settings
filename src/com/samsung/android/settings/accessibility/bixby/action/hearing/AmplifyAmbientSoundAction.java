...
public final class AmplifyAmbientSoundAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.hearing.controllers.AmplifyAmbientSoundPreferenceController";
    }
    ...
    public final int getTitleRes() {
        return R.string.amplify_ambient_sound_title;
    }
}
