...
public final class AdaptSoundAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.hearing.controllers.AdaptSoundController";
    }
    ...
    public final Intent getPunchoutIntent(Context context) {
        return new Intent("com.sec.hearingadjust.launch");
    }
}
