...
public final class MonoAudioAction extends BixbyControllerAction {
    ...
    public final String getDestinationFragment() {
        return SecAccessibilityUtils.isSupportStereoSpeaker()
                ? "com.samsung.android.settings.accessibility.hearing.MonoAudioFragment"
                : "com.samsung.android.settings.accessibility.hearing.HearingEnhancementsFragment";
    }

    @Override // com.samsung.android.settings.accessibility.bixby.action.BixbyActionTarget
    public final int getTitleRes() {
        return R.string.accessibility_toggle_primary_mono_title;
    }
}
