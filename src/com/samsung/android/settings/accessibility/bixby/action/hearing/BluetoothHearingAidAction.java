...
public final class BluetoothHearingAidAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.hearing.controllers.SecAccessibilityHearingAidPreferenceController";
    }
    ...
    public final int getTitleRes() {
        return R.string.bluetooth_hearing_aid_title;
    }
}
