...
public final class LiveCaptionAction extends BixbyControllerAction {
    ...
    public final String getControllerName(Context context) {
        return "com.samsung.android.settings.accessibility.hearing.controllers.SecLiveCaptionPreferenceController";
    }
    ...
    public final Intent getPunchoutIntent(Context context) {
        return new Intent("com.android.settings.action.live_caption");
    }
}
