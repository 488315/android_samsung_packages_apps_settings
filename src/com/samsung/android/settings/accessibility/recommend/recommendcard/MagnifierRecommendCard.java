...
public final class MagnifierRecommendCard implements RecommendCardItem {
    ...
    public final CharSequence getCardContent(Context context) {
        return context.getText(R.string.recommend_magnifier_widget_content);
    }
    ...
    public final boolean isAvailable(Context context) {
        return Utils.hasPackage(context, "com.sec.android.app.magnifier");
    }
}
