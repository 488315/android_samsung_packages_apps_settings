...
public final class BixbyQuickCommandRecommendCard implements RecommendCardItem {
    ...
    public final RecommendCardItem.ActionButtonInfo getActionButtonInfo(final Context context) {
        return new RecommendCardItem.ActionButtonInfo() { // from class:
            // com.samsung.android.settings.accessibility.recommend.recommendcard.BixbyQuickCommandRecommendCard.1
                ...
                try {
                    context.startActivity(
                            new Intent(
                                            ...
                                            Uri.parse(
                                                    "bixbyvoice://com.samsung.android.bixby.agent/GoToFeature?featureName=QuickCommandRecommendations"))
                                    .setFlags(268435456));
                } catch (ActivityNotFoundException e) {
                    Log.w("BixbyQuickCommandRecommendCard", "Activity not found", e);
                }
            }
        };
    }
    ...
    public final CharSequence getCardContent(Context context) {
        return context.getText(R.string.recommend_quick_command_content);
    }
