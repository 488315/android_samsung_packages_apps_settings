...
public final class RoutineRecommendCardForNoProfile extends AbstractRoutineRecommendCard {
    ...
    public final CharSequence getCardContent(Context context) {
        return context.getText(R.string.recommend_routine_for_no_profile_content);
    }
