...
public final class RoutineRecommendCardForAAS extends AbstractRoutineRecommendCard {
    ...
    public final CharSequence getCardContent(Context context) {
        return context.getText(R.string.recommend_routine_amplify_ambient_sound_content);
    }
