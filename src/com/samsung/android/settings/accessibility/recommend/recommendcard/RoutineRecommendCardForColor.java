...
public final class RoutineRecommendCardForColor extends AbstractRoutineRecommendCard {
    ...
    public final CharSequence getCardContent(Context context) {
        return context.getText(R.string.recommend_routine_color_inversion_content);
    }
