...
public final class RoutineRecommendCardForSoundMode extends AbstractRoutineRecommendCard {
    ...
    public final CharSequence getCardContent(Context context) {
        return context.getText(R.string.recommend_routine_sound_mode_content);
    }
