...
public final class CameraFlashNotificationTryItem extends FlashNotificationsTryItem {
    @Override // com.samsung.android.settings.accessibility.recommend.tryitem.TryItem
    public final CharSequence getTitle() {
        return this.mContext.getText(R.string.flash_notification_camera_flash);
    }
    ...
    public final boolean isTurnedOnState() {
        ...
        return flashNotificationsState == 3 || flashNotificationsState == 1;
    }
}
