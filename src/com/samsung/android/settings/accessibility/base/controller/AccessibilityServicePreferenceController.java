...
public abstract class AccessibilityServicePreferenceController
        extends AccessibilityRestrictedPreferenceController {
    public AccessibilityServicePreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public RestrictedPreference getRestrictedPreference(ComponentName componentName) {
        AccessibilityServiceInfo accessibilityServiceInfo =
                SecAccessibilityUtils.getAccessibilityServiceInfo(this.mContext, componentName);
