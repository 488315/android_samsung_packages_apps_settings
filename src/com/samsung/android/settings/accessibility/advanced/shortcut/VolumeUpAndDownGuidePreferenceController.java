...
public class VolumeUpAndDownGuidePreferenceController extends ShortcutGuidePreferenceController
        implements A11yStatusLoggingProvider {
    public VolumeUpAndDownGuidePreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public Map<String, String> getStatusLoggingData(Context context) {
        ...
        return Map.of("A11YS6003", String.valueOf(i));
    }
