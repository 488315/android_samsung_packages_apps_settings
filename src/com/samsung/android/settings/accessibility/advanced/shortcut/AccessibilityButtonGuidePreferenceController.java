...
public class AccessibilityButtonGuidePreferenceController extends ShortcutGuidePreferenceController
        implements A11yStatusLoggingProvider {
    public AccessibilityButtonGuidePreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public Map<String, String> getStatusLoggingData(Context context) {
        ...
        return Map.of("A11YS6031", String.valueOf(i));
    }
    ...
    @Override // com.samsung.android.settings.accessibility.advanced.shortcut.ShortcutGuidePreferenceController, com.android.settingslib.core.AbstractPreferenceController
