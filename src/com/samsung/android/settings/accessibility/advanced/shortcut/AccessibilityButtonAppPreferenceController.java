...
public class AccessibilityButtonAppPreferenceController extends ShortcutGuidePreferenceController
        implements A11yStatusLoggingProvider {
    public AccessibilityButtonAppPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public Map<String, String> getStatusLoggingData(Context context) {
        ...
        return Map.of("A11YS6008", String.valueOf(i));
    }
