...
public class QuickSettingsPreferenceController extends ShortcutGuidePreferenceController
        implements A11yStatusLoggingProvider {
    public QuickSettingsPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public Map<String, String> getStatusLoggingData(Context context) {
        String string =
                Settings.Secure.getString(context.getContentResolver(), "accessibility_qs_targets");
        ...
        return Map.of("A11YS6030", String.valueOf(i));
    }
