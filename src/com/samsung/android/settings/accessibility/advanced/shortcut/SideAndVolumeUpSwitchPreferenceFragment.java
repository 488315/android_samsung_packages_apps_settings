...
public class SideAndVolumeUpSwitchPreferenceFragment extends ShortcutSwitchPreferenceFragment {
    ...
    public final String getDbKey() {
        return "accessibility_direct_access_target_service";
    }

    @Override // com.samsung.android.settings.accessibility.advanced.shortcut.ShortcutSwitchPreferenceFragment
    public final int getDescriptionResId() {
        return R.string.accessibility_shortcut_side_and_volume_up_summary;
    }

    @Override // com.android.settings.dashboard.DashboardFragment
    public final String getLogTag() {
        return "SideAndVolumeUpSwitchPreferenceFragment";
    }
