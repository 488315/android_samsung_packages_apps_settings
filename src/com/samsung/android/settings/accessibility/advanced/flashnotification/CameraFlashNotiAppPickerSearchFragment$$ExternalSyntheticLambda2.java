...
public final /* synthetic */ class CameraFlashNotiAppPickerSearchFragment$$ExternalSyntheticLambda2
    ...
    public final void onSearchFilterCompleted(int i) {
        ...
        if (i < 1) {
            cameraFlashNotiAppPickerSearchFragment.loadingViewController.showEmpty();
        } else {
