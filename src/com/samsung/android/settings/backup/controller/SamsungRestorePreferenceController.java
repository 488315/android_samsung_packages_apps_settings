...
public class SamsungRestorePreferenceController extends BasePreferenceController
    ...
    private static final String TAG = "SamsungRestorePreferenceController";
            ...
            try {
                if (AccountUtils.isSamsungAccountExists(this.mContext)) {
                    ...
                    AccountUtils.addSamsungAccount(
                            this.mContext, this.mParentFragment, 1003, 1, UserHandle.myUserId());
                }
    ...
    public void init(Fragment fragment) {
        ...
        this.mIntent = new Intent("com.samsung.android.scloud.SCLOUD_RESTORE");
    }
