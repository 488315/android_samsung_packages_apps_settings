...
public class BluetoothCastPreferenceController extends TogglePreferenceController {
    ...
    public BluetoothCastPreferenceController(Context context, String str) {
        super(context, str);
        this.isCheck = false;
    ...
    public int getAvailabilityStatus() {
        ...
        return !SemBluetoothCastAdapter.isBluetoothCastSupported() ? 3 : 0;
    }
    ...
    public boolean setChecked(boolean z) {
        return Settings.Secure.putInt(
                this.mContext.getContentResolver(), BLUETOOTH_CAST_MODE, z ? 1 : 0);
    }
