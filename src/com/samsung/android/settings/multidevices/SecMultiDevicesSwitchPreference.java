...
public class SecMultiDevicesSwitchPreference extends SecSwitchPreference {
    public SecMultiDevicesSwitchPreference(Context context, AttributeSet attributeSet) {
