...
public final class AsAppCache implements AsSubListInterface {
    @Override // com.samsung.android.settings.analyzestorage.ui.pages.analyzestorage.AsSubListInterface
    public final int getIconResId() {
        return R.drawable.as_sub_list_app_cache;
    }

    @Override // com.samsung.android.settings.analyzestorage.ui.pages.analyzestorage.AsSubListInterface
    public final int getItemViewResId() {
        return R.id.as_sub_list_app_cache;
    }

    @Override // com.samsung.android.settings.analyzestorage.ui.pages.analyzestorage.AsSubListInterface
    public final String getListSubTitle(Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        String string = context.getString(R.string.as_app_cache_sub_text);
