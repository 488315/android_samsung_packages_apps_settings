...
public final class AsDuplicatedFiles implements AsSubListInterface {
    @Override // com.samsung.android.settings.analyzestorage.ui.pages.analyzestorage.AsSubListInterface
    public final int getIconResId() {
        return R.drawable.as_sub_list_duplicated_files;
    }
    ...
    public final String getListSubTitle(Context context) {
        ...
        String string = context.getString(R.string.as_duplicate_files_sub_text);
    ...
    public final int getListTitleResId() {
        return R.string.as_duplicate_files;
    }
