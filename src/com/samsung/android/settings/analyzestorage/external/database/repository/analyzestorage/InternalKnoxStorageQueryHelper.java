...
public final class InternalKnoxStorageQueryHelper extends LocalStorageQueryHelper {
    ...
    public final String getRootPath() {
        return StoragePathUtils.getInternalKnoxStoragePath(this.mContext);
    }
    ...
    public final int getUserId() {
        ...
        if (userInfoCheckerImpl != null) {
            return userInfoCheckerImpl.getWorkProfileUserId(context);
        }
