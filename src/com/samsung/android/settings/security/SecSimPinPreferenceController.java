...
public class SecSimPinPreferenceController extends BasePreferenceController {
    private static final String TAG = "SecIccLockSettings.SecSimPinPreferenceController";
    private SecIccLockManager mIccLockManager;

    public SecSimPinPreferenceController(Context context, String str) {
        super(context, str);
    }
            ...
            if (this.mIccLockManager.isCTCSlot1()) {
                findPreference.setTitle(
                        this.mContext
                                ...
                                .getResources()
                                .getString(R.string.sim_pin_change)
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        SecSimPinDialog.show(this.mContext, this.mIccLockManager);
        return true;
    }
