...
public class SecDataLimitController extends SecCustomPreferenceController {
    private static final String TAG = "SecBillingCycleSettings.SecDataLimitController";
    private SecBillingCycleSettings mParent;

    public SecDataLimitController(Context context, String str) {
        super(context, str);
    }
    ...
    public CharSequence getSummary() {
        long policyLimitBytes =
                SecBillingCycleManager.getInstance(this.mContext).getPolicyLimitBytes();
        return policyLimitBytes != -1
                ? DataUsageUtils.formatDataUsage(this.mContext, policyLimitBytes)
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        LoggingHelper.insertEventLogging(getMetricsCategory(), 7124);
        SecBytesEditorFragment.show(this.mParent, true, (SecPreference) preference, false);
        return true;
    }
    ...
    public ControlResult setValue(ControlValue controlValue) {
        ...
        try {
            ...
            SecBillingCycleManager.getInstance(this.mContext).setPolicyLimitBytes(parseLong);
    ...
    public void updateState(Preference preference) {
        ...
        } else if (secBillingCycleManager.getPolicyLimitBytes() != -1) {
