...
public class SecWifiDataUsagePreferenceController extends BasePreferenceController {
    private static String TAG = "SecWifiDataUsagePreferenceController";
    private static long sSecureFolderTotalBytes;
    private DataUsageController mDataUsageController;
    private DataUsageController.DataUsageInfo mDataUsageInfo;
    private NetworkTemplate mNetworkTemplate;

    public SecWifiDataUsagePreferenceController(Context context, String str) {
        super(context, str);
        this.mNetworkTemplate = new NetworkTemplate.Builder(4).build();
    ...
    public Intent getLaunchIntent() {
        ...
        subSettingLauncher.setTitleRes(R.string.wifi_data_usage, null);
            ...
            new SecManagedProfileNetworkStatsSummaryLoader(
                            ...
                            new SecManagedProfileNetworkStatsSummaryLoader
                                    .NetworkStatsLoaderResponse() { // from class:
                                                                    // com.samsung.android.settings.datausage.SecWifiDataUsagePreferenceController.1
                                ...
                                public final void setNetworkStatsData(NetworkStats networkStats) {
                                    SecWifiDataUsagePreferenceController
                                            secWifiDataUsagePreferenceController =
                                                    SecWifiDataUsagePreferenceController.this;
                                    SecWifiDataUsagePreferenceController.sSecureFolderTotalBytes =
                                            KnoxUtils.bindStats(
                                    ...
                                    if (secWifiDataUsagePreferenceController.mDataUsageInfo
                                            != null) {
                                        secWifiDataUsagePreferenceController.refreshSummary(
                                                preference2);
                                    }
                                }
                            })
