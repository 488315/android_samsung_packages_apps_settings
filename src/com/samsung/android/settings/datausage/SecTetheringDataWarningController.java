...
public class SecTetheringDataWarningController extends BasePreferenceController {
    private static final String TAG = "SecTetheringDataWarningController";
    private SecBillingCycleSettings mParent;

    public SecTetheringDataWarningController(Context context, String str) {
        super(context, str);
    }
    ...
    public int getAvailabilityStatus() {
        ...
        return (secBillingCycleManager.getAvailableBillingCycleSetting()
                        ...
                        && secBillingCycleManager.getTetheringDataWarningValue().longValue() != -1)
                ? 0
                : 2;
    }
    ...
    public CharSequence getSummary() {
        Long tetheringDataWarningValue =
                SecBillingCycleManager.getInstance(this.mContext).getTetheringDataWarningValue();
        return tetheringDataWarningValue != -1L
                ? DataUsageUtils.formatDataUsage(
                        this.mContext, tetheringDataWarningValue.longValue())
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        SecBytesEditorFragment.show(this.mParent, false, (SecPreference) preference, true);
        return true;
    }
