...
public class ContextExt {
    public static final UserHandle OWNER =
            (UserHandle) ReflectionUtils.getValueOf("OWNER", (Class<?>) UserHandle.class);
    public static final UserHandle CURRENT_OR_SELF =
            (UserHandle) ReflectionUtils.getValueOf("CURRENT_OR_SELF", (Class<?>) UserHandle.class);
    public static final UserHandle CURRENT =
            (UserHandle) ReflectionUtils.getValueOf("CURRENT", (Class<?>) UserHandle.class);
    public static final UserHandle ALL =
            (UserHandle) ReflectionUtils.getValueOf("ALL", (Class<?>) UserHandle.class);
    public static final String STATUS_BAR_SERVICE =
            (String) ReflectionUtils.getValueOf("STATUS_BAR_SERVICE", (Class<?>) Context.class);
    ...
    public static void sendBroadcastAsUser(Context context, Intent intent, UserHandle userHandle) {
        try {
            ReflectionUtils.invoke(
                    context.getClass()
                            .getMethod("sendBroadcastAsUser", Intent.class, UserHandle.class),
                    context,
                    intent,
                    userHandle);
        } catch (IllegalStateException | NoSuchMethodException e) {
