...
public class ConnectivityManagerExt {
    ...
    public static boolean removeRouteToHostAddress(
            ConnectivityManager connectivityManager, int i, InetAddress inetAddress) {
        try {
            return ((Boolean)
    ...
    public static boolean requestRouteToHostAddress(
            ConnectivityManager connectivityManager, int i, InetAddress inetAddress) {
        try {
            return ((Boolean)
                            ReflectionUtils.invoke2(
