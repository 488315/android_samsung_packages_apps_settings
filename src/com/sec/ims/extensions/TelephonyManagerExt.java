...
public class TelephonyManagerExt {
    ...
    public static byte[] getCurrentUATI(Context context) {
        try {
            ...
            Method declaredMethod =
                    Class.forName(TelephonyManager.class.getName())
                            .getDeclaredMethod("getITelephony", null);
            ...
            return (byte[])
                    invoke.getClass().getMethod("getCurrentUATI", null).invoke(invoke, null);
        ...
        try {
            return (String)
                    ReflectionUtils.invoke2(
                            TelephonyManager.class.getMethod("getNetworkTypeName", Integer.TYPE),
                            null,
                            Integer.valueOf(i));
    ...
    public static byte[] getPsismsc(TelephonyManager telephonyManager, int i) {
        try {
            return (byte[])
                    ReflectionUtils.invoke2(
                            TelephonyManager.class.getMethod("getPsismsc", Integer.TYPE),
                            telephonyManager,
                            Integer.valueOf(i));
        } catch (IllegalStateException | NoSuchMethodException e) {
            e.printStackTrace();
