...
public interface IVolteService extends IInterface {
    ...
    void deRegisterForVolteServiceEvent(
            int i, IVolteServiceEventListener iVolteServiceEventListener) throws RemoteException;
    ...
    void registerImsRegistrationListener(
            IImsRegistrationListener iImsRegistrationListener, boolean z, int i)
            throws RemoteException;
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements IVolteService {
        ...
        public static class Proxy implements IVolteService {
            ...
            @Override // com.sec.ims.volte2.IVolteService
            public void deRegisterForVolteServiceEvent(
                    int i, IVolteServiceEventListener iVolteServiceEventListener)
                    throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            @Override // com.sec.ims.volte2.IVolteService
            public void deregisterForCallStateEventForSlot(
                    int i, IImsCallEventListener iImsCallEventListener) throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(IVolteService.DESCRIPTOR);
            ...
            @Override // com.sec.ims.volte2.IVolteService
            public void registerForCallStateEventForSlot(
                    int i, IImsCallEventListener iImsCallEventListener) throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            @Override // com.sec.ims.volte2.IVolteService
            public void registerForVolteServiceEvent(
                    int i, IVolteServiceEventListener iVolteServiceEventListener)
                    throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
                Parcel obtain2 = Parcel.obtain();
        ...
        public static IVolteService asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IVolteService))
                    ? new Proxy(iBinder)
                    : (IVolteService) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2)
            ...
            switch (i) {
                case 1:
                    ...
                    IVolteServiceEventListener asInterface =
                            IVolteServiceEventListener.Stub.asInterface(parcel.readStrongBinder());
                ...
                case 2:
                    ...
                    IVolteServiceEventListener asInterface2 =
                            IVolteServiceEventListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                    ...
                    return true;
                case 3:
                    IImsRegistrationListener asInterface3 =
                    ...
                    return true;
                case 4:
                    IImsRegistrationListener asInterface4 =
                            IImsRegistrationListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                ...
                case 7:
                    ...
                    parcel.enforceNoDataAvail();
                    IImsCallSession createSessionWithRegId =
                            createSessionWithRegId(callProfile2, readInt6);
                    parcel2.writeNoException();
                ...
                case 10:
                    ...
                    return true;
                case 11:
                    IImsCallEventListener asInterface5 =
                    ...
                    return true;
                case 12:
                    IImsCallEventListener asInterface6 =
                            IImsCallEventListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                ...
                case 13:
                    ...
                    IImsCallEventListener asInterface7 =
                            IImsCallEventListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                ...
                case 14:
                    ...
                    IImsCallEventListener asInterface8 =
                            IImsCallEventListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                ...
                case 22:
                    ...
                    IRttEventListener asInterface9 =
                ...
                case 23:
                    ...
                    IRttEventListener asInterface10 =
                            IRttEventListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                ...
                case 26:
                    ...
                    ImsRegistration[] registrationInfoByPhoneId =
                            getRegistrationInfoByPhoneId(readInt20);
                    parcel2.writeNoException();
                ...
                case 30:
                    ...
                    int startLocalRingBackTone =
                            startLocalRingBackTone(readInt25, readInt26, readInt27);
                    parcel2.writeNoException();
