...
public class QuantumSecurityInfo implements Parcelable {
    public static final Parcelable.Creator<QuantumSecurityInfo> CREATOR =
            new Parcelable.Creator<
                    QuantumSecurityInfo>() { // from class:
                                             // com.sec.ims.volte2.data.QuantumSecurityInfo.1
    ...
    public QuantumSecurityInfo() {
        ...
        this.mCryptoMode = 0;
        this.mQtSessionId = ApnSettings.MVNO_NONE;
        this.mRemoteTelNum = ApnSettings.MVNO_NONE;
        this.mSessionKey = ApnSettings.MVNO_NONE;
        this.mLocalPhoneNumber = ApnSettings.MVNO_NONE;
    }
    ...
    public String toString() {
        return "QuantumSecurityInfo [mEncryptStatus="
                + this.mEncryptStatus
                + ", mPeerProfileStatus="
                + this.mPeerProfileStatus
                + ", mCallDirection="
                + this.mCallDirection
                + ", mCryptoMode="
                + this.mCryptoMode
                + ", mQtSessionId="
                + IMSLog.checker(this.mQtSessionId)
                + ", mSessionKey="
                + IMSLog.checker(this.mSessionKey)
                + ", mLocalPhoneNumber="
                + IMSLog.checker(this.mLocalPhoneNumber)
                + ", mRemoteTelNum="
                + IMSLog.checker(this.mRemoteTelNum)
                + "]";
    }
