...
public class MediaProfile implements Parcelable {
    public static final Parcelable.Creator<MediaProfile> CREATOR =
            new Parcelable.Creator<
                    MediaProfile>() { // from class: com.sec.ims.volte2.data.MediaProfile.1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.os.Parcelable.Creator
                public MediaProfile createFromParcel(Parcel parcel) {
                    return new MediaProfile(0, parcel);
                }
    ...
    public /* synthetic */ MediaProfile(int i, Parcel parcel) {
        this(parcel);
    }
    ...
    public MediaProfile() {
        ...
        this.mAudioBitRate = ApnSettings.MVNO_NONE;
    ...
    public MediaProfile(VolteConstants.AudioCodecType audioCodecType, String str) {
        VolteConstants.AudioCodecType audioCodecType2 =
                VolteConstants.AudioCodecType.AUDIO_CODEC_NONE;
        this.mAudioQuality = 0;
        this.mVideoQuality = 0;
        this.mVideoOrientation = 0;
        this.mWidth = 0;
    ...
    private MediaProfile(Parcel parcel) {
        VolteConstants.AudioCodecType audioCodecType =
                VolteConstants.AudioCodecType.AUDIO_CODEC_NONE;
        this.mAudioCodec = audioCodecType;
        this.mAudioBitRate = ApnSettings.MVNO_NONE;
        this.mAudioQuality = 0;
