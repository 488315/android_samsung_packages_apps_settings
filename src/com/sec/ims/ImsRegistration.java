...
public class ImsRegistration implements Parcelable {
    ...
    public static final Parcelable.Creator<ImsRegistration> CREATOR =
            new Parcelable.Creator<ImsRegistration>() { // from class: com.sec.ims.ImsRegistration.1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.os.Parcelable.Creator
                public ImsRegistration createFromParcel(Parcel parcel) {
                    return new ImsRegistration(0, parcel);
                }
    ...
    public /* synthetic */ ImsRegistration(int i, Parcel parcel) {
        this(parcel);
    }
    ...
    public String getOwnNumber() {
        String msisdn;
        if (getPreferredImpu() == null
                || getPreferredImpu().getUri() == null
                || (msisdn = getPreferredImpu().getUri().getMsisdn()) == null) {
            return null;
        }
        return msisdn;
    }
    ...
    public NameAddr getPreferredImpu() {
        ...
        return nameAddr != null
                ? nameAddr
                : new NameAddr(ApnSettings.MVNO_NONE, ApnSettings.MVNO_NONE);
    }
    ...
    public String toString() {
        if (SHIP_BUILD) {
            ...
            return Anchor$$ExternalSyntheticOutline0.m(sb, this.mDeregiReason, "]");
        }
        ...
        return Anchor$$ExternalSyntheticOutline0.m(sb2, this.mDeregiReason, "]");
    }
    ...
    private ImsRegistration(Parcel parcel) {
        ...
        this.mPAssociatedUri2nd = ApnSettings.MVNO_NONE;
        this.mUuid = ApnSettings.MVNO_NONE;
        ...
        this.mPreferredPublicUserId =
                (NameAddr) parcel.readParcelable(NameAddr.class.getClassLoader());
        ArrayList arrayList = new ArrayList();
