...
public class DATA {
    ...
    public static class DM_FIELD_INDEX {
        ...
        @Deprecated public static final String EPDG_HANDOVER_ENABLED = "904";

        @Deprecated public static final String EPDG_TH1X = "908";

        @Deprecated public static final String EPDG_THLTE1 = "905";

        @Deprecated public static final String EPDG_THLTE2 = "906";

        @Deprecated public static final String EPDG_THLTE3 = "907";

        @Deprecated public static final String EPDG_T_EPDG_1X = "913";

        @Deprecated public static final String EPDG_T_EPDG_LTE = "911";

        @Deprecated public static final String EPDG_T_EPDG_WIFI = "912";

        @Deprecated public static final String EPDG_VOWT_A = "909";

        @Deprecated public static final String EPDG_VOWT_B = "910";
        ...
        @Deprecated public static final String SHOW_REG_INFO_TO_SETTING_APP = "900";

        @Deprecated public static final String SHOW_VOLTE_REGI_ICON = "901";

        @Deprecated public static final String SHOW_VOWIFI_REGI_ICON = "902";
        ...
        @Deprecated public static final String VOWIFI_SUPPORTED = "903";
    ...
    public static class DM_NODE {
        ...
        @Deprecated public static final String EAB_SETTING_BY_USER = "presence";
        ...
        public static final String ICSI_RSC_ALLOC_MODE =
                "ICSI_List/ICSI_List_1/ICSI_Resource_Allocation_Mode";
        ...
        public static final String LBO_PCSCF_ADDRESS =
                "LBO_P-CSCF_Address/LBO_P-CSCF_Address_1/Address";
        public static final String LBO_PCSCF_ADDRESS_TYPE =
                "LBO_P-CSCF_Address/LBO_P-CSCF_Address_1/AddressType";
        public static final String LVC_BETA_SETTING = "LVC_BETA_SETTING";
        public static final String LVC_ENABLED = "LVC_ENABLED";

        @Deprecated public static final String LVC_ENABLED_BY_USER = "mmtel-video";
        ...
        public static final String PUBLIC_USER_ID =
                "Public_user_identity_List/Public_user_identity_List_1/Public_user_identity";
        ...
        @Deprecated public static final String VOLTE_ENABLED_BY_USER = "mmtel";
    ...
    public static class URI {
        public static final String CONFIG_PROVIDER =
                "content://com.samsung.rcs.autoconfigurationprovider/";
        public static final String DMCONFIG_PROVIDER =
                "content://com.samsung.rcs.dmconfigurationprovider/";
    }
    ...
    static {
        ...
        DATA$$ExternalSyntheticOutline0.m(
                46, 0, DM_NODE.PUBLISH_ERR_RETRY_TIMER, DM_FIELD_LIST, 46);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                52, 0, DM_NODE.URI_MEDIA_RSC_SERV_3WAY_CALL, DM_FIELD_LIST, 52);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                65, 0, DM_NODE.AMR_WB_BANDWITH_EFFICIENT, DM_FIELD_LIST, 65);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                72, 0, DM_NODE.VOLTE_PREF_SERVICE_STATUS, DM_FIELD_LIST, 72);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                81, 0, DM_NODE.VOICE_DOMAIN_PREF_EUTRAN, DM_FIELD_LIST, 81);
        DATA$$ExternalSyntheticOutline0.m(
                82, 0, DM_NODE.VOICE_DOMAIN_PREF_UTRAN, DM_FIELD_LIST, 82);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                104, 0, DM_NODE.UT_APN_SETTING_UI_SHOW, DM_FIELD_LIST, 104);
        DATA$$ExternalSyntheticOutline0.m(
                105, 0, DM_NODE.CONF_FACTORY_URI_SHOW, DM_FIELD_LIST, 105);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                112, 0, DM_NODE.SS_CSFB_WITH_IMSERROR, DM_FIELD_LIST, 112);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                124, 5, RcsConfigurationReader.IR94_VIDEO_AUTH, DM_FIELD_LIST, 124);
        DATA$$ExternalSyntheticOutline0.m(125, 0, DM_NODE.TWWAN_911_FAIL_TIMER, DM_FIELD_LIST, 125);
        DATA$$ExternalSyntheticOutline0.m(
                126, 0, DM_NODE.TWLAN_911_SEARCHFAIL_TIMER, DM_FIELD_LIST, 126);
        DATA$$ExternalSyntheticOutline0.m(
                127, 0, DM_NODE.TWLAN_911_CALLFAIL_TIMER, DM_FIELD_LIST, 127);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                155, 0, DM_NODE.SPR_IMS_PCSCF_ADDR_TYPE, DM_FIELD_LIST, 155);
        ...
        DATA$$ExternalSyntheticOutline0.m(
                158, 5, RcsConfigurationReader.CONFIG_VERSION, DM_FIELD_LIST, 158);
