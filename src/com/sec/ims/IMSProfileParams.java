...
public class IMSProfileParams implements Parcelable, Cloneable {
    public static final Parcelable.Creator<IMSProfileParams> CREATOR =
            new Parcelable.Creator<
                    IMSProfileParams>() { // from class: com.sec.ims.IMSProfileParams.1
    ...
    public IMSProfileParams m1422clone() throws CloneNotSupportedException {
