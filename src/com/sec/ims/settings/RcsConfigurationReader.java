...
public class RcsConfigurationReader {
    ...
    public static final String CALL_COMPOSER_TIMER_IDLE =
            "root/application/1/other/callComposerTimerIdle";
    public static final String CALL_LOG_BEARER_DIFFER =
            "root/application/1/ux/callLogsBearerDiffer";
    public static final String CAPDISCOVERY_ALLOWED_PREFIXES =
            "root/application/1/capdiscovery/capdiscoverywhitelist/capdiscoveryallowedprefixes/prefix";
    public static final String CAPDISCOVERY_CAPINFO_EXPIRY =
            "root/application/1/capdiscovery/capinfoexpiry";
    public static final String CAPDISCOVERY_CAP_DISC_COMMON_STACK =
            "root/application/1/capdiscovery/capDiscCommonStack";
    public static final String CAPDISCOVERY_CHARACTERISTIC_PATH =
            "root/application/1/capdiscovery/";
    public static final String CAPDISCOVERY_DEFAULT_DISC =
            "root/application/1/capdiscovery/defaultdisc";
    public static final String CAPDISCOVERY_DISABLE_INITIAL_SCAN =
            "root/application/1/capdiscovery/disableInitialAddressBookScan";
    public static final String CAPDISCOVERY_MAX_ENTRIES_IN_LIST =
            "root/application/1/capdiscovery/maxentriesinlist";
    public static final String CAPDISCOVERY_NON_RCS_CAPINFO_EXPIRY =
            "root/application/1/capdiscovery/nonRCScapInfoExpiry";
    public static final String CAPDISCOVERY_POLLING_PERIOD =
            "root/application/1/capdiscovery/pollingperiod";
    public static final String CAPDISCOVERY_POLLING_RATE =
            "root/application/1/capdiscovery/pollingrate";
    public static final String CAPDISCOVERY_POLLING_RATE_PERIOD =
            "root/application/1/capdiscovery/pollingrateperiod";
    public static final String CFS_TRIGGER = "root/application/1/clientControl/cfsTrigger";
    public static final String CHATBOT_BOTINFOFQDNROOT =
            "root/application/1/messaging/chatbot/BotinfoFQDNRoot";
    public static final String CHATBOT_CHATBOTBLACKLIST =
            "root/application/1/messaging/chatbot/ChatbotBlacklist";
    public static final String CHATBOT_CHATBOTDIRECTORY =
            "root/application/1/messaging/chatbot/ChatbotDirectory";
    public static final String CHATBOT_CHATBOT_MSG_TECH =
            "root/application/1/messaging/chatbot/ChatbotMsgTech";
    public static final String CHATBOT_IDENTITY_IN_ENRICHED_SEARCH =
            "root/application/1/messaging/chatbot/IdentityInEnrichedSearch";
    public static final String CHATBOT_MSGHISTORYSELECTABLE =
            "root/application/1/messaging/chatbot/MsgHistorySelectable";
    public static final String CHATBOT_PRIVACY_DISABLE =
            "root/application/1/messaging/chatbot/PrivacyDisable";
    public static final String CHATBOT_SPECIFIC_CHATBOTS_LIST =
            "root/application/1/messaging/chatbot/SpecificChatbotsList";
    ...
    public static final String CLIENT_CONTROL_CHARACTERISTIC_PATH =
            "root/application/1/clientControl/";
    ...
    public static final String DATAOFF_CHRACTERISTIC_PATH =
            "root/application/1/services/ext/dataoff";
    public static final String DATAOFF_CONTENT_SHARE =
            "root/application/1/services/ext/dataoffcontentShareDataOff";
    public static final String DATAOFF_FILE_TRANSFER =
            "root/application/1/services/ext/dataofffileTransferDataOff";
    public static final String DATAOFF_IP_VIDEO =
            "root/application/1/services/ext/dataoffIPVideoCallDataOff";
    public static final String DATAOFF_MMS = "root/application/1/services/ext/dataoffmmsDataOff";
    public static final String DATAOFF_PRE_AND_POST_CALL =
            "root/application/1/services/ext/dataoffpreAndPostCallDataOff";
    public static final String DATAOFF_PROVISIONING =
            "root/application/1/services/ext/dataoffprovisioningDataOff";
    public static final String DATAOFF_RCS_MESSAGING =
            "root/application/1/services/ext/dataoffrcsMessagingDataOff";
    public static final String DATAOFF_SMSOIP =
            "root/application/1/services/ext/dataoffsmsoIPDataOff";
    public static final String DATAOFF_SYNC = "root/application/1/services/ext/dataoffsyncDataOff";
    public static final String DATAOFF_VOLTE =
            "root/application/1/services/ext/dataoffvolteDataOff";
    public static final String DEFERRED_MSG_FUNC_URI =
            "root/application/1/im/deferred-msg-func-uri";
    public static final String DISPLAY_NOTIFICATION_SWITCH =
            "root/application/1/clientControl/displayNotificationSwitch";
    public static final String EXPLODER_URI = "root/application/1/im/exploder-uri";
    public static final String EXTENSIONS_MAX_MSRP_SIZE =
            "root/application/1/other/extensionsMaxMSRPSize";
    public static final String EXTENSION_ENABLED = "root/application/1/services/allowRCSExtensions";
    public static final String EXT_ATT_IM_MSRP_FT_MAX_SIZE =
            "root/application/1/im/ext/att/MSRPFtMaxSize";
    public static final String EXT_ATT_IM_SLM_MAX_RECIPIENTS =
            "root/application/1/im/ext/att/slmMaxRecipients";
    public static final String EXT_FT_HTTP_FT_WARN_SIZE =
            "root/application/1/im/ext/fthttpftwarnsize";
    public static final String EXT_FT_HTTP_MAX_SIZE_FILE_TR =
            "root/application/1/im/ext/fthttpmaxsizefiletr";
    public static final String EXT_FT_HTTP_MAX_SIZE_FILE_TR_INCOMING =
            "root/application/1/im/ext/fthttpmaxsizefiletrincoming";
    public static final String EXT_MAX_ADHOC_OPEN_GROUP_SIZE =
            "root/application/1/im/ext/max_adhoc_open_group_size";
    public static final String FIRST_MSG_INVITE = "root/application/1/im/firstMessageInvite";
    public static final String FTHTTP_CAP_ALWAYS_ON =
            "root/application/1/clientControl/ftHTTPCapAlwaysOn";
    ...
    public static final String FT_HTTP_MAX_SIZE_FILE_TR =
            "root/application/1/im/ftHTTPMaxSizeFileTr";
    public static final String FT_HTTP_MAX_SIZE_FILE_TR_INCOMING =
            "root/application/1/im/ftHTTPMaxSizeFileTrIncoming";
    public static final String FT_MAX1_TO_MANY_RECIPIENTS =
            "root/application/1/clientControl/ftMax1ToManyRecipients";
    public static final String FT_MSRP_FT_WARN_SIZE = "root/application/1/im/ext/ftMSRPftWarnSize";
    public static final String FT_MSRP_MAX_SIZE_FILE_TR =
            "root/application/1/im/ext/ftMSRPMaxSizeFileTr";
    public static final String FT_MSRP_MAX_SIZE_FILE_TR_INCOMING =
            "root/application/1/im/ext/ftMSRPMaxSizeFileTrIncoming";
    ...
    public static final String GROUP_CHAT_FULL_STAND_FWD =
            "root/application/1/im/GroupChatFullStandFwd";
    public static final String GROUP_CHAT_ONLY_F_STAND_FWD =
            "root/application/1/im/GroupChatOnlyFStandFwd";
    public static final String HOME_NETWORK_DOMAIN_NAME =
            "root/application/0/home_network_domain_name";
    ...
    public static final String JOYN_UX_MESSAGING_UX =
            "root/application/1/SERVICEPROVIDEREXT/joyn/UX/messagingUX";
    public static final String JOYN_UX_MSG_FB_DEFAULT =
            "root/application/1/SERVICEPROVIDEREXT/joyn/UX/msgFBDefault";
    ...
    public static final String LASTSEENACTIVE =
            "root/application/1/capdiscovery/ext/joyn/lastseenactive";
    public static final String LBO_PCSCF_ADDRESS =
            "root/application/0/lbo_p-cscf_address/0/address";
    public static final String LBO_PCSCF_ADDRESS_NEW =
            "root/application/0/lbo_p-cscf_address/0/lbo_p-cscf_addresses/address1";
    public static final String LBO_PCSCF_ADDRESS_TYPE =
            "root/application/0/lbo_p-cscf_address/0/addresstype";
    public static final String LBO_PCSCF_ADDRESS_TYPE_NEW =
            "root/application/0/lbo_p-cscf_address/0/lbo_p-cscf_addresses/addresstype1";
    public static final String MASS_FCTY_URI = "root/application/1/im/mass-fcty-uri";
    public static final String MAX1_TO_MANY_RECIPIENTS =
            "root/application/1/clientControl/max1toManyRecipients";
    public static final String MAX_ADHOC_CLOSED_GROUP_SIZE =
            "root/application/1/im/ext/max_adhoc_closed_group_size";
    public static final String MAX_ADHOC_GROUP_SIZE = "root/application/1/im/max_adhoc_group_size";
    public static final String MAX_ADHOC_OPEN_GROUP_SIZE =
            "root/application/1/im/max_adhoc_open_group_size";
    public static final String MAX_CONCURRENT_SESSION =
            "root/application/1/im/maxConcurrentSession";
    ...
    public static final String MAX_SIZE_FILE_TR_INCOMING =
            "root/application/1/im/MaxSizeFileTrIncoming";
    ...
    public static final String MSGCAPVALIDITY =
            "root/application/1/capdiscovery/ext/joyn/msgcapvalidity";
    ...
    public static final String OMADM_HOME_NETWORK_DOMAIN_NAME =
            "omadm/./3GPP_IMS/Home_network_domain_name";
    ...
    public static final String OMADM_PRIVATE_USER_IDENTITY =
            "omadm/./3GPP_IMS/Private_user_identity";
    public static final String OMADM_PUBLIC_USER_ID =
            "omadm/./3GPP_IMS/Public_user_identity_List/Public_user_identity_List_1/Public_user_identity";
    public static final String OMADM_PUBLISH_ERR_RETRY_TIMER =
            "omadm/./3GPP_IMS/PUBLISH_ERR_RETRY_TIMER";
    ...
    public static final String OMADM_SPEAKER_DEFAULT_VIDEO =
            "omadm/./3GPP_IMS/SPEAKER_DEFAULT_VIDEO";
    ...
    public static final String OMADM_SPR_IMS_PCSCF_ADDR_TYPE =
            "omadm/./3GPP_IMS/SPR_IMS_PCSCF_ADDR_TYPE";
    ...
    public static final String OMADM_TWLAN_911_CALLFAIL_TIMER =
            "omadm/./3GPP_IMS/TWLAN_911_CALLFAIL_TIMER";
    ...
    public static final String OMADM_URI_MEDIA_RSC_SERV_3WAY_CALL =
            "omadm/./3GPP_IMS/URI_MEDIA_RSC_SERV_3WAY_CALL";
    public static final String OMADM_VCE_CONFIG = "omadm/./3GPP_IMS/VCE_CONFIG";
    public static final String OMADM_VOICE_DOMAIN_PREF_EUTRAN =
            "omadm/./3GPP_IMS/VOICE_DOMAIN_PREF_EUTRAN";
    ...
    public static final String ONE_TO_MANY_SELECTED_TECH =
            "root/application/1/clientControl/1toManySelectedTech";
    ...
    public static final String PLUGINS_CATALOGURI =
            "root/application/1/messaging/plugins/catalogURI";
    ...
    public static final String PRESENCE_MAX_SUBSCRIPTION_URI =
            "root/application/1/presence/max-number-ofsubscriptions-inpresence-list";
    ...
    public static final String PRESENCE_THROTTLE_PUBLISH =
            "root/application/1/presence/source-throttlepublish";
    ...
    public static final String PS_SIGNALLING =
            "root/application/1/other/transportproto/pssignalling";
    public static final String PS_SIGNALLING_NEW =
            "root/application/0/ext/transportproto/pssignalling";
    ...
    public static final String PUBLIC_USER_IDENTITY =
            "root/application/0/public_user_identity_list/0/public_user_identity";
    public static final String PUBLIC_USER_IDENTITY_LIST =
            "root/application/0/public_user_identity_list";
    public static final String PUBLIC_USER_IDENTITY_LIST_CON = "public_user_identity";
    public static final String PUBLIC_USER_IDENTITY_NEW =
            "root/application/0/public_user_identity_list/0/public_user_identities/public_user_identity";
    ...
    public static final String RCS_VOLTE_SINGLE_REGISTRATION =
            "root/application/0/ext/rcsVolteSingleRegistration";
    public static final String REALM = "root/application/0/appauth/realm";
    public static final String RECONNECT_GUARD_TIMER =
            "root/application/1/clientControl/reconnectGuardTimer";
    public static final String RECONNECT_GUARD_TIMER_JOYN =
            "root/application/1/serviceproviderext/joyn/messaging/reconnectGuardTimer";
    public static final String SERVICEPROVIDEREXT_PATH = "root/application/1/serviceproviderext";
    public static final String SERVICE_AVAILABILITY_INFO_EXPIRY =
            "root/application/1/clientControl/serviceAvailabilityInfoExpiry";
    ...
    public static final String SLM_MAX_MSG_SIZE =
            "root/application/1/cpm/standalonemsg/MaxSizeStandalone";
    ...
    public static final String TRANSPORT_PROTO_CHARACTERISTIC_NEW_PATH =
            "root/application/0/ext/transportproto/";
    public static final String TRANSPORT_PROTO_CHARACTERISTIC_PATH =
            "root/application/1/other/transportproto/";
    ...
    public static final String WARN_SIZE_IMAGE_SHARE =
            "root/application/1/other/warnsizeimageshare";
    ...
    public static final String WIFI_SIGNALLING =
            "root/application/1/other/transportproto/wifisignalling";
    public static final String WIFI_SIGNALLING_NEW =
            "root/application/0/ext/transportproto/wifisignalling";
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.sec.ims.settings.RcsConfigurationReader.getValue(java.lang.String):java.lang.String");
    }

    public Boolean getBoolean(String str) {
        String value = getValue(str);
        if (value == null) {
            Log.v(TAG, "getIntValue: String value used as Boolean is null. Returning -1 instead.");
    ...
    public int getInt(String str) {
        String value = getValue(str);
        if (value == null) {
            Log.v(TAG, "getIntValue: String value used as integer is null. Returning -1 instead.");
            return -1;
        }
        try {
    ...
    public long getLong(String str) {
        String value = getValue(str);
        if (value == null) {
            Log.v(TAG, "getIntValue: String value used as long is null. Returning -1 instead.");
            return -1L;
        }
        try {
