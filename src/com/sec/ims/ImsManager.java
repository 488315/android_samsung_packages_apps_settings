...
public class ImsManager {
    ...
    public ImsManager() {
        ...
        this.mEventProxy =
                new IImsDmConfigListener.Stub() { // from class: com.sec.ims.ImsManager.2
                    ...
                    public void onChangeDmValue(String str, boolean z) throws RemoteException {
                        if (ImsManager.this.mEventRelay == null) {
                            Log.d(
                                    "legacyImsManager[" + ImsManager.this.mPhoneId + "]",
                                    "no listener for IImsDmConfigListener");
                            throw new RemoteException();
                        }
                        Log.d(
                                "legacyImsManager[" + ImsManager.this.mPhoneId + "]",
                                "mEventRelay : " + ImsManager.this.mEventRelay);
    ...
    private void registerPreviousListeners(IImsService iImsService) {
        synchronized (this) {
            try {
                Log.d(
                        LOG_TAG,
                        "registerPreviousListeners:  mRegListeners:"
                                + this.mRegListeners.size()
                                + " mDialogListeners:"
                                + this.mDialogListeners.size()
                                + " mVideoListeners:"
                                + this.mVideoListeners.size()
                                + " mImSessionListeners:"
                                + this.mImSessionListeners.size()
                                + " mOngoingFtEventListeners:"
                                + this.mOngoingFtEventListeners.size()
                                + " mAutoConfigurationListener:"
                                + this.mAutoConfigurationListener.size()
                                + " mSimMobilityStatusListeners:"
                                + this.mSimMobilityStatusListeners.size()
                                + " mEpdgListeners:"
                                + this.mEpdgListeners.size()
                                + " mCmcRegListeners:"
                                + this.mCmcRegListeners.size());
                try {
                    for (IImsRegistrationListener iImsRegistrationListener :
                            this.mRegListeners.keySet()) {
                        String registerImsRegistrationListenerForSlot =
                                iImsService.registerImsRegistrationListenerForSlot(
                                        iImsRegistrationListener, this.mPhoneId);
                        if (!TextUtils.isEmpty(registerImsRegistrationListenerForSlot)) {
                            this.mRegListeners.put(
                                    iImsRegistrationListener,
                                    registerImsRegistrationListenerForSlot);
                        }
                    }
                    for (IDialogEventListener iDialogEventListener :
                            this.mDialogListeners.keySet()) {
                        String registerDialogEventListenerByToken =
                                iImsService.registerDialogEventListenerByToken(
                                        this.mPhoneId, iDialogEventListener);
                        if (!TextUtils.isEmpty(registerDialogEventListenerByToken)) {
                            this.mDialogListeners.put(
                                    iDialogEventListener, registerDialogEventListenerByToken);
                        }
                    }
                    for (IImSessionListener iImSessionListener :
                            this.mImSessionListeners.keySet()) {
                        String registerImSessionListener =
                                iImsService.registerImSessionListener(iImSessionListener);
                        if (!TextUtils.isEmpty(registerImSessionListener)) {
                            this.mImSessionListeners.put(
                                    iImSessionListener, registerImSessionListener);
                        }
                    }
                    for (IImsOngoingFtEventListener iImsOngoingFtEventListener :
                            this.mOngoingFtEventListeners.keySet()) {
                        String registerImsOngoingFtListener =
                                iImsService.registerImsOngoingFtListener(
                                        iImsOngoingFtEventListener);
                        if (!TextUtils.isEmpty(registerImsOngoingFtListener)) {
                            this.mOngoingFtEventListeners.put(
                                    iImsOngoingFtEventListener, registerImsOngoingFtListener);
                        }
                    }
                    for (IAutoConfigurationListener iAutoConfigurationListener :
                            this.mAutoConfigurationListener.keySet()) {
                        String registerAutoConfigurationListener =
                                iImsService.registerAutoConfigurationListener(
                                        iAutoConfigurationListener, this.mPhoneId);
                        if (!TextUtils.isEmpty(registerAutoConfigurationListener)) {
                            this.mAutoConfigurationListener.put(
                                    iAutoConfigurationListener, registerAutoConfigurationListener);
                        }
                    }
                    for (ISimMobilityStatusListener iSimMobilityStatusListener :
                            this.mSimMobilityStatusListeners.keySet()) {
                        String registerSimMobilityStatusListenerByPhoneId =
                                iImsService.registerSimMobilityStatusListenerByPhoneId(
                                        iSimMobilityStatusListener, this.mPhoneId);
                        if (!TextUtils.isEmpty(registerSimMobilityStatusListenerByPhoneId)) {
                            this.mSimMobilityStatusListeners.put(
                                    iSimMobilityStatusListener,
                                    registerSimMobilityStatusListenerByPhoneId);
                        }
                    }
                    for (IEpdgListener iEpdgListener : this.mEpdgListeners.keySet()) {
                        String registerEpdgListener =
                                iImsService.registerEpdgListener(iEpdgListener);
                        if (!TextUtils.isEmpty(registerEpdgListener)) {
                            this.mEpdgListeners.put(iEpdgListener, registerEpdgListener);
                        }
                    }
                    for (IImsRegistrationListener iImsRegistrationListener2 :
                            this.mCmcRegListeners.keySet()) {
                        String registerCmcRegistrationListenerForSlot =
                                iImsService.registerCmcRegistrationListenerForSlot(
                                        iImsRegistrationListener2, this.mPhoneId);
                        if (!TextUtils.isEmpty(registerCmcRegistrationListenerForSlot)) {
                            this.mCmcRegListeners.put(
                                    iImsRegistrationListener2,
                                    registerCmcRegistrationListenerForSlot);
                        }
                    }
    ...
    public void changeEPDGAudioPath(int i) {
        ListPopupWindow$$ExternalSyntheticOutline0.m1m(
                ...
                Anchor$$ExternalSyntheticOutline0.m(
                        new StringBuilder("legacyImsManager["), this.mPhoneId, "]"));
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
            return;
        }
        try {
    ...
    public void connectService() {
        if (this.mRestartReceiver == null) {
            ...
            this.mRestartReceiver =
                    new BroadcastReceiver() { // from class: com.sec.ims.ImsManager.1
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (TextUtils.equals(
                                    intent.getAction(),
                                    ImsManager.INTENT_ACTION_IMSSERVICE_RESTART)) {
            ...
            this.mContext.registerReceiver(
                    ...
                    AppCompatDelegateImpl$$ExternalSyntheticOutline0.m(
                            INTENT_ACTION_IMSSERVICE_RESTART),
                    2);
        }
    ...
    public void deregisterAdhocProfile(int i) {
        WindowAreaControllerImpl$RearDisplayPresentationSessionConsumer$$ExternalSyntheticOutline0
                .m(
                        i,
                        "deregisterAdhocProfile: id ",
                        Anchor$$ExternalSyntheticOutline0.m(
                                new StringBuilder("legacyImsManager["), this.mPhoneId, "]"));
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "deregisterAdhocProfile: Not initialized.");
            return;
        }
        try {
        ...
        if (broadcastReceiver != null) {
            try {
                ...
                Log.e(
                        Anchor$$ExternalSyntheticOutline0.m(
                                new StringBuilder("legacyImsManager["), this.mPhoneId, "]"),
                        "unregisterReceiver " + e.getMessage());
            }
            this.mRestartReceiver = null;
        }
    ...
    public void enableService(String str, boolean z) {
        ...
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m$1(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "enableService: not connected.");
            return;
        }
        try {
    ...
    public void enableVoLte(boolean z) {
        AirplaneModeEnabler$$ExternalSyntheticOutline0.m("enableVoLte: ", LOG_TAG, z);
        IImsService imsService = getImsService();
        if (imsService == null) {
    ...
    public void finishDmConfig(int i) throws RemoteException {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "finishDmConfig");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public CmcCallInfo getCmcCallInfo() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getCmcCallInfo");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "getCmcCallInfo: Not initialized.");
            return null;
        }
        try {
    ...
    public ContentValues getConfigValues(String[] strArr) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getConfigValues");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public ImsProfile[] getCurrentProfile() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getCurrentProfile");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public int getEpsFbCallCount(int i) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getEpsFbCallCount");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public DialogEvent getLastDialogEvent() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getLastDialogEvent");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public int getNrSaCallCount(int i) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getNrSaCallCount");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public String getRcsProfileType() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getRcsProfileType");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public ImsRegistration[] getRegistrationInfo() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getRegistrationInfo");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "getRegistrationInfo: Not initialized.");
            return null;
        }
        try {
    ...
    public ImsRegistration getRegistrationInfoByServiceType(String str) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                ...
                this.mPhoneId,
                "]",
                "getRegistrationInfoByServiceType");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "getRegistrationInfoByServiceType: Not initialized.");
            return null;
        }
        try {
    ...
    public int getVideocallType() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "getVideocallType");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public boolean hasVoLteSim() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "hasVoLteSim");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public boolean isForbidden() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "isForbidden");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public boolean isQSSSuccessAuthAndLogin() {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    ...
                    this.mPhoneId,
                    "]",
                    "isQSSSuccessAuthAndLogin: Not initialized.");
            return false;
        }
        try {
    ...
    public boolean isServiceAvailable(String str) {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m$1(
                    ...
                    this.mPhoneId,
                    "]",
                    "isServiceAvailable: not connected.");
            return false;
        }
        try {
    ...
    public boolean isServiceEnabled(String str) {
        Cursor query =
                this.mContext
                        .getContentResolver()
                        .query(
                                Uri.parse("content://com.sec.ims.settings/imsswitch")
                                        .buildUpon()
                                        .fragment("simslot" + this.mPhoneId)
                                        .build(),
                                new String[] {str},
                                null,
                                null,
        ...
        Cursor query =
                this.mContext
                        ...
                        .query(
                                Uri.parse("content://com.sec.ims.settings/imsswitch")
                                        .buildUpon()
                                        .fragment("simslot" + Integer.toString(this.mPhoneId))
                                        .build(),
                                new String[] {"volte"},
                                null,
                                null,
                ...
                if (query.getCount() != 0) {
                    try {
                        if (query.moveToFirst()) {
                            ...
                            r4 = i == 1;
                            Log.d(
                                    "legacyImsManager[" + this.mPhoneId + "]",
                                    "isVoLteEnabled: " + string + " " + i);
                        }
                    } catch (IllegalArgumentException unused) {
                        Log.d(
                                "legacyImsManager[" + this.mPhoneId + "]",
                                "isVoLteEnabled: false due to IllegalArgumentException");
                    }
                    query.close();
                    return r4;
                }
    ...
    public boolean isVolteEnabledFromNetwork() {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    ...
                    this.mPhoneId,
                    "]",
                    "isVolteEnabledFromNetwork: Not initialized.");
            return false;
        }
        try {
    ...
    public boolean isVolteSupportECT() {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "isVolteSupportECT");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "isVolteSupportECT: Not initialized.");
            return false;
        }
        try {
    ...
    public int registerAdhocProfile(ImsProfile imsProfile) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "registerAdhocProfile");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "registerAdhocProfile: Not initialized.");
            return -1;
        }
        try {
    ...
    public void registerAutoConfigurationListener(
            IAutoConfigurationListener iAutoConfigurationListener) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["),
                this.mPhoneId,
                "]",
                "registerAutoConfigurationListener");
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
            this.mAutoConfigurationListener.put(iAutoConfigurationListener, ApnSettings.MVNO_NONE);
            return;
        }
        try {
            String registerAutoConfigurationListener =
                    imsService.registerAutoConfigurationListener(
                            iAutoConfigurationListener, this.mPhoneId);
            if (TextUtils.isEmpty(registerAutoConfigurationListener)) {
                return;
            }
    ...
    public synchronized void registerCmcRegistrationListener(
        ...
        if (imsService == null) {
            ...
            this.mCmcRegListeners.put(iImsRegistrationListener, ApnSettings.MVNO_NONE);
            return;
        }
        try {
            String registerCmcRegistrationListenerForSlot =
                    imsService.registerCmcRegistrationListenerForSlot(
                            iImsRegistrationListener, this.mPhoneId);
            if (!TextUtils.isEmpty(registerCmcRegistrationListenerForSlot)) {
                this.mCmcRegListeners.put(
                        iImsRegistrationListener, registerCmcRegistrationListenerForSlot);
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    public synchronized void registerDialogEventListener(
            IDialogEventListener iDialogEventListener) {
        ...
        if (imsService == null) {
            Log.e("legacyImsManager[" + this.mPhoneId + "]", "Not initialized.");
            this.mDialogListeners.put(iDialogEventListener, ApnSettings.MVNO_NONE);
            return;
        }
        try {
            String registerDialogEventListenerByToken =
                    imsService.registerDialogEventListenerByToken(
                            this.mPhoneId, iDialogEventListener);
            if (!TextUtils.isEmpty(registerDialogEventListenerByToken)) {
    ...
    public void registerDmValueListener(DmConfigEventRelay dmConfigEventRelay) {
        if (dmConfigEventRelay == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "listener is null");
            return;
        }
    ...
    public synchronized void registerEpdgListener(IEpdgListener iEpdgListener) {
        ...
        if (imsService == null) {
            Log.e(LOG_TAG, "Not initialized.");
            this.mEpdgListeners.put(iEpdgListener, ApnSettings.MVNO_NONE);
            return;
        }
        try {
    ...
    public void registerImSessionListener(IImSessionListener iImSessionListener) {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
            this.mImSessionListeners.put(iImSessionListener, ApnSettings.MVNO_NONE);
            return;
        }
        try {
            String registerImSessionListener =
                    imsService.registerImSessionListener(iImSessionListener);
            if (TextUtils.isEmpty(registerImSessionListener)) {
                return;
            }
    ...
    public void registerImsOngoingFtEventListener(
            IImsOngoingFtEventListener iImsOngoingFtEventListener) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["),
                this.mPhoneId,
                "]",
                "registerImsOngoingFtEventListener");
        if (iImsOngoingFtEventListener == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "registerImsOngoingFtEventListener : wrong instance or null");
            return;
        }
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
            this.mOngoingFtEventListeners.put(iImsOngoingFtEventListener, ApnSettings.MVNO_NONE);
            return;
        }
        try {
            String registerImsOngoingFtListener =
                    imsService.registerImsOngoingFtListener(iImsOngoingFtEventListener);
            if (TextUtils.isEmpty(registerImsOngoingFtListener)) {
                return;
            }
            this.mOngoingFtEventListeners.put(
    ...
    public synchronized void registerImsRegistrationListener(
            IImsRegistrationListener iImsRegistrationListener) {
        ...
        Log.e("legacyImsManager[" + this.mPhoneId + "]", "Not initialized.");
        this.mRegListeners.put(iImsRegistrationListener, ApnSettings.MVNO_NONE);
    }
    ...
    public synchronized void registerRttEventListener(IRttEventListener iRttEventListener) {
        ...
        if (imsService == null) {
            Log.e("legacyImsManager[" + this.mPhoneId + "]", "Not initialized.");
            this.mRttListeners.put(iRttEventListener, ApnSettings.MVNO_NONE);
            return;
        }
        try {
            String registerRttEventListener =
                    imsService.registerRttEventListener(this.mPhoneId, iRttEventListener);
    ...
    public synchronized void registerSimMobilityStatusListener(
            ISimMobilityStatusListener iSimMobilityStatusListener) {
        ...
        Log.e("legacyImsManager[" + this.mPhoneId + "]", "Not initialized.");
        this.mSimMobilityStatusListeners.put(iSimMobilityStatusListener, ApnSettings.MVNO_NONE);
    }

    public void sendDeregister(int i) {
        ImsManager$$ExternalSyntheticOutline0.m(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "sendDeregister");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "sendDeregister");
    ...
    public void sendIidToken(String str) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "sendIidToken");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public void sendMsisdnNumber(String str) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "sendMsisdnNumber");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public void sendRttSessionModifyRequest(int i, boolean z) {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m$1(
                    ...
                    this.mPhoneId,
                    "]",
                    "sendRttSessionModifyRequest: not connected.");
            return;
        }
        try {
    ...
    public void sendRttSessionModifyResponse(int i, boolean z) {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m$1(
                    ...
                    this.mPhoneId,
                    "]",
                    "sendRttSessionModifyResponse: not connected.");
            return;
        }
        try {
    ...
    public void sendTryRegister() {
        ImsManager$$ExternalSyntheticOutline0.m(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "sendTryRegister");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "sendTryRegister: Not initialized.");
            return;
        }
        try {
    ...
    public void sendUpdateRegister() {
        ImsManager$$ExternalSyntheticOutline0.m(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "sendInitialRegister");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
        ...
        try {
            ImsRegistration[] registrationInfoByPhoneId =
                    imsService.getRegistrationInfoByPhoneId(this.mPhoneId);
            if (registrationInfoByPhoneId != null && registrationInfoByPhoneId.length != 0) {
                for (ImsRegistration imsRegistration : registrationInfoByPhoneId) {
                    if (imsRegistration.hasService("mmtel")
                            && imsRegistration.getImsProfile().getPdnType() == 11) {
                        imsService.forcedUpdateRegistrationByPhoneId(
                                imsRegistration.getImsProfile(), this.mPhoneId);
                        return;
                    }
                }
            }
    ...
    public void sendVerificationCode(String str) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "sendVerificationCode");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public int setActiveMsisdn(String str, String str2) {
        Log.d(
                Anchor$$ExternalSyntheticOutline0.m(
                        new StringBuilder("legacyImsManager["), this.mPhoneId, "]"),
                "setActiveMsisdn: msisdn " + IMSLog.checker(str) + " service " + str2);
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "setActiveMsisdn: Not initialized.");
            return -1;
        }
        try {
    ...
    public void setAutomaticMode(boolean z) {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m$1(
                    ...
                    this.mPhoneId,
                    "]",
                    "setAutomaticMode: not connected.");
            return;
        }
        try {
    ...
    public void setEmergencyPdnInfo(String str, String[] strArr, String str2) {
        Log.e(
                Anchor$$ExternalSyntheticOutline0.m(
                        new StringBuilder("legacyImsManager["), this.mPhoneId, "]"),
                "setEmergencyPdnInfo: intfName " + str);
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "setEmergencyPdnInfo: Not initialized.");
            return;
        }
        try {
    ...
    public int startDmConfig() throws RemoteException {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "startDmConfig");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public int startLocalRingBackTone(int i, int i2, int i3) {
        ...
        try {
            ...
            Log.e(
                    Anchor$$ExternalSyntheticOutline0.m(
                            new StringBuilder("legacyImsManager["), this.mPhoneId, "]"),
                    "startLocalRingBackTone has Error " + e.getMessage());
            return -1;
        }
    }
    ...
    public int stopLocalRingBackTone() {
        ...
        try {
            ...
            Log.e(
                    Anchor$$ExternalSyntheticOutline0.m(
                            new StringBuilder("legacyImsManager["), this.mPhoneId, "]"),
                    "stopLocalRingBackTone has Error " + e.getMessage());
            return -1;
        }
    }
    ...
    public void suspendRegister(boolean z) {
        ...
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    ...
                    this.mPhoneId,
                    "]",
                    "SuspendRegi Error. ImsService null.");
            return;
        }
        try {
    ...
    public void transferCall(String str, String str2) {
        Log.d(
                Anchor$$ExternalSyntheticOutline0.m(
                        new StringBuilder("legacyImsManager["), this.mPhoneId, "]"),
                "transferCall msisdn : " + IMSLog.checker(str) + ", dialogId : " + str2);
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public void unregisterAutoConfigurationListener(
            IAutoConfigurationListener iAutoConfigurationListener) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["),
                this.mPhoneId,
                "]",
                "unregisterAutoConfigurationListener");
        if (iAutoConfigurationListener == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
    ...
    public synchronized void unregisterCmcRegistrationListener(
            IImsRegistrationListener iImsRegistrationListener) {
    ...
    public synchronized void unregisterDialogEventListener(
            IDialogEventListener iDialogEventListener) {
    ...
    public void unregisterImsOngoingFtEventListener(
            IImsOngoingFtEventListener iImsOngoingFtEventListener) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["),
                this.mPhoneId,
                "]",
                "unregisterImsOngoingFtEventListener");
        if (iImsOngoingFtEventListener == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
    ...
    public synchronized void unregisterImsRegistrationListener(
            IImsRegistrationListener iImsRegistrationListener) {
    ...
    public synchronized void unregisterSimMobilityStatusListener(
            ISimMobilityStatusListener iSimMobilityStatusListener) {
    ...
    public boolean updateConfigValues(ContentValues contentValues) {
        ImsManager$$ExternalSyntheticOutline0.m$1(
                new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "updateConfigValues");
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["), this.mPhoneId, "]", "Not initialized.");
    ...
    public int updateRegistration(ImsProfile imsProfile) {
        Log.d(
                Anchor$$ExternalSyntheticOutline0.m(
                        new StringBuilder("legacyImsManager["), this.mPhoneId, "]"),
                "updateRegistration: profile " + imsProfile.getName());
        IImsService imsService = getImsService();
        if (imsService == null) {
            ImsManager$$ExternalSyntheticOutline0.m(
                    new StringBuilder("legacyImsManager["),
                    this.mPhoneId,
                    "]",
                    "updateRegistration: Not initialized.");
            return -1;
        }
        try {
    ...
    */
    public boolean isRcsEnabled(boolean r10) {
        ...
        L3d:
            ...
            int r10 = r3.getInt(r10)     // Catch: java.lang.IllegalStateException -> L7f
            java.lang.String r7 = "true"
            java.lang.String r8 = "info/completed"
            java.lang.String r3 = r3.getString(r8)     // Catch: java.lang.IllegalStateException -> L7c
            boolean r3 = r7.equals(r3)     // Catch: java.lang.IllegalStateException -> L7c
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch: java.lang.IllegalStateException -> L7a
            r7.<init>(r2)     // Catch: java.lang.IllegalStateException -> L7a
            int r8 = r9.mPhoneId     // Catch: java.lang.IllegalStateException -> L7a
            r7.append(r8)     // Catch: java.lang.IllegalStateException -> L7a
            r7.append(r0)     // Catch: java.lang.IllegalStateException -> L7a
            java.lang.String r7 = r7.toString()     // Catch: java.lang.IllegalStateException -> L7a
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch: java.lang.IllegalStateException -> L7a
            r8.<init>(r1)     // Catch: java.lang.IllegalStateException -> L7a
            r8.append(r10)     // Catch: java.lang.IllegalStateException -> L7a
            java.lang.String r1 = " autoConfigComplete "
            r8.append(r1)     // Catch: java.lang.IllegalStateException -> L7a
            r8.append(r3)     // Catch: java.lang.IllegalStateException -> L7a
            java.lang.String r1 = r8.toString()     // Catch: java.lang.IllegalStateException -> L7a
            android.util.Log.d(r7, r1)     // Catch: java.lang.IllegalStateException -> L7a
            goto L9b
        L7a:
            r1 = move-exception
            goto L82
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled: com.sec.ims.ImsManager.isRcsEnabled(boolean):boolean");
    }
    ...
    public synchronized void registerImsRegistrationListener(
        ...
        try {
            String registerImsRegistrationListenerForSlot =
                    imsService.registerImsRegistrationListenerForSlot(iImsRegistrationListener, i);
            if (!TextUtils.isEmpty(registerImsRegistrationListenerForSlot)) {
                this.mRegListeners.put(
                        iImsRegistrationListener, registerImsRegistrationListenerForSlot);
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    public synchronized void registerSimMobilityStatusListener(
        ...
        try {
            String registerSimMobilityStatusListenerByPhoneId =
                    imsService.registerSimMobilityStatusListenerByPhoneId(
                            iSimMobilityStatusListener, i);
            if (!TextUtils.isEmpty(registerSimMobilityStatusListenerByPhoneId)) {
                this.mSimMobilityStatusListeners.put(
                        iSimMobilityStatusListener, registerSimMobilityStatusListenerByPhoneId);
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class EpdgListener extends IEpdgListener.Stub {
