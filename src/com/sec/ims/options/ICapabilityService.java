...
public interface ICapabilityService extends IInterface {
    ...
    void registerListenerWithToken(
            ICapabilityServiceEventListener iCapabilityServiceEventListener, String str, int i)
            throws RemoteException;
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements ICapabilityService {
        ...
        public static class Proxy implements ICapabilityService {
            ...
            @Override // com.sec.ims.options.ICapabilityService
            public Capabilities[] getCapabilitiesWithFeatureByUriList(
                    List<ImsUri> list, int i, int i2, int i3) throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(ICapabilityService.DESCRIPTOR);
            ...
            public String registerListener(
                    ICapabilityServiceEventListener iCapabilityServiceEventListener, int i)
                    throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            @Override // com.sec.ims.options.ICapabilityService
            public void registerListenerWithToken(
                    ICapabilityServiceEventListener iCapabilityServiceEventListener,
                    String str,
                    int i)
                    throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
        ...
        public static ICapabilityService asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface =
                    iBinder.queryLocalInterface(ICapabilityService.DESCRIPTOR);
            return (queryLocalInterface == null
                            || !(queryLocalInterface instanceof ICapabilityService))
                    ? new Proxy(iBinder)
                    : (ICapabilityService) queryLocalInterface;
        }
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    Capabilities capabilitiesByNumber =
                            getCapabilitiesByNumber(readString, readInt6, readInt7);
                    parcel2.writeNoException();
                ...
                case 5:
                    ...
                    parcel.enforceNoDataAvail();
                    Capabilities capabilitiesWithDelay =
                            getCapabilitiesWithDelay(readString2, readInt8, readInt9);
                    parcel2.writeNoException();
                ...
                case 6:
                    ...
                    parcel.enforceNoDataAvail();
                    Capabilities capabilitiesWithFeature =
                            getCapabilitiesWithFeature(readString3, readInt10, readInt11);
                    parcel2.writeNoException();
                ...
                case 7:
                    ...
                    parcel.enforceNoDataAvail();
                    Capabilities[] capabilitiesWithFeatureByUriList =
                            getCapabilitiesWithFeatureByUriList(
                                    createTypedArrayList, readInt12, readInt13, readInt14);
                    parcel2.writeNoException();
                ...
                case 8:
                    ...
                    Capabilities[] capabilitiesByContactId =
                            getCapabilitiesByContactId(readString4, readInt15, readInt16);
                    parcel2.writeNoException();
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    ICapabilityServiceEventListener asInterface =
                            ICapabilityServiceEventListener.Stub.asInterface(
                    ...
                    return true;
                case 11:
                    ICapabilityServiceEventListener asInterface2 =
                            ICapabilityServiceEventListener.Stub.asInterface(
                                    parcel.readStrongBinder());
