...
public class Capabilities implements Parcelable, Cloneable {
    ...
    public static final String FEATURE_TAG_CHATBOT_CHAT_SESSION =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.chatbot\"";

    @Deprecated
    public static final String FEATURE_TAG_CHATBOT_COMMUNICATION =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.chatbot\"";

    public static final String FEATURE_TAG_CHATBOT_ROLE = "+g.gsma.rcs.isbot";
    public static final String FEATURE_TAG_CHATBOT_STANDALONE_MSG =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.chatbot.sa\"";
    public static final String FEATURE_TAG_ENRICHED_CALL_COMPOSER =
            "+g.3gpp.icsi-ref=\"urn%3Aurn-7%3A3gpp-service.ims.icsi.gsma.callcomposer\"";
    public static final String FEATURE_TAG_ENRICHED_POST_CALL =
            "+g.3gpp.icsi-ref=\"urn%3Aurn-7%3A3gpp-service.ims.icsi.gsma.callunanswered\"";
    public static final String FEATURE_TAG_ENRICHED_SHARED_MAP =
            "+g.3gpp.icsi-ref=\"urn%3Aurn-7%3A3gpp-service.ims.icsi.gsma.sharedmap\"";
    public static final String FEATURE_TAG_ENRICHED_SHARED_SKETCH =
            "+g.3gpp.icsi-ref=\"urn%3Aurn-7%3A3gpp-service.ims.icsi.gsma.sharedsketch\"";
    public static final String FEATURE_TAG_EXTENDED_BOT_MSG =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.xbotmessage\"";
    public static final String FEATURE_TAG_FT_VIA_SMS =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.ftsms\"";
    public static final String FEATURE_TAG_GEO_VIA_SMS =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.geosms\"";
    public static final String FEATURE_TAG_PLUG_IN =
    ...
    private String mExtendedMessagingVersion;
    ...
    public static int FEATURE_IPCALL = NetworkAnalyticsConstants.DataPoints.FLAG_SOURCE_PORT;
    public static int FEATURE_IPCALL_VIDEO = NetworkAnalyticsConstants.DataPoints.FLAG_UID;
    ...
    public static int FEATURE_GEOLOCATION_PUSH =
    ...
    @Deprecated
    public static long FEATURE_VEMOTICON = GoodSettingsContract.PreferenceFlag.FLAG_NEED_TYPE;

    @Deprecated
    public static long FEATURE_CARD_MSG =
            GoodSettingsContract.PreferenceFlag.FLAG_NEED_PREF_IS_AVAILABLE;

    @Deprecated
    public static long FEATURE_BURN_MSG =
            GoodSettingsContract.PreferenceFlag.FLAG_NEED_PREF_IS_VISIBLE;

    @Deprecated public static long FEATURE_CLOUD_FILE = 34359738368L;
    ...
    public static String FEATURE_TAG_GEOLOCATION_PULL =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.geopull\"";
    public static String FEATURE_TAG_GEOLOCATION_PULL_FT =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.geopullft\"";
    public static String FEATURE_TAG_GEOLOCATION_PUSH =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.geopush\"";
    public static String FEATURE_TAG_INTEGRATED_MSG =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.joyn.intmsg\"";
    public static String FEATURE_TAG_NULL = "null";
    public static String FEATURE_TAG_STICKER =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.sticker\"";
    public static String FEATURE_TAG_FT_HTTP_EXTRA =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.fthttpextra\"";
    public static String FEATURE_TAG_CANCEL_MESSAGE =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.cancelmessage\"";
    public static String FEATURE_TAG_PUBLIC_MSG =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs"
                + " .mnc000.mcc460.publicmsg\"";
    public static String FEATURE_TAG_NOT_UPDATED = "not_updated";
    public static String FEATURE_TAG_LAST_SEEN_ACTIVE =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.lastseenactive\"";
    public static String FEATURE_TAG_EXTENDED_MESSAGING =
            "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.msg.extended\"";
    ...
    static {
        ...
        sFeatureTags.put(
                Long.valueOf(FEATURE_MMTEL_CALL_COMPOSER), FEATURE_TAG_MMTEL_CALL_COMPOSER);
        ...
        sFeatureTags.put(
                Long.valueOf(FEATURE_GEOLOCATION_PULL_FT), FEATURE_TAG_GEOLOCATION_PULL_FT);
        ...
        sFeatureTags.put(
                Long.valueOf(FEATURE_ENRICHED_CALL_COMPOSER), FEATURE_TAG_ENRICHED_CALL_COMPOSER);
        sFeatureTags.put(
                Long.valueOf(FEATURE_ENRICHED_SHARED_MAP), FEATURE_TAG_ENRICHED_SHARED_MAP);
        sFeatureTags.put(
                Long.valueOf(FEATURE_ENRICHED_SHARED_SKETCH), FEATURE_TAG_ENRICHED_SHARED_SKETCH);
        ...
        sFeatureTags.put(
                Long.valueOf(FEATURE_CHATBOT_CHAT_SESSION),
                "+g.3gpp.iari-ref=\"urn%3Aurn-7%3A3gpp-application.ims.iari.rcs.chatbot\"");
        sFeatureTags.put(Long.valueOf(FEATURE_CANCEL_MESSAGE), FEATURE_TAG_CANCEL_MESSAGE);
        sFeatureTags.put(
                Long.valueOf(FEATURE_CHATBOT_STANDALONE_MSG), FEATURE_TAG_CHATBOT_STANDALONE_MSG);
        ...
        sFeatureTags.put(Long.valueOf(FEATURE_EXTENDED_MESSAGING), FEATURE_TAG_EXTENDED_MESSAGING);
        ...
        sTagFeatures.put(
                FEATURE_TAG_MMTEL_CALL_COMPOSER, Long.valueOf(FEATURE_MMTEL_CALL_COMPOSER));
        ...
        sTagFeatures.put(
                FEATURE_TAG_GEOLOCATION_PULL_FT, Long.valueOf(FEATURE_GEOLOCATION_PULL_FT));
        ...
        sTagFeatures.put(
                FEATURE_TAG_ENRICHED_CALL_COMPOSER, Long.valueOf(FEATURE_ENRICHED_CALL_COMPOSER));
        sTagFeatures.put(
                FEATURE_TAG_ENRICHED_SHARED_MAP, Long.valueOf(FEATURE_ENRICHED_SHARED_MAP));
        sTagFeatures.put(
                FEATURE_TAG_ENRICHED_SHARED_SKETCH, Long.valueOf(FEATURE_ENRICHED_SHARED_SKETCH));
        ...
        sTagFeatures.put(
                FEATURE_TAG_CHATBOT_STANDALONE_MSG, Long.valueOf(FEATURE_CHATBOT_STANDALONE_MSG));
        ...
        sTagFeatures.put(FEATURE_TAG_EXTENDED_MESSAGING, Long.valueOf(FEATURE_EXTENDED_MESSAGING));
        ...
        sFeatures.put(Long.valueOf(FEATURE_EXTENDED_MESSAGING), "extended_messaging");
        CREATOR =
                new Parcelable.Creator<
                        Capabilities>() { // from class: com.sec.ims.options.Capabilities.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // android.os.Parcelable.Creator
                    public Capabilities createFromParcel(Parcel parcel) {
                        return new Capabilities(0, parcel);
                    }
    ...
    public /* synthetic */ Capabilities(int i, Parcel parcel) {
        this(parcel);
    }
    ...
    private static String dumpServices(long j) {
        ...
        for (Long l : sFeatures.keySet()) {
            if ((l.longValue() & j) != 0) {
                arrayList.add(sFeatures.get(l));
            }
        }
    ...
    public static long getTagFeature(String str) {
        return sTagFeatures.containsKey(str)
                ? sTagFeatures.get(str).longValue()
                : FEATURE_OFFLINE_RCS_USER;
    }
    ...
    public String getExtendedMessagingVersion() {
        return this.mExtendedMessagingVersion;
    }
    ...
    public String getXbotVersion() {
        return this.mXbotVersion;
    }

    public boolean hasAnyFeature(long j) {
        return (this.mFeatures & j) != 0;
    }
    ...
    public boolean hasNoRcsFeatures() {
        return hasFeature(FEATURE_NON_RCS_USER)
                || hasFeature(FEATURE_NOT_UPDATED)
                || ((this.mFeatures & ((long) (~FEATURE_MMTEL))) & ((long) (~FEATURE_MMTEL_VIDEO)))
                        == ((long) FEATURE_OFFLINE_RCS_USER);
    }
    ...
    public boolean isExpired(long j) {
        Date date = new Date();
        setExpired(date.getTime() - this.mTimestamp.getTime() >= 1000 * j);
        Log.i(
                LOG_TAG,
                "isExpired: "
                        + this.mIsExpired
                        ...
                        + j
                        + " sec, elapsed time = "
                        + (date.getTime() - this.mTimestamp.getTime())
                        + " ms");
        return this.mIsExpired;
    }

    public boolean isFeatureAvailable(int i) {
        return isFeatureAvailable(i);
    }
    ...
    public void setExtendedMessagingVersion(String str) {
        this.mExtendedMessagingVersion = str;
    }
    ...
    public void setXbotVersion(String str) {
        this.mXbotVersion = str;
    }
    ...
    public String toString() {
        ...
        sb.append(z ? "xxxxx" : this.mBotServiceId);
        ...
        sb.append(", mXbotVersion=");
        sb.append(this.mXbotVersion);
        sb.append(", mExtendedMessagingVersion=");
        return ComponentActivity$1$$ExternalSyntheticOutline0.m(
                sb, this.mExtendedMessagingVersion, "]");
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(imsUri != null ? imsUri.toString() : ApnSettings.MVNO_NONE);
        ...
        String str3 = this.mBotServiceId;
        if (str3 == null) {
            str3 = ApnSettings.MVNO_NONE;
        }
        parcel.writeString(str3);
        parcel.writeLong(this.mLastSeen);
        String str4 = this.mXbotVersion;
        if (str4 == null) {
            str4 = ApnSettings.MVNO_NONE;
        }
        parcel.writeString(str4);
        String str5 = this.mExtendedMessagingVersion;
        if (str5 == null) {
    ...
    public Capabilities() {
        ...
        this.mXbotVersion = null;
        this.mExtendedMessagingVersion = null;
    ...
    public static String[] getFeatureTag(long j) {
        ...
        while (it.hasNext()) {
            ...
            if ((key.longValue() & j) != 0) {
                arrayList.add(sFeatureTags.get(key));
                arrayList2.add(key);
            }
        }
    ...
    public Capabilities m1447clone() throws CloneNotSupportedException {
    ...
    private Capabilities(Parcel parcel) {
        ...
        this.mXbotVersion = parcel.readString();
        this.mExtendedMessagingVersion = parcel.readString();
    }
}
