...
public interface ICentralMsgStoreService extends IInterface {
    ...
    void registerCmsProvisioningListenerByPhoneId(
            ICentralMsgStoreServiceListener iCentralMsgStoreServiceListener, int i)
            throws RemoteException;
    ...
    void unregisterCmsProvisioningListenerByPhoneId(
            ICentralMsgStoreServiceListener iCentralMsgStoreServiceListener, int i)
            throws RemoteException;
    ...
    public static class Default implements ICentralMsgStoreService {
        ...
        @Override // com.sec.ims.ICentralMsgStoreService
        public void registerCmsProvisioningListenerByPhoneId(
                ICentralMsgStoreServiceListener iCentralMsgStoreServiceListener, int i)
                throws RemoteException {}
        ...
        @Override // com.sec.ims.ICentralMsgStoreService
        public void unregisterCmsProvisioningListenerByPhoneId(
                ICentralMsgStoreServiceListener iCentralMsgStoreServiceListener, int i)
                throws RemoteException {}
        ...
        @Override // com.sec.ims.ICentralMsgStoreService
        public void onBufferDBReadResult(
                String str, String str2, String str3, String str4, int i, boolean z)
                throws RemoteException {}
    }

    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements ICentralMsgStoreService {
        ...
        public static class Proxy implements ICentralMsgStoreService {
            ...
            public void registerCallback(
                    String str, ICentralMsgStoreService iCentralMsgStoreService)
                    throws RemoteException {
                Parcel obtain = Parcel.obtain(asBinder());
                Parcel obtain2 = Parcel.obtain();
                try {
        ...
        public static ICentralMsgStoreService asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface =
                    iBinder.queryLocalInterface(ICentralMsgStoreService.DESCRIPTOR);
            return (queryLocalInterface == null
                            || !(queryLocalInterface instanceof ICentralMsgStoreService))
                    ? new Proxy(iBinder)
                    : (ICentralMsgStoreService) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2)
            ...
            switch (i) {
                ...
                case 12:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean onUIButtonProceed =
                            onUIButtonProceed(readString21, readInt, readString22);
                    parcel2.writeNoException();
                ...
                case 46:
                    ...
                    return true;
                case 47:
                    ICentralMsgStoreServiceListener asInterface2 =
                            ICentralMsgStoreServiceListener.Stub.asInterface(
                    ...
                    return true;
                case 48:
                    ICentralMsgStoreServiceListener asInterface3 =
                            ICentralMsgStoreServiceListener.Stub.asInterface(
                                    parcel.readStrongBinder());
