...
public class IMSParameter implements Parcelable {
    public static final Parcelable.Creator<IMSParameter> CREATOR =
            new Parcelable.Creator<IMSParameter>() { // from class: com.sec.ims.IMSParameter.1
    ...
    public byte[] getByteArray(String str) {
        return this.mPrimitiveMap.getByteArray(str);
    }
    ...
    public int[] getIntArray(String str) {
        return this.mPrimitiveMap.getIntArray(str);
    }
    ...
    public String getString(String str) {
        return getString(str, ApnSettings.MVNO_NONE);
    }

    public String[] getStringArray(String str) {
        return this.mPrimitiveMap.getStringArray(str);
    }
    ...
    public void putParcelable(String str, Parcelable parcelable) {
        if (str.equals(GENERAL.APCS_INFO) && (parcelable instanceof IMSAPCSInfo)) {
            try {
                this.mAPCSInfo = ((IMSAPCSInfo) parcelable).m1421clone();
                return;
        ...
        if (!str.equals(GENERAL.REGISTRATION_INFO)
                || !(parcelable instanceof IMSRegistrationInfo)) {
            this.mPrimitiveMap.putParcelable(str, parcelable);
            return;
        }
        try {
            this.mRegistrationInfo = ((IMSRegistrationInfo) parcelable).m1423clone();
    ...
    public void putParcelableArray(String str, Parcelable[] parcelableArr) {
        if (!str.equals(PRESENCE.PROFILE_PARAMS)
                || !(parcelableArr instanceof IMSProfileParams[])) {
        ...
        try {
            ...
            for (int i = 0; i < parcelableArr.length; i++) {
                this.mProfileParams[i] = ((IMSProfileParams) parcelableArr[i]).m1422clone();
            }
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
        }
    ...
    public boolean getBoolean(String str, boolean z) {
        return this.mPrimitiveMap.getBoolean(str, z);
    }

    public int getInt(String str, int i) {
        return this.mPrimitiveMap.getInt(str, i);
    }

    public long getLong(String str, long j) {
        return this.mPrimitiveMap.getLong(str, j);
    }

    public String getString(String str, String str2) {
        return this.mPrimitiveMap.getString(str, str2);
    }
    ...
    public IMSParameter(Parcel parcel) {
        ...
        if (parcel.readInt() != 0) {
            this.mAPCSInfo =
                    (IMSAPCSInfo) parcel.readParcelable(IMSAPCSInfo.class.getClassLoader());
        }
        if (parcel.readInt() != 0) {
            this.mRegistrationInfo =
                    (IMSRegistrationInfo)
                            parcel.readParcelable(IMSRegistrationInfo.class.getClassLoader());
        }
        int readInt = parcel.readInt();
        if (readInt > 0) {
            this.mProfileParams = new IMSProfileParams[readInt];
            for (int i = 0; i < readInt; i++) {
                this.mProfileParams[i] =
                        (IMSProfileParams)
                                parcel.readParcelable(IMSProfileParams.class.getClassLoader());
            }
        }
    }
}
