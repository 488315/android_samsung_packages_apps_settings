...
public class IMSRegistrationInfo implements Parcelable, Cloneable {
    public static final Parcelable.Creator<IMSRegistrationInfo> CREATOR =
            new Parcelable.Creator<
                    IMSRegistrationInfo>() { // from class: com.sec.ims.IMSRegistrationInfo.1
    ...
    public IMSRegistrationInfo m1423clone() throws CloneNotSupportedException {
