...
public interface IUtService extends IInterface {
    ...
    /* compiled from: qb/89523975 2c9f6d15a1195540f21380d26e2599d2824bfc1ae85110b01296b5f4d9a9b658 */
    public abstract static class Stub extends Binder implements IUtService {
        ...
        public static IUtService asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUtService))
                    ? new Proxy(iBinder)
                    : (IUtService) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2)
            ...
            switch (i) {
                case 1:
                    ...
                    IImsUtEventListener asInterface =
                            IImsUtEventListener.Stub.asInterface(parcel.readStrongBinder());
                ...
                case 2:
                    ...
                    IImsUtEventListener asInterface2 =
                            IImsUtEventListener.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
