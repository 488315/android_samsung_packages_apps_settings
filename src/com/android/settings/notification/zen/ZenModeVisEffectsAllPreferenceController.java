...
public final class ZenModeVisEffectsAllPreferenceController
    ...
    public final void onRadioButtonClicked(
        ...
        this.mBackend.saveVisualEffectsPolicy(FileType.SASF, true);
    }
    ...
    public final void updateState(Preference preference) {
        ...
        this.mPreference.setChecked(
                NotificationManager.Policy.areAllVisualEffectsSuppressed(
                        this.mBackend.mPolicy.suppressedVisualEffects));
    }
}
