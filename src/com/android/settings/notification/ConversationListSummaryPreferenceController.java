...
public class ConversationListSummaryPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        int size = NotificationBackend.getConversations(true).getList().size();
        return size == 0
                ? this.mContext.getText(R.string.priority_conversation_count_zero)
                : StringUtil.getIcuPluralsString(
                        this.mContext, size, R.string.priority_conversation_count);
    }
