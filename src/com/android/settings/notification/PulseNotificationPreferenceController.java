...
public class PulseNotificationPreferenceController extends TogglePreferenceController
    ...
    public final class SettingObserver extends ContentObserver {
        ...
        public SettingObserver(Preference preference) {
            super(new Handler());
            this.NOTIFICATION_LIGHT_PULSE_URI =
                    Settings.System.getUriFor("notification_light_pulse");
    ...
    public int getAvailabilityStatus() {
        return this.mContext.getResources().getBoolean(R.bool.config_knownNetworksEnabledForService)
                ? 0
                : 3;
    }
    ...
    public int getSliceHighlightMenuRes() {
        return com.android.settings.R.string.menu_key_notifications;
    }
    ...
    public boolean getThreadEnabled() {
        return Settings.System.getInt(
                        this.mContext.getContentResolver(), "notification_light_pulse", 0)
                == 1;
    }
        ...
        if (settingObserver != null) {
            this.mContext
                    ...
                    .registerContentObserver(
                            settingObserver.NOTIFICATION_LIGHT_PULSE_URI, false, settingObserver);
        }
    }
    ...
    public boolean setChecked(boolean z) {
        return Settings.System.putInt(
                this.mContext.getContentResolver(), "notification_light_pulse", z ? 1 : 0);
    }
