...
public class PoliteNotificationGlobalPreferenceController
        extends SettingsMainSwitchPreferenceController {
    public static final int OFF = 0;
    public static final int ON = 1;

    public PoliteNotificationGlobalPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public boolean setChecked(boolean z) {
        return Settings.System.putInt(
                this.mContext.getContentResolver(), "notification_cooldown_enabled", z ? 1 : 0);
    }
