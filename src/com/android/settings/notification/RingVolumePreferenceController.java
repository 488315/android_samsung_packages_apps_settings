...
public class RingVolumePreferenceController extends RingerModeAffectedVolumePreferenceController {
    ...
    public final class H extends Handler {
        ...
        public final void handleMessage(Message message) {
            int i = message.what;
            RingVolumePreferenceController ringVolumePreferenceController =
                    RingVolumePreferenceController.this;
            if (i == 1) {
                ringVolumePreferenceController.updateEffectsSuppressor();
            } else {
                if (i != 2) {
                    return;
                }
                ringVolumePreferenceController.updateRingerMode();
            }
        }
    }
    ...
    public final class RingReceiver extends BroadcastReceiver {
        ...
        public final void register(boolean z) {
            ...
            if (z) {
                ((AbstractPreferenceController) RingVolumePreferenceController.this)
