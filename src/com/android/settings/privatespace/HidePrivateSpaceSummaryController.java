...
public final class HidePrivateSpaceSummaryController extends BasePreferenceController {
    ...
    private boolean isHidden() {
        return Settings.Secure.getInt(
                        this.mContext.getContentResolver(), "hide_privatespace_entry_point", 0)
                == 1;
    }
    ...
    public CharSequence getSummary() {
        return isHidden()
                ? this.mContext.getString(R.string.private_space_hide_on_summary)
                : this.mContext.getString(R.string.private_space_hide_off_summary);
    }
