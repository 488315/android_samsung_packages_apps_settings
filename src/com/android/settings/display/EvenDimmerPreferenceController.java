...
public class EvenDimmerPreferenceController extends TogglePreferenceController {
    ...
    public EvenDimmerPreferenceController(Context context, String str) {
        super(context, str);
    ...
    private boolean getEvenDimmerActivated() {
        return Settings.Secure.getFloatForUser(
                        this.mContext.getContentResolver(), "even_dimmer_activated", 1.0f, -2)
                == 1.0f;
    }
    ...
    public boolean setChecked(boolean z) {
        ...
        return Settings.Secure.putFloat(
                this.mContext.getContentResolver(), "even_dimmer_activated", f);
    }
