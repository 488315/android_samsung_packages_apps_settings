...
public class LockscreenClockPreferenceController extends TogglePreferenceController {
    ...
    public int getDoublelineClockDefault() {
        return this.mContext.getResources().getInteger(R.integer.config_keyChordPowerVolumeUp);
    }
    ...
    public CharSequence getSummary() {
        return this.mContext.getText(
                com.android.settings.R.string.lockscreen_double_line_clock_summary);
    }
