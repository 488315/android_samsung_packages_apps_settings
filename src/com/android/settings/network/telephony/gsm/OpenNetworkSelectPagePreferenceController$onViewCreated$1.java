...
public final class OpenNetworkSelectPagePreferenceController$onViewCreated$1 extends SuspendLambda
    ...
    @Metadata(
            ...
            mv = {1, 9, 0},
            xi = 48)
    /* renamed from: com.android.settings.network.telephony.gsm.OpenNetworkSelectPagePreferenceController$onViewCreated$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OpenNetworkSelectPagePreferenceController$onViewCreated$1(
            OpenNetworkSelectPagePreferenceController openNetworkSelectPagePreferenceController,
            Continuation continuation) {
        super(2, continuation);
        this.this$0 = openNetworkSelectPagePreferenceController;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new OpenNetworkSelectPagePreferenceController$onViewCreated$1(
                this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((OpenNetworkSelectPagePreferenceController$onViewCreated$1)
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (preference != null) {
                ...
                this.label = 1;
                Object withContext =
                        BuildersKt.withContext(defaultScheduler, anonymousClass1, this);
