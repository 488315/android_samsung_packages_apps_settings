...
public class TopLevelNetworkEntryPreferenceController extends BasePreferenceController {
    ...
    public TopLevelNetworkEntryPreferenceController(Context context, String str) {
        super(context, str);
        this.mMobileNetworkPreferenceController =
                new MobileNetworkPreferenceController(this.mContext);
    }

    @Override // com.android.settings.core.BasePreferenceController
    public int getAvailabilityStatus() {
        return (!Utils.isDemoUser(this.mContext)
    ...
    public CharSequence getSummary() {
        return this.mMobileNetworkPreferenceController.isAvailable()
                ? BidiFormatter.getInstance()
                        .unicodeWrap(
                                this.mContext.getString(R.string.network_dashboard_summary_mobile))
                : BidiFormatter.getInstance()
                        .unicodeWrap(
