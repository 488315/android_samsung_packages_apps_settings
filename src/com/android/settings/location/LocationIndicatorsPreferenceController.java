...
public class LocationIndicatorsPreferenceController extends TogglePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return (DeviceConfig.getBoolean("privacy", "location_indicator_settings_enabled", false)
                        && this.mContext
                                .getPackageManager()
                                .hasSystemFeature("android.hardware.location"))
                ? 0
                : 3;
    }
    ...
    public boolean setChecked(boolean z) {
        DeviceConfig.setProperty(
                "privacy", "location_indicators_enabled", Boolean.toString(z), true);
        return true;
    }
