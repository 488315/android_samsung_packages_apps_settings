...
public class ButtonNavigationSettingsAssistController extends TogglePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return (SystemNavigationPreferenceController.isOverlayPackageAvailable(
                                this.mContext, "com.android.internal.systemui.navbar.twobutton")
                        || SystemNavigationPreferenceController.isOverlayPackageAvailable(
                                this.mContext, "com.android.internal.systemui.navbar.threebutton"))
                ? 0
                : 3;
    }
    ...
    public boolean getThreadEnabled() {
        return Settings.Secure.getInt(
                        ...
                        this.mContext
                                        ...
                                        .getBoolean(
                                                android.R.bool
                                                        .config_audio_ringer_mode_affects_alarm_stream)
                                ? 1
                                : 0)
                == 1;
    }
    ...
    public boolean setChecked(boolean z) {
        return Settings.Secure.putInt(
                this.mContext.getContentResolver(), "assist_long_press_home_enabled", z ? 1 : 0);
    }
