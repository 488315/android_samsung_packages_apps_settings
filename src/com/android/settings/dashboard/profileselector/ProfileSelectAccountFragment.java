        ...
        return ProfileSelectFragment.getFragments(
                ...
                new ProfileSelectFragment
                        .FragmentConstructor() { // from class:
                                                 // com.android.settings.dashboard.profileselector.ProfileSelectAccountFragment$$ExternalSyntheticLambda0
                    ...
                    public final Fragment constructAndGetFragment() {
                        switch (i) {
                            case 0:
                                return new AccountPersonalDashboardFragment();
                            case 1:
                                return new AccountWorkProfileDashboardFragment();
                            default:
                                return new AccountPrivateDashboardFragment();
                        }
                    }
                },
                new ProfileSelectFragment
