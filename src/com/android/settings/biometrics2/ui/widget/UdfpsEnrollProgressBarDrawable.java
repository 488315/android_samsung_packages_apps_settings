...
public class UdfpsEnrollProgressBarDrawable extends Drawable {
    ...
    /* JADX WARN: Type inference failed for: r6v3, types: [com.android.settings.biometrics2.ui.widget.UdfpsEnrollProgressBarDrawable$$ExternalSyntheticLambda1] */
    /* JADX WARN: Type inference failed for: r6v4, types: [com.android.settings.biometrics2.ui.widget.UdfpsEnrollProgressBarDrawable$$ExternalSyntheticLambda1] */
    /* JADX WARN: Type inference failed for: r6v5, types: [com.android.settings.biometrics2.ui.widget.UdfpsEnrollProgressBarDrawable$$ExternalSyntheticLambda1] */
    /* JADX WARN: Type inference failed for: r6v6, types: [com.android.settings.biometrics2.ui.widget.UdfpsEnrollProgressBarDrawable$$ExternalSyntheticLambda1] */
    public UdfpsEnrollProgressBarDrawable(Context context, AttributeSet attributeSet) {
        ...
        this.mProgressUpdateListener =
                new ValueAnimator.AnimatorUpdateListener(
                        this) { // from class:
                                // com.android.settings.biometrics2.ui.widget.UdfpsEnrollProgressBarDrawable$$ExternalSyntheticLambda1
