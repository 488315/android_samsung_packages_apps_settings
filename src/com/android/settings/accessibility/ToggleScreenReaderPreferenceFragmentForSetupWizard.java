    ...
    public final void onStop() {
        if (this.mToggleServiceSwitchPreference.mChecked != this.mToggleSwitchWasInitiallyChecked) {
            this.mMetricsFeatureProvider.action(
                    getContext(), 371, this.mToggleServiceSwitchPreference.mChecked);
        }
        super.onStop();
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (view instanceof GlifPreferenceLayout) {
            ...
            AccessibilitySetupWizardUtils.updateGlifPreferenceLayout(
                    ...
                    getContext().getString(R.string.talkback_summary),
            ...
            AccessibilitySetupWizardUtils.setPrimaryButton(
                    ...
                    new Runnable() { // from class:
                                     // com.android.settings.accessibility.ToggleScreenReaderPreferenceFragmentForSetupWizard$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ToggleScreenReaderPreferenceFragmentForSetupWizard
                                    toggleScreenReaderPreferenceFragmentForSetupWizard =
                                            ToggleScreenReaderPreferenceFragmentForSetupWizard.this;
                            int i = ToggleScreenReaderPreferenceFragmentForSetupWizard.$r8$clinit;
                            toggleScreenReaderPreferenceFragmentForSetupWizard.setResult(0);
                            toggleScreenReaderPreferenceFragmentForSetupWizard.finish();
                        }
                    });
        }
