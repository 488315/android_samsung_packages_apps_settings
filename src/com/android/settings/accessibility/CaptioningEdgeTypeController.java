...
public class CaptioningEdgeTypeController extends BasePreferenceController
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        EdgeTypePreference edgeTypePreference =
                (EdgeTypePreference) preferenceScreen.findPreference(getPreferenceKey());
        edgeTypePreference.setValue(
                CaptioningManager.CaptionStyle.getCustomStyle(this.mCaptionHelper.mContentResolver)
                        .edgeType);
        edgeTypePreference.mOnValueChangedListener = this;
        edgeTypePreference.seslSetSummaryColor(
    ...
    public void onValueChanged(ListDialogPreference listDialogPreference, int i) {
        Settings.Secure.putInt(
                this.mCaptionHelper.mContentResolver, "accessibility_captioning_edge_type", i);
    }
