...
public class KeyboardBounceKeyPreferenceController extends TogglePreferenceController {
    ...
    public KeyboardBounceKeyPreferenceController(Context context, String str) {
        super(context, str);
    }

    @Override // com.android.settings.core.BasePreferenceController
    public int getAvailabilityStatus() {
        return InputSettings.isAccessibilityBounceKeysFeatureEnabled() ? 0 : 3;
    }
    ...
    public boolean setChecked(boolean z) {
        InputSettings.setAccessibilityBounceKeysThreshold(this.mContext, z ? 500 : 0);
        return true;
    }
