...
public class HearingDeviceRingtoneRoutingPreferenceController
        extends HearingDeviceAudioRoutingBasePreferenceController {
    public HearingDeviceRingtoneRoutingPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public int restoreRoutingValue(Context context) {
        return Settings.Secure.getInt(
                context.getContentResolver(), "hearing_aid_ringtone_routing", 0);
    }
    ...
    public void saveRoutingValue(Context context, int i) {
        Settings.Secure.putInt(context.getContentResolver(), "hearing_aid_ringtone_routing", i);
    }
