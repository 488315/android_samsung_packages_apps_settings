...
public class CaptioningForegroundColorController extends BasePreferenceController
    ...
    public CaptioningForegroundColorController(Context context, String str) {
        super(context, str);
    ...
    private int getNonDefaultOpacity(boolean z) {
        int parseOpacity = CaptionUtils.parseOpacity(this.mCaptionHelper.getForegroundColor());
        if (!z) {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        colorPreference.setValue(CaptionUtils.parseColor(this.mCaptionHelper.getForegroundColor()));
