...
public class CaptioningBackgroundOpacityController extends BasePreferenceController
    ...
    public CaptioningBackgroundOpacityController(Context context, String str) {
        super(context, str);
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        colorPreference.setValue(
                CaptionUtils.parseOpacity(this.mCaptionHelper.getBackgroundColor()));
    ...
    public void onValueChanged(ListDialogPreference listDialogPreference, int i) {
        Settings.Secure.putInt(
                ...
                CaptionUtils.mergeColorOpacity(
                        CaptionUtils.parseColor(this.mCaptionHelper.getBackgroundColor()), i));
    }
