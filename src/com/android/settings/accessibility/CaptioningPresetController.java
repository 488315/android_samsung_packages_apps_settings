...
public class CaptioningPresetController extends BasePreferenceController
    ...
    public CaptioningPresetController(Context context, String str) {
        super(context, str);
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        PresetPreference presetPreference =
                (PresetPreference) preferenceScreen.findPreference(getPreferenceKey());
        Resources resources = this.mContext.getResources();
        int[] intArray = resources.getIntArray(R.array.captioning_preset_selector_values);
        presetPreference.mEntryTitles =
                resources.getStringArray(R.array.captioning_preset_selector_titles);
        presetPreference.setValues(intArray);
        presetPreference.setValue(this.mCaptionHelper.mCaptioningManager.getRawUserStyle());
        presetPreference.mOnValueChangedListener = this;
        presetPreference.seslSetSummaryColor(
    ...
    public void onValueChanged(ListDialogPreference listDialogPreference, int i) {
        Settings.Secure.putInt(
                this.mCaptionHelper.mContentResolver, "accessibility_captioning_preset", i);
    }
