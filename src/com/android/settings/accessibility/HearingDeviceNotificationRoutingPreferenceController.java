...
public class HearingDeviceNotificationRoutingPreferenceController
        extends HearingDeviceAudioRoutingBasePreferenceController {
    public HearingDeviceNotificationRoutingPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public int restoreRoutingValue(Context context) {
        return Settings.Secure.getInt(
                context.getContentResolver(), "hearing_aid_notification_routing", 0);
    }
    ...
    public void saveRoutingValue(Context context, int i) {
        Settings.Secure.putInt(context.getContentResolver(), "hearing_aid_notification_routing", i);
    }
