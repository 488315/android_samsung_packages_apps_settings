...
public class CaptioningTogglePreferenceController extends TogglePreferenceController
    ...
    public CaptioningTogglePreferenceController(Context context, String str) {
        super(context, str);
    ...
    public boolean getThreadEnabled() {
        return this.mCaptionHelper.mCaptioningManager.isEnabled();
    }
    ...
    public boolean setChecked(boolean z) {
        ...
        if (captionHelper.mCaptioningManager.isEnabled() == z) {
            return true;
        }
        Settings.Secure.putInt(
                captionHelper.mContext.getContentResolver(),
    ...
    public void updateState(Preference preference) {
        ...
        if (preference instanceof SecRestrictedSwitchPreference) {
            ((SecRestrictedSwitchPreference) preference).setDisabledByAdmin(null);
        }
    }
