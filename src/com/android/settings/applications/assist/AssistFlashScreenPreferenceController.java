...
public final class AssistFlashScreenPreferenceController extends AbstractPreferenceController
    ...
    public final class SettingObserver extends AssistSettingObserver {
        public final Uri URI = Settings.Secure.getUriFor("assist_disclosure_enabled");
        public final Uri CONTEXT_URI = Settings.Secure.getUriFor("assist_structure_enabled");
        ...
        public final void onSettingChange() {
            AssistFlashScreenPreferenceController.this.updatePreference$2();
        }
    }
    ...
    public final void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mPreference = preferenceScreen.findPreference("flash");
    ...
    public final void updatePreference$2() {
        ...
        } else if (this.mScreen.findPreference("flash") == null) {
        ...
        this.mPreference.setEnabled(
                (Settings.Secure.getInt(
                                        ...
                                        1)
                                != 0)
                        && isPreInstalledAssistant(assistComponentForUser));
        ((TwoStatePreference) this.mPreference).setChecked(willShowFlash(assistComponentForUser));
    }
