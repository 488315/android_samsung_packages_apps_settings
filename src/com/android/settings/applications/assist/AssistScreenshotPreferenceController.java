...
public final class AssistScreenshotPreferenceController extends AbstractPreferenceController
    ...
    public final class SettingObserver extends AssistSettingObserver {
        public final Uri URI = Settings.Secure.getUriFor("assist_screenshot_enabled");
        ...
        public final void onSettingChange() {
            AssistScreenshotPreferenceController.this.updatePreference$3();
        }
    }
    ...
    public final void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mPreference = preferenceScreen.findPreference("screenshot");
    ...
    public final void updatePreference$3() {
        ...
        } else if (this.mScreen.findPreference("screenshot") == null) {
        ...
        this.mPreference.setEnabled(
                Settings.Secure.getInt(
                                this.mContext.getContentResolver(), "assist_structure_enabled", 1)
                        != 0);
    }
