...
public final class RingerVibrateConditionController extends AbnormalRingerConditionController {
    public static final int ID = Objects.hash("RingerVibrateConditionController");
    ...
    public final ContextualCard buildContextualCard() {
        ...
        builder.mName =
                this.mAppContext.getPackageName()
                        + "/"
                        + ((Object)
                                this.mAppContext.getText(R.string.condition_device_vibrate_title));
        builder.mTitleText =
                this.mAppContext.getText(R.string.condition_device_vibrate_title).toString();
        builder.mSummaryText =
                this.mAppContext.getText(R.string.condition_device_vibrate_summary).toString();
        builder.mIconDrawable = this.mAppContext.getDrawable(R.drawable.ic_volume_ringer_vibrate);
