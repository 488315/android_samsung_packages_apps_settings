...
public class TimeFeedbackPreferenceCategoryController extends BasePreferenceController {
    ...
    public void addChildController(AbstractPreferenceController abstractPreferenceController) {
        List<AbstractPreferenceController> list = this.mChildControllers;
        Objects.requireNonNull(abstractPreferenceController);
        list.add(abstractPreferenceController);
    }
    ...
    public boolean isTimeFeedbackFeatureEnabled() {
        return false;
    }
