...
public class NotifyOpenNetworksPreferenceController extends TogglePreferenceController
    ...
    public final class SettingObserver extends ContentObserver {
        public final Uri NETWORKS_AVAILABLE_URI;
        public final Preference mPreference;

        public SettingObserver(Preference preference) {
            super(new Handler());
            this.NETWORKS_AVAILABLE_URI =
                    Settings.Global.getUriFor("wifi_networks_available_notification_on");
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mSettingObserver =
                new SettingObserver(preferenceScreen.findPreference(getPreferenceKey()));
    }
        ...
        if (settingObserver != null) {
            this.mContext
                    ...
                    .registerContentObserver(
                            settingObserver.NETWORKS_AVAILABLE_URI, false, settingObserver);
        }
    }
