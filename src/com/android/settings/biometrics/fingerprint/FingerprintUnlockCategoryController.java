...
public class FingerprintUnlockCategoryController extends BasePreferenceController {
    ...
    @VisibleForTesting protected FingerprintManager mFingerprintManager;
    private int mUserId;

    public FingerprintUnlockCategoryController(Context context, String str) {
        super(context, str);
    ...
    public int getAvailabilityStatus() {
        ...
        if (fingerprintManager != null
                ...
                && this.mFingerprintManager.isPowerbuttonFps()) {
