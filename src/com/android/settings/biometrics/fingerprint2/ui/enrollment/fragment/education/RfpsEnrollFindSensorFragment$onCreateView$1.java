...
final class RfpsEnrollFindSensorFragment$onCreateView$1 extends SuspendLambda implements Function2 {
    int label;
    ...
    @Metadata(
            ...
            mv = {1, 9, 0},
            xi = 48)
    /* renamed from: com.android.settings.biometrics.fingerprint2.ui.enrollment.fragment.education.RfpsEnrollFindSensorFragment$onCreateView$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RfpsEnrollFindSensorFragment$onCreateView$1(
            RfpsEnrollFindSensorFragment rfpsEnrollFindSensorFragment, Continuation continuation) {
        super(2, continuation);
        this.this$0 = rfpsEnrollFindSensorFragment;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new RfpsEnrollFindSensorFragment$onCreateView$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((RfpsEnrollFindSensorFragment$onCreateView$1)
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnonymousClass1 anonymousClass1 =
                    new AnonymousClass1(rfpsEnrollFindSensorFragment, null);
            this.label = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(
                            rfpsEnrollFindSensorFragment, state, anonymousClass1, this)
                    == coroutineSingletons) {
