...
public final class FingerprintEnrollConfirmationViewModel extends ViewModel {
    public static final InitializerViewModelFactory Factory;
    public final SafeFlow isAddAnotherButtonVisible;

    static {
        ReflectionFactory reflectionFactory = Reflection.factory;
        reflectionFactory.getOrCreateKotlinClass(FingerprintNavigationStep$Confirmation.class);
        ...
        initializerViewModelFactoryBuilder.addInitializer(
                ...
                new Function1() { // from class:
                    // com.android.settings.biometrics.fingerprint2.ui.enrollment.viewmodel.FingerprintEnrollConfirmationViewModel$Companion$Factory$1$1
