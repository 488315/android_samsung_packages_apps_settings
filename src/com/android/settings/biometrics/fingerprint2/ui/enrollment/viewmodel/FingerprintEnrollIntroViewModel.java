...
public final class FingerprintEnrollIntroViewModel extends ViewModel {
    public static final InitializerViewModelFactory Factory;
    public final ReadonlySharedFlow fingerprintFlow;
    public final Flow sensor;

    static {
        ReflectionFactory reflectionFactory = Reflection.factory;
        reflectionFactory.getOrCreateKotlinClass(FingerprintNavigationStep$Introduction.class);
        ...
        initializerViewModelFactoryBuilder.addInitializer(
                reflectionFactory.getOrCreateKotlinClass(FingerprintEnrollIntroViewModel.class),
                new Function1() { // from class:
                    // com.android.settings.biometrics.fingerprint2.ui.enrollment.viewmodel.FingerprintEnrollIntroViewModel$Companion$Factory$1$1
