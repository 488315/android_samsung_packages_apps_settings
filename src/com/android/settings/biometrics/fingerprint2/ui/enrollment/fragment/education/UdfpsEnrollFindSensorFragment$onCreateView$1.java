...
final class UdfpsEnrollFindSensorFragment$onCreateView$1 extends SuspendLambda
    ...
    @Metadata(
            ...
            mv = {1, 9, 0},
            xi = 48)
    /* renamed from: com.android.settings.biometrics.fingerprint2.ui.enrollment.fragment.education.UdfpsEnrollFindSensorFragment$onCreateView$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UdfpsEnrollFindSensorFragment$onCreateView$1(
            UdfpsEnrollFindSensorFragment udfpsEnrollFindSensorFragment,
            Continuation continuation) {
        super(2, continuation);
        this.this$0 = udfpsEnrollFindSensorFragment;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new UdfpsEnrollFindSensorFragment$onCreateView$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((UdfpsEnrollFindSensorFragment$onCreateView$1)
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnonymousClass1 anonymousClass1 =
                    new AnonymousClass1(udfpsEnrollFindSensorFragment, null);
            this.label = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(
                            udfpsEnrollFindSensorFragment, state, anonymousClass1, this)
                    == coroutineSingletons) {
