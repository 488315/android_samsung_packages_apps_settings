...
public class FaceStatusPreferenceController extends BiometricStatusPreferenceController
    ...
    private void updateStateInternal() {
        updateStateInternal(
                ParentalControlsUtils.parentConsentRequired(this.mFaceStatusUtils.mContext, 8));
    }
    ...
    public String getSettingsClassName() {
        this.mFaceStatusUtils.getClass();
    ...
    public String getSummaryText() {
        ...
        if (RestrictedLockUtilsInternal.checkIfKeyguardFeaturesDisabled(
                        faceStatusUtils.mContext, 128, i)
                != null) {
            return faceStatusUtils.mContext.getString(R.string.disabled_by_admin);
        }
        Resources resources = faceStatusUtils.mContext.getResources();
        if (faceStatusUtils.mFaceManager.hasEnrolledTemplates(i)) {
    ...
    public boolean isDeviceSupported() {
        return Utils.hasFaceHardware(this.mFaceStatusUtils.mContext);
    }
    ...
    public void setSummaryColor(Preference preference) {
        FaceStatusUtils faceStatusUtils = this.mFaceStatusUtils;
        if (faceStatusUtils.mFaceManager.hasEnrolledTemplates(faceStatusUtils.mUserId)) {
