...
public class BiometricFingerprintStatusPreferenceController
    ...
    public void updateState(Preference preference) {
        ...
        boolean hasEnrolledFingerprints =
                fingerprintStatusUtils.mFingerprintManager.hasEnrolledFingerprints(
                        fingerprintStatusUtils.mUserId);
        RestrictedLockUtils.EnforcedAdmin checkIfKeyguardFeaturesDisabled =
                RestrictedLockUtilsInternal.checkIfKeyguardFeaturesDisabled(
                        this.mContext, 32, getUserId());
        if (checkIfKeyguardFeaturesDisabled == null || hasEnrolledFingerprints) {
