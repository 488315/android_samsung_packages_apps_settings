...
public final class BluetoothSnoopLogFilterProfileMapPreferenceController
    ...
    public final String getPreferenceKey() {
        return "bt_hci_snoop_log_filter_map";
    }
    ...
    public final void updateState(Preference preference) {
        ...
        BluetoothProperties.snoop_log_filter_profile_map_values
                snoop_log_filter_profile_map_valuesVar =
                        (BluetoothProperties.snoop_log_filter_profile_map_values)
                                BluetoothProperties.snoop_log_filter_profile_map()
                                        .orElse(
                                                BluetoothProperties
        ...
        while (true) {
            ...
            if (snoop_log_filter_profile_map_valuesVar
                    == BluetoothProperties.snoop_log_filter_profile_map_values.valueOf(
