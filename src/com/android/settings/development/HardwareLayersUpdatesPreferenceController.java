...
public final class HardwareLayersUpdatesPreferenceController
    ...
    public final boolean onPreferenceChange(Preference preference, Object obj) {
        SystemProperties.set(
                "debug.hwui.show_layers_updates", ((Boolean) obj).booleanValue() ? "true" : null);
    ...
    public final void updateState(Preference preference) {
        ((TwoStatePreference) this.mPreference)
                .setChecked(SystemProperties.getBoolean("debug.hwui.show_layers_updates", false));
    }
}
