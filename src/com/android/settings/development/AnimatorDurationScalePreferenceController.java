...
public final class AnimatorDurationScalePreferenceController
    ...
    public AnimatorDurationScalePreferenceController(Context context) {
        ...
        this.mListValues =
                context.getResources().getStringArray(R.array.animator_duration_scale_values);
        this.mListSummaries =
                context.getResources().getStringArray(R.array.animator_duration_scale_entries);
    }
    ...
    public final void updateAnimationScaleValue() {
    ...
    public final void writeAnimationScaleOption(Object obj) {
        float parseFloat;
        if (obj != null) {
            try {
