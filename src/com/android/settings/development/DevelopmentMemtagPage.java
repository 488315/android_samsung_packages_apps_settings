...
public class DevelopmentMemtagPage extends DashboardFragment implements DeveloperOptionAwareMixin {
    ...
    public final void onAttach(Context context) {
        ...
        ((RebootWithMtePreferenceController) use(RebootWithMtePreferenceController.class))
                .setFragment(this);
        ((DevelopmentMemtagPreferenceController) use(DevelopmentMemtagPreferenceController.class))
                .setFragment(this);
    }
}
