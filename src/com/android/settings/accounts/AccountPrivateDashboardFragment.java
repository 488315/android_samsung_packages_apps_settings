    ...
    public final List createPreferenceControllers(Context context) {
        ...
        AccountPreferenceController accountPreferenceController =
                new AccountPreferenceController(
                        context, this, getIntent().getStringArrayExtra("authorities"), 4);
        ...
        AutoSyncPrivateDataPreferenceController autoSyncPrivateDataPreferenceController =
                new AutoSyncPrivateDataPreferenceController(context, this);
        autoSyncPrivateDataPreferenceController.mUserHandle =
                Utils.getProfileOfType(autoSyncPrivateDataPreferenceController.mUserManager, 4);
        getSettingsLifecycle().addObserver(autoSyncPrivateDataPreferenceController);
        arrayList.add(autoSyncPrivateDataPreferenceController);
        return arrayList;
    }
