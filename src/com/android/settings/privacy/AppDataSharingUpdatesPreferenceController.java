...
public class AppDataSharingUpdatesPreferenceController extends BasePreferenceController {
    public AppDataSharingUpdatesPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    private boolean isPrivacySafetyLabelChangeNotificationsEnabled(Context context) {
        ...
        return (Rune.isChinaModel()
                        || !DeviceConfig.getBoolean(
                                "privacy", "safety_label_change_notifications_enabled", true)
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (findPreference != null) {
            findPreference.setIntent(
                    new Intent("android.intent.action.REVIEW_APP_DATA_SHARING_UPDATES")
                            .setPackage(
                                    this.mContext
                                            .getPackageManager()
    ...
    public int getAvailabilityStatus() {
        return isPrivacySafetyLabelChangeNotificationsEnabled(this.mContext) ? 0 : 3;
    }
