...
public class AccessibilityUsagePreferenceController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (findPreference != null) {
            findPreference.setIntent(
                    new Intent("android.intent.action.REVIEW_ACCESSIBILITY_SERVICES")
                            .setPackage(
                                    this.mContext
                                            .getPackageManager()
    ...
    public CharSequence getSummary() {
        return this.mContext
                .getResources()
                .getQuantityString(
                        R.plurals.sec_accessibility_usage_summary,
                        this.mEnabledServiceInfos.size(),
                        Integer.valueOf(this.mEnabledServiceInfos.size()));
    }
    ...
    public void updateState(Preference preference) {
        ...
        List<AccessibilityServiceInfo> enabledAccessibilityServiceList =
                this.mAccessibilityManager.getEnabledAccessibilityServiceList(-1);
