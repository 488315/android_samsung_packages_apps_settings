...
public class BackupDataPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        if (privacySettingsConfigData.mBackupGray) {
            return null;
        }
        return privacySettingsConfigData.mBackupEnabled
                ? this.mContext.getText(R.string.accessibility_feature_state_on)
                : this.mContext.getText(R.string.accessibility_feature_state_off);
    }
