...
public class DataManagementPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        ...
        return (privacySettingsConfigData.mManageIntent == null
                        || !privacySettingsConfigData.mBackupEnabled)
                ? 3
                : 0;
    }
    ...
    public void updateState(Preference preference) {
        if (isAvailable()) {
            preference.setIntent(this.mPSCD.mManageIntent);
            CharSequence charSequence = this.mPSCD.mManageLabel;
