...
public final class AppListNotificationsPageProvider implements SettingsPageProvider {
    public static final AppListNotificationsPageProvider INSTANCE =
            new AppListNotificationsPageProvider();

    public final void EntryItem(Composer composer, final int i) {
        final ComposerImpl composerImpl = (ComposerImpl) composer;
        composerImpl.startRestartGroup(-251076681);
        if ((i & 1) == 0 && composerImpl.getSkipping()) {
            ...
            final String stringResource =
                    StringResources_androidKt.stringResource(
                            composerImpl, R.string.app_notification_field_summary);
            PreferenceKt.Preference(
                    new PreferenceModel(
                            composerImpl,
                            stringResource) { // from class:
                                              // com.android.settings.spa.notification.AppListNotificationsPageProvider$EntryItem$1
...

                        {
                            this.title =
                                    StringResources_androidKt.stringResource(
                                            composerImpl, R.string.app_notifications_title);
                            this.summary =
                                    new Function0() { // from class:
                                                      // com.android.settings.spa.notification.AppListNotificationsPageProvider$EntryItem$1$summary$1
                            ...
                            this.onClick =
                                    (Lambda)
                                            NavControllerWrapperKt.navigator(
                                                    composerImpl, "AppListNotifications");
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.block =
                    new Function2() { // from class:
                                      // com.android.settings.spa.notification.AppListNotificationsPageProvider$EntryItem$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final Object invoke(Object obj, Object obj2) {
                            ...
                            AppListNotificationsPageProvider.this.EntryItem(
    ...
    public final void Page(final Bundle bundle, Composer composer, final int i) {
        ...
        composerImpl.startRestartGroup(546951067);
        if ((i & 1) == 0 && composerImpl.getSkipping()) {
            composerImpl.skipToGroupEnd();
        } else {
            OpaqueKey opaqueKey = ComposerKt.invocation;
            AppListPageKt.AppListPage(
                    ...
                    (AppListModel)
                            RuntimeUtilsKt.rememberContext(
                                    AppListNotificationsPageProvider$Page$1.INSTANCE, composerImpl),
                    false,
                    false,
                    false,
                    null,
        ...
        if (endRestartGroup != null) {
            endRestartGroup.block =
                    new Function2() { // from class:
                                      // com.android.settings.spa.notification.AppListNotificationsPageProvider$Page$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final Object invoke(Object obj, Object obj2) {
                            ((Number) obj2).intValue();
                            AppListNotificationsPageProvider.this.Page(
                                    bundle,
                                    (Composer) obj,
