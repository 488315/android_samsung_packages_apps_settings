...
public class QrDecorateView extends View {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.mMaskCanvas != null && this.mMaskBitmap != null) {
            this.mStrokePaint.setColor(
                    this.mFocused ? this.mFocusedCornerColor : this.mCornerColor);
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (getWidth() <= 0 || getHeight() <= 0) {
            Log.e("QrDecorateView", "width and height must be > 0");
            return;
        }
        ...
        float applyDimension =
                TypedValue.applyDimension(1, 264.0f, getResources().getDisplayMetrics()) / 2.0f;
        ...
        this.mInnerFrame =
                new RectF(
                        rectF.left + applyDimension2,
                        rectF.top + applyDimension2,
                        rectF.right - applyDimension2,
