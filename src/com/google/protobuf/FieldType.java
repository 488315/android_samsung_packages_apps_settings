...
public final class FieldType {
    ...
    static {
        ...
        FieldType fieldType41 =
                new FieldType("FIXED64_LIST_PACKED", 40, 40, collection3, javaType3);
        FieldType fieldType42 =
                new FieldType("FIXED32_LIST_PACKED", 41, 41, collection3, javaType4);
        ...
        FieldType fieldType46 =
                new FieldType("SFIXED32_LIST_PACKED", 45, 45, collection3, javaType4);
        FieldType fieldType47 =
                new FieldType("SFIXED64_LIST_PACKED", 46, 46, collection3, javaType3);
        ...
        $VALUES =
                new FieldType[] {
                    ...
                    fieldType48,
                    fieldType49,
                    new FieldType("GROUP_LIST", 49, 49, collection2, javaType7),
    ...
    public FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        this.primitiveScalar =
                (collection != Collection.SCALAR
                                || (ordinal = javaType.ordinal()) == 6
                                || ordinal == 7
                                || ordinal == 9)
                        ? false
                        : true;
