...
public final class JavaType {
    ...
    static {
        ...
        FLOAT = javaType4;
        JavaType javaType5 =
                new JavaType("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(0.0d));
        DOUBLE = javaType5;
        JavaType javaType6 = new JavaType("BOOLEAN", 5, Boolean.TYPE, Boolean.class, Boolean.FALSE);
        BOOLEAN = javaType6;
        JavaType javaType7 =
                new JavaType("STRING", 6, String.class, String.class, ApnSettings.MVNO_NONE);
        STRING = javaType7;
        JavaType javaType8 =
                new JavaType(
                        "BYTE_STRING", 7, ByteString.class, ByteString.class, ByteString.EMPTY);
