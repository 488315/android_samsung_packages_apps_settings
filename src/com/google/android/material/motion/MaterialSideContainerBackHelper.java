...
public final class MaterialSideContainerBackHelper extends MaterialBackAnimationHelper {
    ...
    public MaterialSideContainerBackHelper(View view) {
        ...
        this.maxScaleXDistanceShrink =
                resources.getDimension(
                        R.dimen.m3_back_progress_side_container_max_scale_x_distance_shrink);
        this.maxScaleXDistanceGrow =
                resources.getDimension(
                        R.dimen.m3_back_progress_side_container_max_scale_x_distance_grow);
        this.maxScaleYDistance =
                resources.getDimension(
                        R.dimen.m3_back_progress_side_container_max_scale_y_distance);
    }
        ...
        if (f2 > 0.0f) {
            ...
            if (view3 instanceof ViewGroup) {
                ...
                for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                    ...
                    childAt.setPivotX(
                            z2
                                    ? childAt.getWidth() + (width - childAt.getRight())
                                    : -childAt.getLeft());
