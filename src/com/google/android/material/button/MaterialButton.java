...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public void onAttachedToWindow() {
        ...
        if (isUsingOriginalBackground()) {
            MaterialShapeUtils.setParentAbsoluteElevation(
                    this, this.materialButtonHelper.getMaterialShapeDrawable(false));
        }
    }
        ...
        if (isCheckable() && isEnabled() && this.checked != z) {
            ...
            if (getParent() instanceof MaterialButtonToggleGroup) {
                MaterialButtonToggleGroup materialButtonToggleGroup =
                        (MaterialButtonToggleGroup) getParent();
    ...
    public final void setPressed(boolean z) {
        MaterialButtonToggleGroup.PressedStateTracker pressedStateTracker =
                this.onPressedChangeListenerInternal;
    ...
    public final void setShapeAppearanceModel(ShapeAppearanceModel shapeAppearanceModel) {
        if (!isUsingOriginalBackground()) {
            throw new IllegalStateException(
                    "Attempted to set ShapeAppearanceModel on a MaterialButton which has an"
        ...
        if (materialButtonHelper.backgroundTint != colorStateList) {
            ...
            if (materialButtonHelper.getMaterialShapeDrawable(false) != null) {
                materialButtonHelper
                        .getMaterialShapeDrawable(false)
                        .setTintList(materialButtonHelper.backgroundTint);
            }
        }
    }
    ...
    public final void setSupportBackgroundTintMode(PorterDuff.Mode mode) {
        ...
        if (materialButtonHelper.backgroundTintMode != mode) {
            ...
            if (materialButtonHelper.getMaterialShapeDrawable(false) == null
                    || materialButtonHelper.backgroundTintMode == null) {
                return;
            }
            materialButtonHelper
                    .getMaterialShapeDrawable(false)
                    .setTintMode(materialButtonHelper.backgroundTintMode);
        }
    }
    ...
    public final void updateIcon(boolean z) {
        ...
        if (((i5 == 1 || i5 == 2) && drawable3 != this.icon)
                || (((i5 == 3 || i5 == 4) && drawable5 != this.icon)
                        || ((i5 == 16 || i5 == 32) && drawable4 != this.icon))) {
            resetIconDrawable();
        }
    }
    ...
    public final void updateIconPosition(int i, int i2) {
        ...
        if (!(i3 == 1 || i3 == 2) && i3 != 3 && i3 != 4) {
            if (i3 == 16 || i3 == 32) {
                    ...
                    if (getTransformationMethod() != null) {
                        charSequence =
                                getTransformationMethod()
                                        .getTransformation(charSequence, this)
                                        .toString();
                    }
                    Rect rect = new Rect();
                ...
                int max =
                        Math.max(
                                0,
                                (((((i2 - min) - getPaddingTop()) - i4) - this.iconPadding)
                                                - getPaddingBottom())
                                        / 2);
                if (this.iconTop != max) {
                    this.iconTop = max;
        ...
        if (textAlignment != 1) {
            alignment =
                    (textAlignment == 6 || textAlignment == 3)
        ...
        if (i5 == 1
                || i5 == 3
                || ((i5 == 2 && alignment == Layout.Alignment.ALIGN_NORMAL)
                        || (i5 == 4 && alignment == Layout.Alignment.ALIGN_OPPOSITE))) {
            this.iconLeft = 0;
            updateIcon(false);
            return;
        }
    ...
    public MaterialButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.android.settings.R.attr.materialButtonStyle);
    }

    public MaterialButton(Context context, AttributeSet attributeSet, int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, 2132084871), attributeSet, i);
        boolean z;
        ...
        this.iconTint =
                MaterialResources.getColorStateList(getContext(), obtainStyledAttributes, 14);
        ...
        MaterialButtonHelper materialButtonHelper =
                new MaterialButtonHelper(
                        this,
                        ShapeAppearanceModel.builder(context2, attributeSet, i, 2132084871)
                                .build());
        ...
        if (obtainStyledAttributes.hasValue(8)) {
            ...
            ShapeAppearanceModel.Builder builder =
                    materialButtonHelper.shapeAppearanceModel.toBuilder();
        ...
        materialButtonHelper.backgroundTintMode =
                ViewUtils.parseTintMode(obtainStyledAttributes.getInt(7, -1), mode);
        materialButtonHelper.backgroundTint =
                MaterialResources.getColorStateList(getContext(), obtainStyledAttributes, 6);
        materialButtonHelper.strokeColor =
                MaterialResources.getColorStateList(getContext(), obtainStyledAttributes, 19);
        materialButtonHelper.rippleColor =
                MaterialResources.getColorStateList(getContext(), obtainStyledAttributes, 16);
        ...
        materialButtonHelper.toggleCheckedStateOnClick =
        ...
        if (obtainStyledAttributes.hasValue(0)) {
            ...
            MaterialShapeDrawable materialShapeDrawable =
                    new MaterialShapeDrawable(materialButtonHelper.shapeAppearanceModel);
            ...
            int color =
                    materialButtonHelper.shouldDrawSurfaceColorStroke
                            ? MaterialColors.getColor(
                                    this, com.android.settings.R.attr.colorSurface)
                            : 0;
            ...
            RippleDrawable rippleDrawable =
                    new RippleDrawable(
                            colorStateList2 == null ? ColorStateList.valueOf(0) : colorStateList2,
                            new InsetDrawable(
                                    (Drawable)
                                            new LayerDrawable(
                                                    new Drawable[] {
                                    ...
                                    materialButtonHelper.insetLeft,
                                    materialButtonHelper.insetTop,
                                    materialButtonHelper.insetRight,
                                    materialButtonHelper.insetBottom),
                            materialButtonHelper.maskDrawable);
        ...
        setPaddingRelative(
                paddingStart + materialButtonHelper.insetLeft,
                paddingTop + materialButtonHelper.insetTop,
                paddingEnd + materialButtonHelper.insetRight,
                paddingBottom + materialButtonHelper.insetBottom);
