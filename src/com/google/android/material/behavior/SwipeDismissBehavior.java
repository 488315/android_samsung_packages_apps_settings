...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.Behavior {
    ...
    public final AnonymousClass1 dragCallback = new ViewDragHelper.Callback() { // from class:
                ...
                public final void onViewPositionChanged(View view, int i, int i2) {
                    ...
                    if (abs <= f) {
                        ...
                        view.setAlpha(
                                Math.min(Math.max(0.0f, 1.0f - ((abs - f) / (width2 - f))), 1.0f));
                    }
                }
                ...
                */
                    ...
                    */
                    throw new UnsupportedOperationException(
                            "Method not decompiled:"
                                + " com.google.android.material.behavior.SwipeDismissBehavior.AnonymousClass1.onViewReleased(android.view.View,"
                                + " float, float):void");
                }
                ...
                public final boolean tryCaptureView(View view, int i) {
                    ...
                    return (i2 == -1 || i2 == i)
                            && SwipeDismissBehavior.this.canSwipeDismissView(view);
                }
            };
    ...
    public boolean onInterceptTouchEvent(
        ...
        return !this.requestingDisallowInterceptTouchEvent
