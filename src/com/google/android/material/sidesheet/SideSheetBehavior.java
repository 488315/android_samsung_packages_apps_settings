...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior
    ...
    public final class StateSettlingTracker {
        public final SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
                continueSettlingRunnable =
                        new Runnable() { // from class:
                                         // com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                SideSheetBehavior.StateSettlingTracker stateSettlingTracker =
                                        SideSheetBehavior.StateSettlingTracker.this;
                                ...
                                if (viewDragHelper != null && viewDragHelper.continueSettling()) {
                                    stateSettlingTracker.continueSettlingToState(
                                            stateSettlingTracker.targetState);
                                } else if (sideSheetBehavior.state == 2) {
                                    sideSheetBehavior.setStateInternal(
                                            stateSettlingTracker.targetState);
                                }
                            }
                        };
                ...
                new ViewDragHelper.Callback() { // from class:
                    ...
                    public final int clampViewPositionHorizontal(View view, int i) {
                        ...
                        return MathUtils.clamp(
                                i,
                                sideSheetBehavior.sheetDelegate.getMinViewPositionHorizontal(),
                                sideSheetBehavior.sheetDelegate.getMaxViewPositionHorizontal());
                    }
                    ...
                    public final void onViewPositionChanged(View view, int i, int i2) {
                        ...
                        if (view2 != null
                                && (marginLayoutParams =
                                        ...
                                        != null) {
                            sideSheetBehavior.sheetDelegate.updateCoplanarSiblingLayoutParams(
                                    marginLayoutParams, view.getLeft(), view.getRight());
                    ...
                    */
                    public final void onViewReleased(android.view.View r4, float r5, float r6) {
                        ...
                        L56:
                            r5 = 1
                            r3.startSettling$1(r4, r1, r5)
                            return
                        */
                        throw new UnsupportedOperationException(
                                "Method not decompiled:"
                                    + " com.google.android.material.sidesheet.SideSheetBehavior.AnonymousClass1.onViewReleased(android.view.View,"
                                    + " float, float):void");
                    }
                    ...
                    public final boolean tryCaptureView(View view, int i) {
                        ...
                        SideSheetBehavior sideSheetBehavior = SideSheetBehavior.this;
                        return (sideSheetBehavior.state == 1
                                        || (weakReference = sideSheetBehavior.viewRef) == null
                                        || weakReference.get() != view)
                                ? false
                                : true;
                    }
                };
    ...
    public final void cancelBackProgress() {
        MaterialSideContainerBackHelper materialSideContainerBackHelper =
                this.sideContainerBackHelper;
        ...
        animatorSet.playTogether(
                ObjectAnimator.ofFloat(
                        materialSideContainerBackHelper.view,
                        (Property<View, Float>) View.SCALE_X,
                        1.0f),
                ObjectAnimator.ofFloat(
                        materialSideContainerBackHelper.view,
                        (Property<View, Float>) View.SCALE_Y,
                        1.0f));
    ...
    public final void handleBackInvoked() {
        ...
        AnimatorListenerAdapter animatorListenerAdapter =
                new AnimatorListenerAdapter() { // from class:
                                                // com.google.android.material.sidesheet.SideSheetBehavior.2
        ...
        if (view != null
                && (marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams())
                        != null) {
            final int coplanarSiblingAdjacentMargin =
                    this.sheetDelegate.getCoplanarSiblingAdjacentMargin(marginLayoutParams);
            animatorUpdateListener =
                    new ValueAnimator
                            .AnimatorUpdateListener() { // from class:
                                                        // com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda2
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ...
                            View view2 = view;
                            sideSheetBehavior.sheetDelegate.updateCoplanarSiblingAdjacentMargin(
                                    marginLayoutParams2,
                                    AnimationUtils.lerp(
                                            i3, 0, valueAnimator.getAnimatedFraction()));
                            view2.requestLayout();
                        }
                    };
        }
        ...
        float scaleX =
                materialSideContainerBackHelper.view.getScaleX()
                        * materialSideContainerBackHelper.view.getWidth();
        ViewGroup.LayoutParams layoutParams =
                materialSideContainerBackHelper.view.getLayoutParams();
        ...
        ofFloat.setDuration(
                AnimationUtils.lerp(
                        materialSideContainerBackHelper.hideDurationMax,
                        materialSideContainerBackHelper.hideDurationMin,
                        backEventCompat.progress));
        ofFloat.addListener(
                new AnimatorListenerAdapter() { // from class:
                                                // com.google.android.material.motion.MaterialSideContainerBackHelper.1
    ...
    public final boolean onInterceptTouchEvent(
        ...
        if ((!view.isShown() && ViewCompat.getAccessibilityPaneTitle(view) == null)
                || !this.draggable) {
    ...
    public final boolean onLayoutChild(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (this.viewRef == null) {
            ...
            if (ViewCompat.getAccessibilityPaneTitle(view) == null) {
                ViewCompat.setAccessibilityPaneTitle(
                        view,
                        view.getResources()
                                .getString(R.string.side_sheet_accessibility_pane_title));
            }
        }
        int i5 =
            ...
            if (i5 == 0) {
                ...
                if (shapeAppearanceModel != null) {
                    ...
                    if (weakReference != null
                            && (view3 = (View) weakReference.get()) != null
                ...
                if (shapeAppearanceModel != null) {
                    ...
                    if (weakReference2 != null
                            && (view2 = (View) weakReference2.get()) != null
                            && (view2.getLayoutParams()
                                    instanceof CoordinatorLayout.LayoutParams)) {
        ...
        this.innerMargin =
                marginLayoutParams != null
                        ? this.sheetDelegate.calculateInnerMargin(marginLayoutParams)
                        : 0;
        int i6 = this.state;
        if (i6 == 1 || i6 == 2) {
        ...
        if (this.coplanarSiblingViewRef == null
                && (i2 = this.coplanarSiblingViewId) != -1
                && (findViewById = coordinatorLayout.findViewById(i2)) != null) {
    ...
    public final boolean onTouchEvent(
        ...
        if (shouldHandleDraggingWithHelper$1()
                && actionMasked == 2
                && !this.ignoreEvents
                && shouldHandleDraggingWithHelper$1()) {
    ...
    */
    public final void startSettling$1(android.view.View r3, int r4, boolean r5) {
        ...
        Ld:
            ...
            java.lang.String r3 = androidx.appcompat.util.SeslRoundedCorner$$ExternalSyntheticOutline0.m(r4, r3)
            r2.<init>(r3)
            throw r2
        L19:
            com.google.android.material.sidesheet.SheetDelegate r0 = r2.sheetDelegate
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.google.android.material.sidesheet.SideSheetBehavior.startSettling$1(android.view.View,"
                    + " int, boolean):void");
    }
            ...
            ViewCompat.replaceAccessibilityAction(
                    ...
                    new AccessibilityViewCommand() { // from class:
                        ...
                        public final boolean perform(View view2) {
                            SideSheetBehavior.this.setState$1(i);
                            return true;
                        }
                    });
        }
        ...
        if (this.state != 3) {
            ViewCompat.replaceAccessibilityAction(
                    ...
                    new AccessibilityViewCommand() { // from class:
                        ...
                        @Override // androidx.core.view.accessibility.AccessibilityViewCommand
                        public final boolean perform(View view2) {
                            SideSheetBehavior.this.setState$1(i2);
                            return true;
                        }
                    });
        }
    ...
    public final void updateBackProgress(BackEventCompat backEventCompat) {
        ...
        if (backEventCompat2 != null) {
            materialSideContainerBackHelper.updateBackProgress(
                    backEventCompat.progress, backEventCompat.swipeEdge == 0, i);
        }
        WeakReference weakReference = this.viewRef;
        if (weakReference == null || weakReference.get() == null) {
            return;
        ...
        this.sheetDelegate.updateCoplanarSiblingAdjacentMargin(
                marginLayoutParams,
                (int) ((view.getScaleX() * this.childWidth) + this.innerMargin));
        view2.requestLayout();
    }
    ...
    public SideSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes =
                context.obtainStyledAttributes(attributeSet, R$styleable.SideSheetBehavior_Layout);
        ...
        if (obtainStyledAttributes.hasValue(6)) {
            this.shapeAppearanceModel =
                    ShapeAppearanceModel.builder(context, attributeSet, 0, 2132084822).build();
        }
