...
public class Illustration extends FrameLayout {
            ...
            TypedArray obtainStyledAttributes =
                    getContext()
                            .obtainStyledAttributes(
                                    attributeSet, R$styleable.SudIllustration, i, 0);
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (drawable != null) {
            ...
            Gravity.apply(
                    55, intrinsicWidth, intrinsicHeight, this.viewBounds, this.illustrationBounds);
        ...
        if (drawable2 != null) {
            drawable2.setBounds(
                    0,
                    0,
                    (int) Math.ceil(i5 / this.scale),
                    (int) Math.ceil((i6 - this.illustrationBounds.height()) / this.scale));
        }
