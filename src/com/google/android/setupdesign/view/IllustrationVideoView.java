...
public class IllustrationVideoView extends TextureView
    ...
    public final boolean shouldPauseVideoWhenFinished;
    Surface surface;
    ...
    public IllustrationVideoView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes =
                context.obtainStyledAttributes(attributeSet, R$styleable.SudIllustrationVideoView);
        int resourceId = obtainStyledAttributes.getResourceId(1, 0);
        this.shouldPauseVideoWhenFinished = obtainStyledAttributes.getBoolean(0, true);
        obtainStyledAttributes.recycle();
        String packageName = getContext().getPackageName();
        if (resourceId != this.videoResId
                || (packageName != null && !packageName.equals(this.videoResPackageName))) {
    ...
    public final void createMediaPlayer() {
        ...
        try {
            this.mediaPlayer.setDataSource(
                    getContext(),
                    Uri.parse("android.resource://" + this.videoResPackageName + "/" + i),
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (mediaPlayer.getVideoWidth() <= 0 || mediaPlayer.getVideoHeight() <= 0) {
            Log.w(
                    "IllustrationVideoView",
                    "Unexpected video size="
    ...
    public final void stop() {
        MediaPlayer mediaPlayer;
        if (this.shouldPauseVideoWhenFinished
                && this.prepared
