...
public class TemplateLayout extends FrameLayout {
    ...
    public final View inflateTemplate(LayoutInflater layoutInflater, int i, int i2) {
        ...
        if (i != 0) {
            layoutInflater =
                    LayoutInflater.from(new FallbackThemeWrapper(layoutInflater.getContext(), i));
        }
    ...
    public final void init(int i, int i2, AttributeSet attributeSet, int i3) {
        TypedArray obtainStyledAttributes =
                getContext()
                        .obtainStyledAttributes(attributeSet, R$styleable.SucTemplateLayout, i3, 0);
        if (i == 0) {
        ...
        super.addView(
                onInflateTemplate(LayoutInflater.from(getContext()), i),
                -1,
            ...
            this.preDrawListener =
                    new ViewTreeObserver
                            .OnPreDrawListener() { // from class:
                                                   // com.google.android.setupcompat.internal.TemplateLayout.1
                        @Override // android.view.ViewTreeObserver.OnPreDrawListener
                        public final boolean onPreDraw() {
                            TemplateLayout.this
                                    .getViewTreeObserver()
                                    .removeOnPreDrawListener(TemplateLayout.this.preDrawListener);
